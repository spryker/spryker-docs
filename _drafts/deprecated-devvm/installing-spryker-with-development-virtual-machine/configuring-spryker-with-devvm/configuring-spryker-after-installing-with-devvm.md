...
To check for newer released versions, we recommend that you follow the steps described in [Core Updates](/docs/scos/dev/set-up/managing-scos-dependencies-with-composer.html#core-updates).
