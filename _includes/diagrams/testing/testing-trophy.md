...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 940 520" width="100%" style="max-width:940px;height:auto;"
  ...
  <text x="468" y="154" font-size="13" fill="#55554F">— a handful of API requests, real token, over real HTTP</text>
  ...
  <text x="240" y="258" text-anchor="middle" font-size="12.5" fill="#55554F">one process, a service only where named</text>
