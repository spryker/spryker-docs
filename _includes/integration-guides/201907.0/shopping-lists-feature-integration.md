...
originalLink: https://documentation.spryker.com/v3/docs/shopping-lists-feature-integration
originalArticleId: f806410e-21ea-4476-a622-2665374eff42
redirect_from:
  - /v3/docs/shopping-lists-feature-integration
  - /v3/docs/en/shopping-lists-feature-integration
related:
...
```bash
composer require spryker-feature/shopping-lists:"^201907.0" --update-with-dependencies
```
...
<details open>
<summary markdown='span'>src/Pyz/Zed/ShoppingListStorage/Persistence/Propel/Schema/spy_shopping_list_customer_storage.schema.xml</summary>
...
<details open>
<summary markdown='span'>src/Pyz/Client/ShoppingListSession/ShoppingListSessionDependencyProvider.php</summary>
