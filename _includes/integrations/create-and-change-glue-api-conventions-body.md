...
To create a new convention, implement `ConventionPluginInterface`:
...
## Use a convention
To use the newly created convention, you must add it to the `GlueBackendApiApplicationDependencyProvider::getConventionPlugins()`.
