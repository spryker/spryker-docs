...
See also [Create and change Backend API conventions](/docs/integrations/spryker-glue-api/backend-api/developing-new-apis/create-glue-api-applications/create-and-change-glue-api-conventions.html) guide.
