...
For an example, see the default configuration file: [order_export_config.yml](https://github.com/spryker-shop/b2b-demo-marketplace/blob/master/data/export/production/order_export_config.yml).
...
Generate the data export files:
