...
| billingAddress | Object | &check; | Customer's billing [address](/docs/pbc/all/customer-relationship-management/{{page.version}}/manage-using-glue-api/customers/managing-customer-addresses.html). |
...
| shipment.shippingAddress | Object | &check; | Customer's shipping [address](/docs/pbc/all/customer-relationship-management/{{page.version}}/manage-using-glue-api/customers/managing-customer-addresses.html) for this shipment. |
