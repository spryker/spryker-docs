...
| concrete-product-prices| volumePrices | Array | An array of objects defining the [volume prices](/docs/pbc/all/price-management/{{page.version}}/base-shop/prices-feature-overview/volume-prices-overview.html) for the concrete product. |
| concrete-product-prices| netAmount | Integer | Net price in cents. |
| concrete-product-prices| grossAmount | Integer | Gross price in cents. |
