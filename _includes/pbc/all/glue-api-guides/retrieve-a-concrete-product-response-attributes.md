...
| isDiscontinued | Boolean | Specifies whether a product is [discontinued](/docs/scos/user/features/{{site.version}}/product-feature-overview/discontinued-products-overview.html):<br>**true** - the product is discontinued and requires a replacement item; <br> **false** - the product is not discontinued. |
