...
| CMS          | {{site.version}}  | [Install the CMS feature](/docs/pbc/all/content-management-system/install-and-upgrade/install-features/install-the-cms-feature.html) |
...
| ---------- | ----------------- | ---------------------------- |
| Content items |                                  | [Install the Content Items feature](/docs/pbc/all/content-management-system/install-and-upgrade/install-features/install-the-content-items-feature.html) |
| CMS           | ✓                                | [Install the CMS feature](/docs/pbc/all/content-management-system/install-and-upgrade/install-features/install-the-cms-feature.html) |
