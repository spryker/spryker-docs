...
For information on how to protect resources, see [Security and authentication](/docs/pbc/all/identity-access-manager/{{site.version}}/manage-using-glue-api/glue-api-security-and-authentication.html).
