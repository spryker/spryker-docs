...
* [Create a discount for the product](/docs/pbc/all/discount-management/{{page.version}}/manage-in-the-back-office/create-discounts.html). The discount application type should be promotional product.
* Create a cart.
...
* [Create a discount])(/docs/pbc/all/discount-management/{{page.version}}/manage-in-the-back-office/create-discounts.html). Discount application type should be promotional product.
