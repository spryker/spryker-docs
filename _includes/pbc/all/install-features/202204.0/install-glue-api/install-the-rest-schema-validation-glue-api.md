...
2. Create validation configuration:
    ...
    b. In the file, describe validation rules for endpoints. See [Validate REST request format](/docs/docs/scos/dev/glue-api-guides/{{site.version}}/glue-api-tutorials/validate-rest-request-format.html) for more details. Example:
