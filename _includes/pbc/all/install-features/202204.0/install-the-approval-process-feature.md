...
This document describes how to integrate the [Approval Process](/docs/pbc/all/cart-and-checkout/{{page.version}}/approval-process-feature-overview.html) into a Spryker project.
