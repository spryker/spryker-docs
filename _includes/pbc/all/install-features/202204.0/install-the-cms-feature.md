...
Verify the changes by adding a slot widget to a page. For references, see [Templates & Slots Feature Overview](/docs/scos/user/features/{{site.version}}/cms-feature-overview/templates-and-slots-overview.html).
...
3. Choose a slot in **List of Slots for [NAME] Template**. The `NAME` placeholder stands for the name of the template.
4. Select or [assign](/docs/scos/user/back-office-user-guides/{{site.version}}/content/slots/managing-slots.html#assigning-cms-blocks-to-slots) a CMS block to a slot in the **List of Blocks for [NAME] Slot**.
