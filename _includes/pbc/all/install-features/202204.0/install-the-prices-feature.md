...
| PriceProductWidget | Could be checked on a slot configurator page of a [Configurable Bundle](/docs/scos/user/features/{{site.version}}/configurable-bundle-feature-overview.html) feature. |
