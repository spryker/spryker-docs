...
Make sure that the provided rating value does not exceed [the configured maximum rating](/docs/pbc/all/ratings-reviews/tutorials-and-howtos/howto-configure-product-reviews.html#configure-the-maximum-rating) limit.
