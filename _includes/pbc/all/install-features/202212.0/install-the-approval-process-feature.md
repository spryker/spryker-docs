...
This document describes how to integrate the [Approval Proces feature](/docs/pbc/all/cart-and-checkout/{{site.version}}/approval-process-feature-overview.html) into a Spryker project.
...
| -------------- | ----------------- | ----------------- |
| Company Account | {{site.version}}|[Company Account feature](/docs/scos/dev/feature-integration-guides/{{site.version}}/company-account-feature-integration.html)| 
