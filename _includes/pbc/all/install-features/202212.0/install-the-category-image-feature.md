...
| PLUGIN | SPECIFICATION                                                     | PREREQUISITES | NAMESPACE |
| --- |-------------------------------------------------------------------| --- | --- |
| CategoryImagePublisherTriggerPlugin | Retrieves category images based on the provided limit and offset. | None | Spryker\Zed\CategoryImageStorage\Communication\Plugin\Publisher |
