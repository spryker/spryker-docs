...
| PriceProductWidget | Could be checked on a slot configurator page of a [Configurable Bundle](/docs/pbc/all/product-information-management/{{page.version}}/feature-overviews/configurable-bundle-feature-overview.html) feature. |
