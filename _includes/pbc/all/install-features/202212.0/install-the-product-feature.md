...
| ProductConcretePublisherTriggerPlugin | Trigger concrete products resource to be published. | None | Spryker\Zed\ProductPageSearch\Communication\Plugin\Publisher |
