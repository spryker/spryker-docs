...
It requires upgrading `spryker/smyfony:3.5.0` and applying some changes on the project, see [Symfony 5 integration](/docs/dg/dev/integrate-and-configure/integrate-symfony-5.html).
