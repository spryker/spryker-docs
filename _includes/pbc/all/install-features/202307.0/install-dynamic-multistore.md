...
You may need to update other modules. 
Below is an example of updating the Spryker Core module from version 202202.0 to 202307.0 with all dependencies for b2c-demo-shop:
...
```json
{
    ...
    "require": {
        ...
        "spryker/configurable-bundle-carts-rest-api": "^0.1.1",
        ...
        "spryker/customer-group-discount-connector": "^2.2.0",
        "spryker/customer-user-connector": "^1.0.3",
        "spryker/customer-user-connector-gui": "^1.4.0",
        "spryker/customers-rest-api": "^1.22.0",
        "spryker/discount-calculation-connector": "^5.3.0",
        "spryker/discount-promotions-rest-api": "^1.4.0",
        ...
        "spryker/product-discontinued-product-label-connector": "^1.5.0",
        ...
        "spryker/products-categories-resource-relationship": "^1.3.0",
        ...
        "spryker/currency":"^4.3.0",
        "spryker/country":"^4.3.0",
        "spryker/locale":"^4.3.0"
    },
    "require-dev": {
        ...
...
```bash
composer update spryker-feature/* spryker-shop/calculation-page spryker-shop/date-time-configurator-page-example spryker/app-catalog-gui spryker/availability-gui spryker/cart-currency-connector spryker/catalog-price-product-connector spryker/catalog-search-rest-api spryker/category-discount-connector spryker/checkout-rest-api spryker/cms-slot-block-product-category-connector spryker/cms-slot-locale-connector spryker/customers-rest-api spryker/money-gui spryker/oauth-customer-connector spryker/price-cart-connector spryker/product-alternative-product-label-connector spryker/product-bundle-discount-connector spryker/product-cart-connector spryker/product-discontinued-product-label-connector spryker/product-discount-connector spryker/product-options-rest-api spryker/product-prices-rest-api spryker/stores-rest-api spryker/tax-product-connector spryker/wishlists-rest-api spryker/currency spryker/country spryker/locale --with-all-dependencies
```

You may need to remove vendor directory and run project setup again:
```bash
rm -Rf vendor
docker/sdk up --data
```

For more details on how to update modules, see [Updating Spryker](/docs/dg/dev/updating-spryker/updating-spryker.html).
...
- Make sure that you can create a store with a store context assigned to it.
- Make sure that you can update a store with a store context assigned to it.
...
| PLUGIN | SPECIFICATION | PREREQUISITES | NAMESPACE |
|---|---|---|---|
| StoreSwitcherWidget | Provides functionality to display a store dropdown. |  | SprykerShop\Yves\StoreWidget\Widget |
