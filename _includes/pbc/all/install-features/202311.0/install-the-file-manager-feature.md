...
For additional details, refer to [Docker SDK configuration reference](/docs/dg/dev/sdks/the-docker-sdk/{{page.version}}/docker-sdk-configuration-reference.html)
