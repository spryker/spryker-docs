...
| CheckoutRestApiConfig::isRecalculationEnabledForQuoteMapperPlugins()    | Defines if quote recalculation in a stack of `QuoteMapperPluginInterface` plugins will be enabled.                        | Pyz\Zed\CheckoutRestApi  |
