...
Make sure that all the CMS entity changes performed manually in the Back Office are exported or removed from key-value storage (Redis or Valkey) and Elasticsearch accordingly.

| STORAGE TYPE | TARGET ENTITY | EXAMPLE EXPECTED DATA IDENTIFIER |
| --- | --- | --- |
| Redis or Valkey | CmsBlock | cms\_block:de:de\_de:blck-1 |
| Redis or Valkey | CmsBlockCategory | cms\_block\_category:5 |
| Redis or Valkey | CmsBlockProduct | cms\_block\_product:93 |
| Redis or Valkey | CmsPage | cms\_page:de:de\_de:1 |
| Redis or Valkey | CmsSlot | cms_slot:slt-1 |
| Redis or Valkey | CmsSlotBlock | cms\_slot\_block:@productdetailpage/views/pdp/pdp.twig:slt-5 |
...
| UrlStorageCmsPageMapperPlugin | Allows getting a page resource from key-value storage (Redis or Valkey). | None | Spryker\Client\CmsStorage\Plugin |
