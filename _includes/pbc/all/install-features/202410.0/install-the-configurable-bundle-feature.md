...
| Product Lists	 | {{page.release_tag}} | [Install the Product Lists feature](/docs/pbc/all/product-information-management/latest/base-shop/install-and-upgrade/install-features/install-the-product-lists-feature.html) |
...
```bash
composer require spryker-feature/configurable-bundle:"^{{page.release_tag}}" --update-with-dependencies
```
