...
| --- | --- | --- | --- |
| PriceProductStorage | PriceProductMerchantRelationshipStorageDimensionPlugin | Reads prices for merchant relations from key-value storage (Redis or Valkey) to show them in catalog. | getPriceDimensionPlugins |
