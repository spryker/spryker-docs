...
| ReleaseUsedCodesCheckoutDoSaveOrderPlugin                         | Otherwise decreases the number of uses of each of found discount codes by 1.                                                                                                                            | None                                                                                                                                             | Spryker\Zed\Discount\Communication\Plugin\Checkout                                   |
...
| DiscountSalesOrderItemCollectionPreDeletePlugin                   | Executes before order items deletion.                                                                                                                                                                   | None                                                                                                                                             | Spryker\Zed\Discount\Communication\Plugin\Sales                                      |
| SalesDiscountSalesExpensePreDeletePlugin                          | Executes before order expense deletion.                                                                                                                                                                 | None                                                                                                                                             | Spryker\Zed\Discount\Communication\Plugin\Sales                                      |
...
| GiftCardSalesOrderItemCollectionPreDeletePlugin                   | Executes before gift card order items deletion.                                                                                                                                                         | None                                                                                                                                             | Spryker\Zed\GiftCard\Communication\Plugin\Sales                                      |
| NopaymentSalesOrderItemCollectionPreDeletePlugin                  | Executes before no-payment order items deletion.                                                                                                                                                        | None                                                                                                                                             | Spryker\Zed\Nopayment\Communication\Plugin\Sales                                     |
...
| OmsItemHistorySalesOrderItemCollectionPreDeletePlugin             | Executes before OMS item history deletion.                                                                                                                                                              | None                                                                                                                                             | Spryker\Zed\Oms\Communication\Plugin\Sales                                           |
...
| ProductOptionSalesOrderItemCollectionPreDeletePlugin              | Executes before product option order items deletion.                                                                                                                                                    | None                                                                                                                                             | Spryker\Zed\ProductOption\Communication\Plugin\Sales                                 |
| SalesConfigurableBundleSalesOrderItemCollectionPreDeletePlugin    | Executes before configurable bundle order items deletion.                                                                                                                                               | None                                                                                                                                             | Spryker\Zed\SalesConfigurableBundle\Communication\Plugin\Sales                       |
...
| SalesProductConfigurationSalesOrderItemCollectionPreDeletePlugin  | Executes before product configuration order items deletion.                                                                                                                                             | None                                                                                                                                             | Spryker\Zed\SalesProductConfiguration\Communication\Plugin\Sales                     |
...
| ItemMetadataSalesOrderItemCollectionPreDeletePlugin               | Executes before item metadata deletion.                                                                                                                                                                 | None                                                                                                                                             | Spryker\Zed\SalesProductConnector\Communication\Plugin\Sales                         |
| SalesReclamationSalesOrderItemCollectionPreDeletePlugin           | Executes before reclamation order items deletion.                                                                                                                                                       | None                                                                                                                                             | Spryker\Zed\SalesReclamation\Communication\Plugin\Sales                              |
...
| ServicePointSalesOrderItemCollectionPreDeletePlugin               | Executes before service point order items deletion.                                                                                                                                                     | None                                                                                                                                             | Spryker\Zed\SalesServicePoint\Communication\Plugin\Sales                             |
