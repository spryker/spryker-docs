...
|---|---|---|
|Spryker Core| 202507.0 |[Glue Application](/docs/pbc/all/miscellaneous/latest/install-and-upgrade/install-glue-api/install-the-spryker-core-glue-api.html)|
|Product Relation| 202507.0 | [Install the Product Relations feature](/docs/pbc/all/product-relationship-management/latest/install-and-upgrade/install-the-product-relations-feature.html)|
|Cart| 202507.0 | [Cart API](/docs/pbc/all/cart-and-checkout/latest/base-shop/install-and-upgrade/install-glue-api/install-the-cart-glue-api.html) |
| Product| 202507.0 |[Products API](/docs/pbc/all/product-information-management/latest/base-shop/install-and-upgrade/install-glue-api/install-the-product-glue-api.html)|
