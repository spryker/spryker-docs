...
| OrderCustomReferenceCartPreReorderPlugin                      | Maps a custom order reference from an original order to a reorder quote.                     |               | Spryker\Zed\OrderCustomReference\Communication\Plugin\CartReorder       |
