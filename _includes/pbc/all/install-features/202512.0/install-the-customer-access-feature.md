...
This document describes how to install the [Customer Access feature](/docs/pbc/all/customer-relationship-management/{{page.version}}/base-shop/customer-access-feature-overview.html).
...
Make sure that when a customer access rule is created, updated, or deleted, it's exported (or removed) to the key-value store (Redis or Valkey).
