...
|-------------------|------------------|------------------|
| Data Exchange API | 202507.0 | [Install the Data Exchange API](/docs/pbc/all/data-exchange/{{page.version}}/install-and-upgrade/install-the-data-exchange-api.html) |
