...
| Product Approval Process | 202507.0 | [Install the Product Approval Process feature](/docs/pbc/all/product-information-management/{{page.version}}/base-shop/install-and-upgrade/install-features/install-the-product-approval-process-feature.html) |
...
```bash
composer require spryker-feature/marketplace-product-approval-process:"202507.0" --update-with-dependencies
```
