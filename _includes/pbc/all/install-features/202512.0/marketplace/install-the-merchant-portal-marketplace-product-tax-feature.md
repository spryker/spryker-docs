...
| Tax | 202507.0 | [Install the Tax feature](https://github.com/spryker-feature/tax) |
...
```bash
composer require spryker/tax-merchant-portal-gui:"202507.0" --update-with-dependencies
```
