...
| Product Measurement Units | 202507.0 | [Install the Product Measurement Units feature](/docs/pbc/all/product-information-management/latest/base-shop/install-and-upgrade/install-features/install-the-measurement-units-feature.html) |
...
Make sure that the following key-value store (Redis or Valkey) keys exist and there is data in them:
