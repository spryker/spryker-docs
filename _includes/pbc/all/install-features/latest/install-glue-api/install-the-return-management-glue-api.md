...
| --- | --- | --- |
| Spryker Core | {{site.versionid}} | [Feature API](/docs/pbc/all/miscellaneous/latest/install-and-upgrade/install-features/install-the-spryker-core-feature.html) |
...
```bash
composer require spryker/sales-returns-rest-api:"{{site.versionid}}" --update-with-dependencies
```
