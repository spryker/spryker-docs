...
```bash
composer require spryker-feature/catalog:"{{site.versionid}}" spryker-feature/cms:"{{site.versionid}}" spryker-shop/tabs-widget-extension:"^1.0.0" --update-with-dependencies
```
