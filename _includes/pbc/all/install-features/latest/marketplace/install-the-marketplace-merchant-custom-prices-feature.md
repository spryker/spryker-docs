...
|----------------|------------------|-------------------|
| Merchant Custom Prices                         | {{site.versionid}} | [Install the Merchant Custom Prices feature](/docs/pbc/all/price-management/latest/base-shop/install-and-upgrade/install-features/install-the-merchant-custom-prices-feature.html)                                    |
| Marketplace Merchant Portal Product Management | {{site.versionid}} | [Install the Merchant Portal - Marketplace Product feature](/docs/pbc/all/merchant-management/latest/marketplace/install-and-upgrade/install-features/install-the-merchant-portal-marketplace-product-feature.html) |
...
```bash
composer require spryker-feature/marketplace-merchant-custom-prices:"{{site.versionid}}" --with-dependencies
```
