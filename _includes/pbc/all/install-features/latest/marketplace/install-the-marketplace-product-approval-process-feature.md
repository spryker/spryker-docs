...
| Product Approval Process | {{site.versionid}} | [Install the Product Approval Process feature](/docs/pbc/all/product-information-management/latest/base-shop/install-and-upgrade/install-features/install-the-product-approval-process-feature.html) |
...
```bash
composer require spryker-feature/marketplace-product-approval-process:"{{site.versionid}}" --update-with-dependencies
```
