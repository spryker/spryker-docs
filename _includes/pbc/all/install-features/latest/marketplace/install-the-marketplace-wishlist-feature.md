...
| Marketplace Product + Marketplace Product Offer | {{site.versionid}} | [Install the Marketplace Product + Marketplace Product Offer feature](/docs/pbc/all/product-information-management/latest/marketplace/install-and-upgrade/install-features/install-the-marketplace-product-marketplace-product-offer-feature.html) |
...
```bash
composer require spryker-feature/marketplace-wishlist:"{{site.versionid}}" --update-with-dependencies
```
