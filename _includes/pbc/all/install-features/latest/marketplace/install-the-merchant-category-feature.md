...
```bash
composer require spryker-feature/merchant-category:"{{site.versionid}}"  --update-with-dependencies
```
...
| -------- | ------ | -------------- |
| Spryker Core | {{site.versionid}} | [Install the Spryker Core feature](/docs/pbc/all/miscellaneous/latest/install-and-upgrade/install-features/install-the-spryker-core-feature.html) |
| Merchant     | {{site.versionid}} | [[DEPRECATED\] Merchant Feature Integration](https://github.com/spryker-feature/merchant) |
