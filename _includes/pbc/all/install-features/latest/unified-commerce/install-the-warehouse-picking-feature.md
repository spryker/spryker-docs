...
| Push Notification                       | {{page.release_tag}} | [Install the Push Notification feature](/docs/pbc/all/miscellaneous/latest/install-and-upgrade/install-features/install-the-push-notification-feature.html)                                     |
...
```bash
composer require spryker-feature/warehouse-picking: "{{page.release_tag}}" --update-with-dependencies
```
