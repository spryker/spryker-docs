...
| ----------- | ------ | --------------|
| Merchant Opening Hours | 202507.0  | [Install the Merchant Opening Hours feature](/docs/pbc/all/merchant-management/{{page.version}}/marketplace/install-and-upgrade/install-features/install-the-merchant-opening-hours-feature.html) |
