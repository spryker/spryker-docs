...
| Product Prices API | 202507.0 |[Install the Product Prices Glue API](/docs/pbc/all/price-management/{{page.version}}/base-shop/install-and-upgrade/install-the-product-price-glue-api.html) |
