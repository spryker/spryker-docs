...
| ----------- | ------ | --------------|
| Merchant Opening Hours | {{page.release_tag}}  | [Install the Merchant Opening Hours feature](/docs/pbc/all/merchant-management/latest/marketplace/install-and-upgrade/install-features/install-the-merchant-opening-hours-feature.html) |
