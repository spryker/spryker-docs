...
**Oms version >= 4** is required. See the [Migration Guide - OMS](/docs/pbc/all/order-management-system/{{site.version}}/base-shop/install-and-upgrade/upgrade-modules/upgrade-the-oms-module.html) to version 4 step by step guide how to migrate OMS to have the new Availability module integrated.
