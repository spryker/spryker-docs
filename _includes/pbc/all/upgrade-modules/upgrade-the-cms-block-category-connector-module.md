...
The script can be found in [Migration Guide - CMS Block Category Connector Console](/docs/pbc/all/content-management-system/install-and-upgrade/upgrade-modules/upgrade-the-cms-block-category-connector-module.html).
