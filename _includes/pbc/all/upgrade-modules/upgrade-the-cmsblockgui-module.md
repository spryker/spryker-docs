...
1. Install/update `spryker/cms-block` to at least version 2.0.0. For more information, see [Migration Guide - CMS Block](/docs/pbc/all/content-management-system/{{site.version}}/install-and-upgrade/upgrade-modules/upgrade-the-cmsblock-module.html).
