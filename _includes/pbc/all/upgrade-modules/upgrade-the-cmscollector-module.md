...
Upgrade the `spryker/cms` module to at least 6.2 version. See [Migration Guide - CMS](/docs/pbc/all/content-management-system/{{site.version}}/base-shop/install-and-upgrade/upgrade-modules/upgrade-the-cms-module.html) for more details.
