...
The tax plugins are using the version 3.* of the Tax module. See [Migration Guide - Tax](/docs/pbc/all/tax-management/{{site.version}}/install-and-upgrade/upgrade-the-tax-module.html) for more details.
