...
2. Install/Update `spryker/currency` to at least version 3.0.0. See [Migration Guide - Currency](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-currency-module.html) for more details.
3. Install/Update `spryker/price` to at least version 5.0.0. See [Migration Guide - Price](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-price-module.html) for more details.
