...
1. Update `spryker/quote-request:^2.0.` by following the steps from the [Upgrade the QuoteRequest module](/docs/scos/dev/module-migration-guides/migration-guide-quoterequest.html)
