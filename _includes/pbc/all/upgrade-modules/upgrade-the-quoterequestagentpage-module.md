...
1. Update `spryker/quote-request-agent` to version ^2.0.0 by following the steps from [Upgrade the QuoteRequest module](/docs/scos/dev/module-migration-guides/migration-guide-quoterequest.html).
