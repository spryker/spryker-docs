...
| [glue-api-storefront-guide-template](https://github.com/spryker/spryker-docs/blob/master/_templates/glue-api-storefront-guide-template.md) | Use this template for creating [Storefront API guides](/docs/pbc/all/customer-relationship-management/{{site.version}}/base-shop/manage-using-glue-api/company-account/glue-api-retrieve-company-users.html)—endpoints a Storefront customer calls. |
| [glue-api-backend-guide-template](https://github.com/spryker/spryker-docs/blob/master/_templates/glue-api-backend-guide-template.md) | Use this template for creating [Backend API guides](/docs/pbc/all/customer-relationship-management/{{site.version}}/base-shop/manage-using-glue-api/company-account/backend-api-manage-companies.html)—endpoints served on the Glue Backend application and authorized with a Back Office user access token. Do not use the Storefront template for these: it adds a note about Storefront serving infrastructure that does not apply to Backend API endpoints. |
