...
<details>
<summary>Marketplace B2C feature list</summary>
...
To download the Marketplace B2C Demo Shop, see the following [Marketplace B2C Demo Shop GitHub repository](https://github.com/spryker-shop/b2c-demo-marketplace).
