...
| dependencies     | An array of objects represented as application dependencies. Dependencies array is one dimentional array where key is a dependency name, and value is it's version.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | See *dependencies example* under this table.                                                                                                                                                                                                                                                                                                                                                                                                            |
