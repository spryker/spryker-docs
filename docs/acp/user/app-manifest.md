...
| dependencies     | An object represented as application dependencies. Each property is an dependency that could be either a string or more detailed object indicating what are the compatible business models.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | See *dependencies example* under this table.                                                                                                                                                                                                                                                                                                                                                                                                            |
