...
| messages         | Optional. An array of objects represented as application messages. The message object has following keys: <ul><li>`type` - Mandatory. Message type (available types: `text`).</li><li>`data` - Mandatory. Message data.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | See *message example* under this table.
