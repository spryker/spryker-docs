...
| dependencies     | An array of objects represented as application dependencies. The dependency object has following keys: <ul><li>`name` - Mandatory. Dependency name.</li><li>`version` - Mandatory. Dependency version.</li><li>`compatibleBusinessModels` - Optional. Array of strings. Has to match `businessModels`.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                       | See *dependency example* under this table.
