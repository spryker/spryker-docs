...
- *DDOS prevention or mitigation checked and implemented.*
    ...
    - Check your concepts for DOS and DDOS prevention Admin panel and/or Merchant portal. Add basic auth if applicable. More details can be found [here](https://docs.spryker.com/docs/pbc/all/identity-access-management/202311.0/configure-basic-htaccess-authentication.html#define-login-details-and-endpoints)
...
- Security guidelines are applied. More information can be found [here](https://docs.spryker.com/docs/scos/dev/guidelines/security-guidelines.html)
- Double-check that you do not have any clear text passwords stored in config files or repositories.
...
// Doc team help is needed. Can we move "Email quota restrictions" to a separate page with all the restrictions and / or limitations? 
...
// Doc team help is needed. Can we move "DNS setup" to a separate page with how to or similar and link it to existing here DNS section
...
- *Code freeze*. Recomendation is to have a code freeze at least two weeks before go live.
...
- *Define the exact plan for go-live day.*:
