...
- Please make sure that you have implemented (if applicable) our suggested Jenkins [performance and stability improvements](https://docs.spryker.com/docs/scos/dev/tutorials-and-howtos/howtos/howto-reduce-jenkins-execution-costs-without-refactoring.html) and are observing general [Publish and Sync stability best practices](https://docs.spryker.com/docs/ca/dev/best-practices/best-practises-jenkins-stability.html#memory-management) 
...
- *Validate BI and Analytics Integrations* These should not be connected to your production database, but should be connected to the provided read replica. Please make sure that no external system is working with your production database
