...
- If possible, check whether you can implement payment options in a redunant fashion so that if one payment provider is suffering an outage, customers can still pay with another one.
