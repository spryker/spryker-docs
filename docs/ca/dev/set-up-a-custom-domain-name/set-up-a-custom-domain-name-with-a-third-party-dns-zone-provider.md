...
Domains are defined in a [deploy.*.yml](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/deploy-file/deploy-file-reference.html) file used by the [Docker SDK](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/the-docker-sdk.html) tool to build applications.
...
See [Deploy file reference](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/deploy-file/deploy-file-reference.html) to learn more about deploy file configuration.
