...
Domains are defined in a [deploy.*.yml](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/deploy-file/deploy-file-reference-1.0.html) file used by the [Docker SDK](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/the-docker-sdk.html) tool to build applications.
...
See [Deploy File Reference - 1.0](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/deploy-file/deploy-file-reference-1.0.html) to learn more about deploy file configuration.
