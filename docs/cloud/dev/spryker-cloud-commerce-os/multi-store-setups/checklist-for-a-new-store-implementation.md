...
For detailed steps about the new store implementation, see [HowTo: Set up multiple stores](/docs/pbc/all/dynamic-multistore/{{site.version}}/base-shop/tutorials-and-howtos/set-up-multiple-stores.html).
