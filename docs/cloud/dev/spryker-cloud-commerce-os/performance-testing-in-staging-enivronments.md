...
Testing with real data gives significantly better and more reliable results than testing with a small data set. To conduct effective performance tests, you should use the same amount of data that will be used in the production environment.
...
For information on how to import data into your staging environment, we also provide guides on [data import]( /docs/scos/dev/sdk/data-import.html).
