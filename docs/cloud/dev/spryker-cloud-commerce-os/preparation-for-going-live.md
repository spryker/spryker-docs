...
It is critical to start working with data of realistic size an quality as early as possible. At this point, you should be importing data regularly to all your environments. It is best practise to work with the same import data across all your environments. This will significantly simplify troublehshooting, as well as help you estimate import performance leading up to your go live as well as heling us with environment sizing considerations. We expect all our customers to follow this advice.
{% endinfo_block %}
...
Please note that the PaaS Email service has the following quotas. Please make sure to reach out to Spryker Support if these are not sufficient to support your use case.
Daily Sending Limit: 50.000 emails
Sending Limit Message/Second: 14 
{% endinfo_block %}
