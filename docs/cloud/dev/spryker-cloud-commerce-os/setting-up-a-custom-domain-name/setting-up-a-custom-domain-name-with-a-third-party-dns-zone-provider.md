...
Domains are defined in a [deploy.*.yml](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html) file used by the [Docker SDK](/docs/scos/dev/the-docker-sdk/the-docker-sdk.html) tool to build applications.
...
See [Deploy File Reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html) to learn more about deploy file configuration.
