...
- [Glue](/docs/integrations/{{site.version}}/spryker-glue-api/storefront-api/developing-apis/storefront-infrastructure.html) — provides infrastructure for API endpoints.
