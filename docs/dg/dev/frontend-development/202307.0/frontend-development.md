...
* [Migration guide – Switch from TSLint to ESLint](/docs/dg/dev/upgrade-and-migrate/migrate-from-tslint-to-eslint.html)
...
* [Migration guide - Upgrade to Webpack v5](/docs/dg/dev/upgrade-and-migrate/upgrade-to-webpack-v5.html)
