...
redirect_from:
- /docs/scos/dev/front-end-development/202311.0/oryx/building-components/oryx-integrating-components.html
...
The integration of the [server-side rendering](/docs/dg/dev/frontend-development/{{page.version}}/oryx/architecture/oryx-server-side-rendering.html) part might be quite complex.
{% endinfo_block %}
