...
- /docs/scos/dev/front-end-development/202404.0/marketplace/table-design/table-configuration.html
...
- [Datasource](/docs/dg/dev/frontend-development/latest/marketplace/ui-components-library/datasources/datasources.html) type that describes how the data should be provided to a table.
...
To get more details about the table columns, see [Column Types](/docs/dg/dev/frontend-development/latest/marketplace/table-design/table-column-type-extension/table-column-type-extension.html).
