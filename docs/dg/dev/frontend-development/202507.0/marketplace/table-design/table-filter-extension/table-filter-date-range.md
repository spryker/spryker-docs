...
redirect_from:
  ...
  - /docs/scos/dev/front-end-development/202404.0/marketplace/table-design/table-filter-extension/table-filter-date-range.html

related:
  - title: Table Filter extension
    link: docs/dg/dev/frontend-development/202507.0/marketplace/table-design/table-filter-extension/table-filter-extension.html
