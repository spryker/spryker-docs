...
To learn more about Oryx presets and feature sets, which often work hand in hand with compositions, see [Presets](/docs/dg/dev/frontend-development/latest/oryx/building-applications/oryx-presets.html) and [Feature sets](/docs/dg/dev/frontend-development/latest/oryx/building-applications/oryx-feature-sets.html).
