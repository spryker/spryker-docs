...
redirect_from:
  ...
  - /docs/scos/dev/glue-api-guides/202212.0/glue-api-tutorials/b2c-api-react-example/b2c-api-react-example.html
...
related:
  ...
  - title: Glue REST API
    link: docs/dg/dev/glue-api/page.version/old-glue-infrastructure/glue-rest-api.html
---
...
| Product Availability API | [Retrieve abstract product availability](/docs/pbc/all/warehouse-management-system/{{page.version}}/base-shop/manage-using-glue-api/glue-api-retrieve-abstract-product-availability.html)<br>[Retrieve concrete product availability](/docs/dg/dev/glue-api/{{site.version}}/managing-products/concrete-products/retrieving-concrete-product-availability.html) |
...
| Customer API | [Managing customers](/docs/dg/dev/glue-api/{{site.version}}/managing-customers/managing-customers.html) |
