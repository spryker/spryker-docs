...
redirect_from:
  ...
  - /docs/scos/dev/glue-api-guides/202212.0/glue-api-tutorials/extend-a-rest-api-resource.html
...
If you have a development virtual machine with the [B2C Demo Shop](/docs/about/all/intro-to-spryker.html#spryker-b2bb2c-demo-shops) installed, all the required components are available out of the box.
