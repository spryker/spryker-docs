...
By default, the option is enabled on the Spryker Core level but disabled on the project level in all [Spryker Demo Shops](/docs/about/all/intro-to-spryker.html#demo-shops) (B2B Demo Shop, B2C Demo Shop and Master Shop Suite).
