...
redirect_from:
  - /docs/scos/dev/glue-api-guides/202311.0/old-glue-infrastructure/glue-rest-api.html
...
For more details, see [Glue Infrastructure](/docs/dg/dev/glue-api/{{page.version}}/old-glue-infrastructure/glue-infrastructure.html).
...
For more deatails about installing and running, see [B2C API React example](/docs/dg/dev/glue-api/{{page.version}}/glue-api-tutorials/b2c-api-react-example/b2c-api-react-example.html).
