...
For more information on route plugins, see the [Resource routing](/docs/dg/dev/glue-api/{{page.version}}/rest-api/glue-infrastructure.html#resource-routing) section in *Glue Infrastructure*.
