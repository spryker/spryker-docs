...
Below, you can find information about [the differences between backend and storefront API modules](/docs/dg/dev/glue-api/latest/backend-and-storefront-api-module-differences.html) and [Authentication integration.](/docs/dg/dev/upgrade-and-migrate/migrate-to-decoupled-glue-infrastructure/decoupled-glue-infrastructure-integrate-the-authentication.html).
...
- [Create protected Glue API endpoints](/docs/dg/dev/glue-api/latest/create-protected-glue-api-endpoints.html)
- [Use API Key authorization](/docs/dg/dev/glue-api/latest/use-api-key-authorization.html)
