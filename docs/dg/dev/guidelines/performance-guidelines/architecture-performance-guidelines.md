...
We strongly recommend our customers enable APM systems for their projects. Spryker supports [Newrelic](/docs/dg/dev/miscellaneous-guides/advanced-tutorials/tutorial-new-relic-monitoring.html) as the default monitoring system.
