...
3. Submit an infrastructure change request via the [Support Portal](/docs/about/all/support/how-to-use-the-support-portal.html).
...
If you update the name of an application, [contact support](/docs/about/all/support/how-to-use-the-support-portal.html) to update the changes in your APM.
