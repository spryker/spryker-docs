...
| `spryker/twig` | Twig template engine required for Web Profiler UI |
...
class GlueApplicationDependencyProvider extends SprykerGlueApplicationDependencyProvider
{
    ...
    protected function getApplicationPlugins(): array
    {
        ...
        if (class_exists(WebProfilerApplicationPlugin::class) && class_exists(TwigApplicationPlugin::class)) {
            $plugins[] = new TwigApplicationPlugin();
