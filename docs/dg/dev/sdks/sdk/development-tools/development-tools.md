...
redirect_from:
  ...
  - /docs/sdk/dev/development-tools/development-tools.html
...
* [Code Sniffer](/docs/dg/dev/sdks/sdk/development-tools/code-sniffer.html)
* [Performance audit tool – Benchmark](/docs/dg/dev/sdks/sdk/development-tools/benchmark-performance-audit-tool.html)
* [PHPstan](/docs/dg/dev/sdks/sdk/development-tools/phpstan.html)
* [Static Security Checker](/docs/dg/dev/sdks/sdk/development-tools/static-security-checker.html)
* [Tooling config file](/docs/dg/dev/sdks/sdk/development-tools/tooling-configuration-file.html)
