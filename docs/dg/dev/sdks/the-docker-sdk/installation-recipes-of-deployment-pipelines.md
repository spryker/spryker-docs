...
The default recipe for any project is [config/install/docker.yml](https://github.com/spryker-shop/b2c-demo-shop/blob/master/config/install/docker.yml). You can define a different recipe in a [deploy](/docs/dg/dev/sdks/the-docker-sdk/deploy-file/deploy-file.html) file. The default value is as follows:
