...
Spryker is compatible with PHP 8.5. Support for PHP 8.4 was added in August 2025, and support for PHP 8.3 in September 2024.

We recommend using PHP 8.5. PHP 8.3 remains the minimum supported version, but its support will be dropped in July 2027, so plan your migration before that date.
More and more libraries deliver releases, including bug fixes and security updates, only for the latest PHP versions, so staying on an older version becomes an increasing risk factor for any business.
...
- [New Features PHP8.5](https://www.php.net/manual/en/migration85.new-features.php)
...
- [Backward Incompatible Changes PHP8.5](https://www.php.net/manual/en/migration85.incompatible.php)
...
- [Deprecated Features PHP8.5](https://www.php.net/manual/en/migration85.deprecated.php)
...
- [Other Changes PHP8.5](https://www.php.net/manual/en/migration85.other-changes.php)
