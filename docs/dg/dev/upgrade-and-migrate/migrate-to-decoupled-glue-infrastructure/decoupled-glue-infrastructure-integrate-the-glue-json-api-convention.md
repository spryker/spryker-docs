...
To verify that everything is set up correctly, and you can access the endpoint, see [Create backend resources](/docs/integrations/spryker-glue-api/backend-api/developing-apis/create-backend-resources.html).
