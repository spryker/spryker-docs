...
Before starting the migration, make sure that Webpack is v5; if it's v4, the [Webpack migration guide](/docs/dg/dev/frontend-development/{{page.version}}/migration-guide-upgrade-to-webpack-v5.html) is required.
