...
Zed API, initially released as a beta version, is now considered outdated and is no longer being developed. Instead of it, we recommend using [Glue Backend API](/docs/integrations/spryker-glue-api/storefront-api/developing-apis/storefront-infrastructure.html).
