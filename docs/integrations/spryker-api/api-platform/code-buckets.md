...
redirect_from:
  - /docs/dg/dev/architecture/api-platform/code-buckets.html
---
...
For detailed testing guidance, see [Test API Platform resources](/docs/integrations/spryker-api/api-platform/testing.html).
...
For more troubleshooting guidance, see [API Platform Troubleshooting](/docs/integrations/spryker-api/api-platform/troubleshooting.html).

## Next steps

- [Resource schemas](/docs/integrations/spryker-api/api-platform/resource-schemas.html) - Deep dive into schema syntax
...
- [Test API Platform resources](/docs/integrations/spryker-api/api-platform/testing.html) - Testing your resources
