...
redirect_from:
  - /docs/dg/dev/architecture/api-platform/validation-schemas.html
---
...
- [Resource schemas](/docs/integrations/spryker-api/api-platform/resource-schemas.html) - Define resource structure
