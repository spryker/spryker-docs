...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/authenticating-and-authorization/backend-api/use-api-key-authorization.html
---
...
To be able to generate the API key in the Back Office, make sure the required features are installed. For the installation guidelines, see [Integrate the API Key Authorization](/docs/integrations/spryker-api/backend-api/integrate-backend-api/integrate-api-key-authorization.html).
