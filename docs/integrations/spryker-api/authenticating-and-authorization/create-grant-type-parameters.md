...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/authenticating-and-authorization/create-grant-type-parameters.html
---

This document explains how to create and use a [grant type](https://oauth.net/2/grant-types/) parameter.

Integrate authentication following the [Backend API Authentication integration](/docs/integrations/spryker-api/backend-api/integrate-backend-api/integrate-the-authentication.html) guide.
