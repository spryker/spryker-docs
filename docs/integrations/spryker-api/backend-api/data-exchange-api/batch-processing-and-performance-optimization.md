...
redirect_from:
  - /docs/integrations/spryker-glue-api/backend-api/data-exchange-api/batch-processing-and-performance-optimization.html
---
...
For configuration details, see [Configure Data Exchange API endpoints](/docs/integrations/spryker-api/backend-api/data-exchange-api/configure-data-exchange-api.html).
