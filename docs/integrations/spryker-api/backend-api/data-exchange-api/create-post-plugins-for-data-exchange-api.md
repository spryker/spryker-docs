...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/data-exchange-api/create-post-plugins-for-data-exchange-api.html
---
...
1. Configure the Product entity in `spy_dynamic_entity_configuration`. For instructions, see [Configure Data Exchange API](/docs/integrations/spryker-api/backend-api/data-exchange-api/configure-data-exchange-api.html).
2. Send a POST request to import product data. For instructions, see [Sending requests to Data Exchange API](/docs/integrations/spryker-api/backend-api/data-exchange-api/sending-requests-to-data-exchange-api.html).
3. Send a GET request to check if the product is activated. For instructions, see [Sending requests to Data Exchange API](/docs/integrations/spryker-api/backend-api/data-exchange-api/sending-requests-to-data-exchange-api.html).
