...
template: default
redirect_from:
  - /docs/integrations/spryker-glue-api/backend-api/data-exchange-api/data-exchange-api-limitations.html
---
...
- Additional business logic that you might want to execute together with data saving is only possible after the data has been saved via [Post Plugins](/docs/integrations/spryker-api/backend-api/data-exchange-api/create-post-plugins-for-data-exchange-api.html).
