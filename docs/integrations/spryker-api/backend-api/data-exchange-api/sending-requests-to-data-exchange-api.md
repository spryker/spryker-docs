...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/data-exchange-api/sending-requests-to-data-exchange-api.html
---
...
<!-- The Message column quotes verbatim API error messages; do not reword them. -->
<!-- vale Spryker.over-politeness = NO -->
...
<!-- vale Spryker.over-politeness = YES -->
