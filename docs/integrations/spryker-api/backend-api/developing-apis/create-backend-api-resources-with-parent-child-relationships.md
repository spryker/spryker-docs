...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/developing-apis/create-backend-api-resources-with-parent-child-relationships.html
---
...
1. Create a resource using the steps described in the [Create Backend resources](/docs/integrations/spryker-api/backend-api/developing-apis/create-backend-resources.html) guide.
