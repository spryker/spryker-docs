...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/integrate-backend-api/integrate-api-key-authorization.html
---
...
Follow the instructions from [Use API Key authorization](/docs/integrations/spryker-api/authenticating-and-authorization/backend-api/use-api-key-authorization.html) to check that the API Key authorization has been integrated properly.
