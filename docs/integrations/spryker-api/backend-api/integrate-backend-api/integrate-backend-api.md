...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/integrate-backend-api/integrate-backend-api.html
---
...
```bash
composer require spryker/glue-backend-api-application:"^1.7.0" --update-with-dependencies
```
