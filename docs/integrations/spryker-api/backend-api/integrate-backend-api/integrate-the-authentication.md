...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/integrate-backend-api/integrate-the-authentication.html
---
...
Apply the following changes only if [Integrate the API Key authorization](/docs/integrations/spryker-api/backend-api/integrate-backend-api/integrate-api-key-authorization.html) is integrated.
