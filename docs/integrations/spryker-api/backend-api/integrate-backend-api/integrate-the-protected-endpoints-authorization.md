...
redirect_from:
  ...
  - /docs/integrations/spryker-glue-api/backend-api/integrate-backend-api/integrate-the-protected-endpoints-authorization.html
---
...
| -------------- | ----------------- | ----------------- |
| Backend API Authentication | {{site.version}} | [Backend API Authentication itegration](/docs/integrations/spryker-api/backend-api/integrate-backend-api/integrate-the-authentication.html) |
...
To verify that everything is set up correctly and the route is protected, see [Create protected Backend API endpoints](/docs/integrations/spryker-api/authenticating-and-authorization/backend-api/create-protected-backend-api-endpoints.html).
