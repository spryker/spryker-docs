...
template: default
redirect_from:
  - /docs/integrations/spryker-glue-api/getting-started-with-apis/api-roadmap-and-adoption.html
---

This page continues the [Spryker API Strategy](/docs/integrations/spryker-api/getting-started-with-apis/api-strategy.html). It covers the API types on the roadmap, how to choose one, why API Platform integration, your migration decision, and the rollout timeline.
...
| Glue REST module migration | In progress | Spryker-provided modules move to API Platform. Check the [migration status page](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/migrate-to-api-platform-status.html) |
