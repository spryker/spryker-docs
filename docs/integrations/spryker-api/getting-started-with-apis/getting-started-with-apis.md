...
description: Overview of the Spryker APIs, Storefront API and Backend API, and the Spryker API strategy.
...
<div class="grid_container">
  <div class="cst_cards_2">
    <div class="cst_card">
      ...
      <a class="cst_card_button" href="/docs/integrations/spryker-api/storefront-api/storefront-api.html">Learn more</a>
    </div>
    <br>
    <div class="cst_card">
      ...
      <a class="cst_card_button" href="/docs/integrations/spryker-api/backend-api/backend-api.html">Learn more</a>
    </div>
    <br>
    <div class="cst_card">
      <div class="cst_card_title">Spryker API Strategy for 2026</div>
      <div class="cst_card_desc">Spryker is evolving its API strategy by introducing <b>API Platform–based integration</b> as a <b>new, strategic integration layer</b>, while continuing to <b>fully support existing Glue APIs</b>.</div>
      <a class="cst_card_button" href="/docs/integrations/spryker-api/getting-started-with-apis/api-strategy.html">Learn more</a>
    </div>
  </div>
</div>
