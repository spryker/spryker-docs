...
related:
  ...
  - title: Migrate to API Platform (per module)
...
- **API Platform is integrated** at the project level (bundles registered, project configuration applied, Symfony container compiled). See [Integrate API Platform](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/integrate-api-platform.html).
- **PHP 8.3+ and Symfony 6.4+.**
- **You know which modules you're migrating.** The [Glue API to API Platform migration status page](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/migrate-to-api-platform-status.html) lists every module, its migration status, and its prerequisites.
...
API Platform must be integrated at the project level before any module can be served through it. This is the integration step, not part of the migration itself — follow [Integrate API Platform](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/integrate-api-platform.html), which covers:
