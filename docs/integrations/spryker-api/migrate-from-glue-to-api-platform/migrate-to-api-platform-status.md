...
redirect_from:
  ...
  - /docs/dg/dev/architecture/api-platform/migrate-to-api-platform-status.html
related:
...
{% info_block infoBox "Looking for the migration steps?" %}

This page only tracks **which** modules are available on API Platform and their status. The end-to-end migration steps—upgrade the modules, confirm configuration, flip routing, verify, and clean up—are owned by the [API Platform migration overview](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/migrate-to-api-platform-overview.html). See also:

- [Migrate to API Platform](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/migrate-to-api-platform.html) (per module)
- [Integrate API Platform](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/integrate-api-platform.html)
...
- [API Platform architecture](/docs/integrations/spryker-api/api-platform/api-platform.html)
