...
template: default
redirect_from:
  - /docs/integrations/spryker-glue-api/storefront-api/adding-products-to-cart.html
---
...
For the complete contract of the endpoints used in this document—all request attributes, response fields, and error codes—see the following references:

- [Manage carts of registered users](/docs/pbc/all/cart-and-checkout/latest/base-shop/manage-using-glue-api/manage-carts-of-registered-users/glue-api-manage-carts-of-registered-users.html)
- [Manage items in carts of registered users](/docs/pbc/all/cart-and-checkout/latest/base-shop/manage-using-glue-api/manage-carts-of-registered-users/glue-api-manage-items-in-carts-of-registered-users.html)
- [Manage guest cart items](/docs/pbc/all/cart-and-checkout/latest/base-shop/manage-using-glue-api/manage-guest-carts/glue-api-manage-guest-cart-items.html)
