...
description: Implement versioning for REST API resources on the Glue infrastructure so that clients can request a specific resource version.
...
If necessary, you can implement versioning for built-in resources as well as [extend](/docs/integrations/spryker-api/storefront-api/developing-apis/extend-a-storefront-api-resource.html) the corresponding resource module on the project level.
...
For more information on route plugins, see [Resource routing](/docs/integrations/spryker-api/storefront-api/developing-apis/glue-infrastructure.html#resource-routing).
