...
redirect_from:
  ...
  - /docs/dg/dev/glue-api/latest/glue-api-tutorials/validate-rest-request-format.html
  - /docs/integrations/spryker-glue-api/storefront-api/developing-apis/validate-rest-request-format.html
related:
