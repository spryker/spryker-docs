...
This document describes the `merchant.csv` file to configure [merchant](/docs/marketplace/user/features/{{ site.version }}/marketplace-merchant/marketplace-merchant-feature-overview/merchant-feature-overview.html) information in your Spryker shop.
