...
This document describes the `merchant_stock.csv` file to configure [merchant stock](/docs/marketplace/user/features/{{ site.version }}/merchant/merchant-feature-overview/merchant-feature-overview.html#merchant-warehouse) information in your Spryker shop.
...
| stock_name         | &check;             | String   |                   | Stock name is defined as described in [merchant warehouse](/docs/marketplace/user/features/{{ site.version }}/merchant/merchant-feature-overview/merchant-feature-overview.html#merchant-warehouse). | Name of the stock.                        |
