...
Spryker’s customers need to import data from other systems into their Spryker Marketplace project. The _Data import_ section holds information all the needed information for that. For more details, see the following documents:
