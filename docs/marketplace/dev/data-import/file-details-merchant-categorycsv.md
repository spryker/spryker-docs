...
This document describes the `merchant_category.csv` file to configure [merchant categories](https://spryker-docs.herokuapp.com/docs/marketplace/user/features/202106.0/merchants/merchants-feature-overview.html#merchant-category) in your Spryker shop.
