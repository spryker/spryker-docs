...
| ProductOfferShoppingListWidget       | Go to product page and verify that product offer's merchants are displayed and items are added to shopping list with correct merchant names.                                                                                                                                                                                                                                                                    |
