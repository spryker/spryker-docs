...
| Spryker Core Back Office | {{page.version}}      | [Spryker Core feature integration](/docs/pbc/all/identity-access-manager/{{page.version}}/install-and-upgrade/install-the-spryker-core-back-office-feature.html) |
