...
| Quick Add to Cart | {{page.version}} | [Install the Quick Add to Cart feature](/docs/scos/dev/feature-integration-guides/{{page.version}}/quick-add-to-cart-feature-integration.html) |
