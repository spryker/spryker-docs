...
## Dynamic segments
Since segments are defined using a many-to-many table, projects can build so-called dynamic segments.
For instance, you may want to subscribe to events such as Product created and Product updated, and by handling these events you can maintain a special segment of product (e.g. red products).
