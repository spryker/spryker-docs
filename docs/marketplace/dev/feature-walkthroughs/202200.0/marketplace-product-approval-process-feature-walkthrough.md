...
an optional ``spy_merchant.default_product_abstract_approval_status`` DB column where default product approval statuses for merchants are stored and can be 
used as default product approval statuses for merchant products. Also the feature provides Data importer for merchant's default product approval statuses.
