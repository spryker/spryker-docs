...
You can import the product offer validity data from the[product_offer_validity.csv](/docs/marketplace/dev/data-import/file-details-product-offer-validity.csv.html) file by running
