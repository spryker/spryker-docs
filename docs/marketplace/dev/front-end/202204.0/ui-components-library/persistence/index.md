...
- [In-memory](/docs/marketplace/dev/front-end/{{page.version}}/ui-components-library/persistence/in-memory-persistence-strategy.html)—
 stores data in memory and will be lost when the browser page is reloaded.
- [Local-storage](/docs/marketplace/dev/front-end/{{page.version}}/ui-components-library/persistence/local-storage-persistence-strategy.html)—uses browser Local Storage to store the data.
- [Url](/docs/marketplace/dev/front-end/{{page.version}}/ui-components-library/persistence/url-persistence-strategy.html)—uses browser URL to store the data.
