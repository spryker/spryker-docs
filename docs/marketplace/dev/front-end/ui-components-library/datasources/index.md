...
- [inline](/docs/marketplace/dev/front-end/ui-components-library/datasource/datasource-inline.html) — Allows passing data along with the configuration of the Datasource.
