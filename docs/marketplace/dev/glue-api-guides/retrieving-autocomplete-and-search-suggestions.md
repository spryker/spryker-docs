...
related:
  - title: Searching the product catalog
    link: docs/marketplace/dev/glue-api-guides/searching-the-product-catalog.html
---

In addition to [catalog search](/docs/scos/dev/glue-api-guides/searching-the-product-catalog.html), Glue API lets you retrieve autocomplete suggestions for products, categories, and CMS pages. The feature lets developers predict search strings and provide customers with available options.
...
For detailed information about the modules that provide the API functionality and related installation instructions, see [Glue API: Catalog feature integration](/docs/scos/dev/feature-integration-guides/glue-api/glue-api-catalog-feature-integration.html).
