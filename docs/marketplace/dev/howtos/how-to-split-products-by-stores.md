...
You can do this through the Back Office. See [Managing groups](/docs/scos/user/back-office-user-guides/{{site.version}}/users/managing-groups/creating-user-groups.html) for details on how you can do that. Make sure to [assign corresponding `AclRule`](/docs/scos/dev/feature-walkthroughs/{{site.version}}/spryker-core-back-office-feature-walkthrough/user-and-rights-overview.html) to the roles as well.
