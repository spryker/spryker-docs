...
In our case, we use the [basic inheritance configuration](/docs/marketplace/dev/feature-walkthroughs/persistence-acl-feature-walkthrough/persistence-acl-feature-configuration.html) example and adopt it:
...
For more information about the data segmentation, see [Segment scope documentation](/docs/marketplace/dev/feature-walkthroughs/persistence-acl-feature-walkthrough/rules-and-scopes/segment-scope.html).
...
For more information about `AclEntityRule`, see [Rules and scopes](/docs/marketplace/dev/feature-walkthroughs/persistence-acl-feature-walkthrough/rules-and-scopes/rules-and-scopes.html).
...
You can do this through the Back Office. For details about how you can do that, see [Managing groups](/docs/scos/user/back-office-user-guides/users/managing-user-groups/creating-user-groups.html)  Make sure to [assign corresponding `AclRule`](/docs/scos/dev/feature-walkthroughs/spryker-core-back-office-feature-walkthrough/user-and-rights-overview.html) to the roles as well.
