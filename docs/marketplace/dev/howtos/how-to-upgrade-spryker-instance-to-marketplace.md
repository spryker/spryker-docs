...
Depending on the virtualization solution you use, use the recommendations in [Docker based instance build](/docs/scos/dev/set-up/install-spryker/installing-spryker-with-docker.html).
