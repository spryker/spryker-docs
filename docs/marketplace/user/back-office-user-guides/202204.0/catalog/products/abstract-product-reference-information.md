...
| Tax Set | Conditions under which a product is going to be taxed. For instruction on creating tax sets, see [Create tax sets]/docs/scos/user/back-office-user-guides/{{page.version}}/administration/tax-sets/create-tax-sets.html). Only one value can be selected. | Yes | Yes |
