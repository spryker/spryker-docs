...
There should be an existing tax set to apply it to the [product option group](/docs/marketplace/user/features/marketplace-product-options-feature-overview.html). For detailed instructions about creating tax sets, see [Create tax sets](/docs/scos/user/back-office-user-guides/administration/tax-sets/create-tax-sets.html).
...
| Tax Set | Conditions under which the product option group is to be taxed. To learn how to create tax sets, see [Create tax sets](/docs/scos/user/back-office-user-guides/administration/tax-sets/create-tax-sets.html). |
