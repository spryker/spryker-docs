...
Marketplace products are displayed on the Storefront when the following conditions are met:
...
Before new marketplace products become visible on the Storefront, they must be activated <!---LINK--> in the Back Office.
...
Merchants create and manage their products <!---LINK--> in the Merchant Portal. They can define prices, stock, attributes etc. for their products. See Managing marketplace products <!---LINK--> for details on how to do that.

## Related Business User articles

| MERCHANT PORTAL USER GUIDES  | BACK OFFICE USER GUIDES |
| -------------------- | ----------------------- |
| Managing marketplace products <!---LINK--> | [Editing abstract products](https://documentation.spryker.com/docs/editing-abstract-products) |
