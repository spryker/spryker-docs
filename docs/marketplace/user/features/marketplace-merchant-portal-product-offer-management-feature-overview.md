...
In a marketplace environment, merchants manage [product offers](/docs/marketplace/user/features/marketplace-product-offer-feature-overview.html) in the Merchant Portal.
...
|Prices | Product offers support all types of Spryker Commerce OS prices: [volume](/docs/scos/user/features/prices-feature-overview/volume-prices-overview.html), [default and original](/docs/scos/user/features/prices-feature-overview/prices-feature-overview.html). |
...
Are you a developer? See [Marketplace Merchant Portal Product Offer Management feature walkthrough](/docs/marketplace/dev/feature-walkthroughs/marketplace-merchant-portal-product-offer-management-feature-walkthrough.html) for developers.
