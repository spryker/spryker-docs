...
| **Product** is discontinued.                                 | The shopping list item is marked as *discontinued*, the *Sold by* hint is shown in the Storefront. If an alternative [marketplace product](/docs/marketplace/user/features/marketplace-product-feature-overview.html) exists, it is displayed with the  *Sold by* hint. Product offers are not supported, so if the alternative product has an offer, it is displayed as a marketplace product or a merchant product. |
...
Are you a developer? See [Marketplace Shopping Lists feature walkthrough](/docs/marketplace/dev/feature-walkthroughs/marketplace-shopping-lists-feature-walkthrough.html) for developers.
