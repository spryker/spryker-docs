...
- [Orders](/docs/pbc/all/return-management/{{site.version}}/marketplace/manage-merchant-orders.html)
...
You can encounter tables in the [Offers](/docs/marketplace/user/merchant-portal-user-guides/{{site.version}}/offers/managing-product-offers.html), [Products](/docs/marketplace/user/merchant-portal-user-guides/{{site.version}}/products/abstract-products/creating-marketplace-abstract-product.html), and [Orders](/docs/pbc/all/return-management/{{site.version}}/marketplace/manage-merchant-orders.html) sections of the Merchant Portal.
