...
This section allows [merchant users](/docs/marketplace/user/features/{{ page.version }}/merchant/merchant-feature-overview/merchant-users.html) to check and update the merchant profile information.
...
This section describes attributes you see when editing he merchant's online profile in the *Online Profile* tab. This  tab contains the information that will further be displayed on the [Merchant Profile page on the Storefront](/docs/marketplace/user/features/{{ page.version }}/merchant/merchant-feature-overview/merchant-feature-overview.html#merchant-profile).
