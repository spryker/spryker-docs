...
4. Optional: To set a price for a specific customer, from the **Customer** drop-down menu, select the appropriate customer's [business unit](/docs/scos/user/features/company-account-feature-overview/business-units-overview.html) to apply the price to.
  ...
  You can set customer-specific prices for the [marketplace products](/docs/marketplace/user/features/marketplace-product-offer-feature-overview.html), not [product offers](/docs/marketplace/user/features/marketplace-product-offer-feature-overview.html).
