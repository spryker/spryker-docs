...
| [Content Assistant](/docs/pbc/all/ai-commerce/latest/content-assistant.html) | An AI-powered panel in the Back Office CMS Page and CMS Block glossary editors. Back Office users can generate and refine placeholder content per locale through a conversational AI interface. |
