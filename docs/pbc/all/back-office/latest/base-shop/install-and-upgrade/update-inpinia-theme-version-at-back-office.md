...
The Spryker Back Office uses the INSPINIA admin theme for styling. If your project uses an older INSPINIA version, upgrade to the latest version to modernize the UI foundation and reduce front-end maintenance overhead.

To update the INSPINIA theme version in the Back Office, complete the following steps:
...
Then update major versions. Remove unused features from the list if applicable:
...
## 4. Build JavaScript and CSS assets to apply Bootstrap 5 updates
