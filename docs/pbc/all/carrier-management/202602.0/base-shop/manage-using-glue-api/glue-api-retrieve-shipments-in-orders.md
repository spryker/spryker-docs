...
redirect_from:
  - /docs/pbc/all/carrier-management/202507.0/base-shop/manage-using-glue-api/glue-api-retrieve-shipments-in-orders.html 
...
This document describes how to retrieve shipments in orders. For full information about the endpoint, see [Retrieve orders](/docs/pbc/all/order-management-system/{{page.version}}/base-shop/glue-api-retrieve-orders.html)
...
| ------------------ | -------------------- |
| ***{% raw %}{{{% endraw %}order_id{% raw %}}}{% endraw %}*** | The unique identifier of an order. [Retrieve all orders](/docs/pbc/all/order-management-system/{{page.version}}/base-shop/glue-api-retrieve-orders.html#retrieve-all-orders) to get it. |
