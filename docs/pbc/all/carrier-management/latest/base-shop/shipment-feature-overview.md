...
To add service types using Glue API, see [Backend API Marketplace B2B Demo Shop reference](/docs/integrations/spryker-api/backend-api/api-references/backend-api-marketplace-b2b-demo-shop-reference.html).
