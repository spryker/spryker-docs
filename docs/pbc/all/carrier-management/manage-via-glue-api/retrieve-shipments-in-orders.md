...
This document describes how to retrieve shipments in orders. For full information about retrieving orders, see [Retrieve orders](/docs/scos/dev/glue-api-guides/{{site.version}}/retrieving-orders.html)
