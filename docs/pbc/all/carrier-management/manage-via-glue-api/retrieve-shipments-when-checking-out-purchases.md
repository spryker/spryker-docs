...
This document describes how to retrieve order shipments when checking out. For full information on checking out, see [Checking out purchases](/docs/scos/dev/glue-api-guides/{{page.version}}/checking-out/checking-out-purchases.html)
