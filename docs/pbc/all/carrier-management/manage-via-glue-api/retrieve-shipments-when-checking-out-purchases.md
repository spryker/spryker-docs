...
This document describes how to retrieve order shipments when checking out via the Glue API. For full information on the endpoint, see [Check out purchases](/docs/pbc/all/cart-and-checkout/manage-using-glue-api/check-out/check-out-purchases.html)
