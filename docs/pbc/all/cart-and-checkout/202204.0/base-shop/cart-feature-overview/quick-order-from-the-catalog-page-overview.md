...
* The product does not have [measurement](/docs/pbc/all/product-information-management/{{site.version}}/feature-overviews/measurement-units-feature-overview.html) or [packaging units](/docs/pbc/all/product-information-management/{{site.version}}/feature-overviews/packaging-units-feature-overview.html).
...
If a product has [options](/docs/pbc/all/product-information-management/{{site.version}}/feature-overviews/product-options-feature-overview.html), it can be added to the cart from the Category page, but it is added without any options.
