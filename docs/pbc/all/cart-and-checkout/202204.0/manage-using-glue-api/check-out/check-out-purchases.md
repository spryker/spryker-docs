...
After sending a request, the cart is deleted, and you cannot make any further changes in the checkout data. This means the endpoint is best used for checkouts that can be performed in one pass or for finalizing a checkout after [submitting checkout data](/docs/pbc/all/cart-and-checkout/{{site.version}}/manage-using-glue-api/check-out/submit-checkout-data.html).  
...
* [Update payment data](/docs/pbc/all/cart-and-checkout/{{site.version}}/manage-using-glue-api/check-out/update-payment-data.html)
