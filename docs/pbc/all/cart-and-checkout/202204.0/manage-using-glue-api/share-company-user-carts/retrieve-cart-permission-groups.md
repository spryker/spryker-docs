...
related:
  ...
  - title: Managing shared company user carts
    link: docs/pbc/all/cart-and-checkout/page.version/manage-using-glue-api/share-company-user-carts/manage-shared-company-user-carts.html
---
...
For detailed information on the modules that provide the API functionality and related installation instructions, see [Install the Shared Carts feature](/docs/pbc/all/cart-and-checkout/{{site.version}}/install-and-upgrade/install-features/install-the-shared-carts-feature.html).
...
[Share company user carts](/docs/pbc/all/cart-and-checkout/{{site.version}}/manage-using-glue-api/share-company-user-carts/share-company-user-carts.html)
