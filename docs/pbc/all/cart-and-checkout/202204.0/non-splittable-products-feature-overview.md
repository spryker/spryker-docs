...
redirect_from:
  ...
  - /docs/scos/dev/feature-walkthroughs/202204.0/non-splittable-products-feature-walkthrough.html   
...
Product quantity restriction values define the number of items that customers can put into the cart. You can specify the product quantity restrictions by importing them for your project with the `data:import:product-quantity` command. For details about the import file, see [File details: product_quantity.csv](/docs/pbc/all/cart-and-checkout/{{site.version}}/import-and-export-data/file-details-product-quantity.csv.html).
...
| DATA IMPORT |
|---------|
|[File details: product_quantity.csv](/docs/pbc/all/cart-and-checkout/{{site.version}}/import-and-export-data/file-details-product-quantity.csv.html) |
