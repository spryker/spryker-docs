...
For the attributes of other included resources, see [Retrieve customer's order](/docs/pbc/all/customer-relationship-management/{{site.version}}/manage-using-glue-api/customers/retrieving-customer-orders.html)
