...
redirect_from:
  - /docs/scos/user/features/202307.0/cart-feature-overview/cart-widget-overview.html
  - /docs/pbc/all/cart-and-checkout/202307.0/cart-feature-overview/cart-widget-overview.html  
---
...
* Access level to a shopping cart (for more details, see [Shared Cart Feature Overview](/docs/pbc/all/cart-and-checkout/{{site.version}}/base-shop/shared-carts-feature-overview.html))
* Price mode
* Cart total
