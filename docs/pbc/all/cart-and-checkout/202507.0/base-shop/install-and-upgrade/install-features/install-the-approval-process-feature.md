...
{% include pbc/all/install-features/{{page.version}}/install-the-approval-process-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-approval-process-feature.md -->
