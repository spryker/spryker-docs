...
related:
  - title: Install the Cart Glue API
    link: docs/pbc/all/cart-and-checkout/202507.0/base-shop/install-and-upgrade/install-glue-api/install-the-cart-glue-api.html
---

{% include pbc/all/install-features/{{page.version}}/install-the-cart-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/202410.0/install-the-cart-feature.md -->
