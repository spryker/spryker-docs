...
related:
  - title: Share company user carts
    link: docs/pbc/all/cart-and-checkout/202507.0/base-shop/manage-using-glue-api/share-company-user-carts/glue-api-share-company-user-carts.html
  - title: Retrieving cart permission groups
    link: docs/pbc/all/cart-and-checkout/202507.0/base-shop/manage-using-glue-api/share-company-user-carts/glue-api-retrieve-cart-permission-groups.html
  ...
  - title: Shared Cart feature overview
    link: docs/pbc/all/cart-and-checkout/202507.0/base-shop/feature-overviews/shared-carts-feature-overview.html
  - title: Install the Shared Carts feature
    link: docs/pbc/all/cart-and-checkout/202507.0/base-shop/install-and-upgrade/install-features/install-the-shared-carts-feature.html
...
| --- | --- | --- | --- |
| Authorization | string | ✓ | A string containing digits, letters, and symbols that authorize the company user. [Authenticate as a company user](/docs/pbc/all/identity-access-management/{{page.version}}/manage-using-glue-api/glue-api-authenticate-as-a-company-user.html#authenticate-as-a-company-user) to get the value.  |
