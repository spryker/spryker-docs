...
redirect_from:
  - /docs/pbc/all/cart-and-checkout/202507.0/base-shop/manage-using-glue-api/check-out/glue-api-check-out-purchases.html 
...
- [Install the Shipment Glue API](/docs/pbc/all/carrier-management/{{page.version}}/base-shop/install-and-upgrade/install-features/install-the-shipment-feature.html)
...
{% include pbc/all/glue-api-guides/{{page.version}}/checkout-request-attributes.md %} <!-- To edit, see /_includes/pbc/all/glue-api-guides/{{page.version}}/checkout-request-attributes.md -->
