...
This document describes the `content_banner.csv` file to configure [Content Banner](/docs/pbc/all/content-management-system/{{page.version}}/navigation-feature-overview.html#content-item) information in your Spryker Demo Shop.
