...
redirect_from:
  ...
  - /docs/pbc/all/content-management-system/202212.0/import-and-export-data/file-details-cms-block-category.csv.html
related:
...
This file has the following dependency: [cms_block_category_position.csv](/docs/pbc/all/content-management-system/{{page.version}}/base-shop/import-and-export-data/file-details-cms-block-category-postion.csv.html).
