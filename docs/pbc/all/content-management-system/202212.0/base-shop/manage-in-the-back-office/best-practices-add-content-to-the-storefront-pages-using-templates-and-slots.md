...
redirect_from:
  ...
  - /docs/pbc/all/content-management-system/202212.0/manage-in-the-back-office/best-practices-add-content-to-the-storefront-pages-using-templates-and-slots.html
related:
...
If the content item types shipped by default are not sufficient for your project needs, new ones can be created by a developer. See [HowTo - Create a Content Item](/docs/dg/dev/miscellaneous-guides/howtos/feature-howtos/cms/howto-create-a-custom-content-item.html) for more details.
