...
To create a [navigation element](/docs/pbc/all/content-management-system/{{page.version}}/navigation-feature-overview.html#navigation-element) in the Back Office, follow the steps:
