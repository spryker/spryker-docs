...
There is a number of email templates with the respective Email CMS Blocks available in the [Spryker Demo Shops](/docs/about/all/intro-to-spryker.html#spryker-b2bb2c-demo-shops).
