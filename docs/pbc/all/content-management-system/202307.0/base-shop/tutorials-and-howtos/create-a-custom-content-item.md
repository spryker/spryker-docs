...
redirect_from:
  ...
  - /docs/pbc/all/content-management-system/202307.0/tutorials-and-howtos/howto-create-a-custom-content-item.html
  - /docs/pbc/all/content-management-system/202307.0/base-shop/tutorials-and-howtos/howto-create-a-custom-content-item.html
---
...
```
  1. Create `ContentFooTermForm`. The main part of the plugin is the `Form` class that implements `\Symfony\Component\Form\FormBuilderInterface`.
     ...
     * To learn about form creation procedure in Spryker, see [Creating forms](/docs/dg/dev/backend-development/forms/creating-forms.html)
