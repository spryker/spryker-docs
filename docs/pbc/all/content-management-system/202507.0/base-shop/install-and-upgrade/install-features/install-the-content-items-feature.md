...
related:
  - title: Install the Content Items Glue API
    link: docs/pbc/all/content-management-system/202507.0/base-shop/install-and-upgrade/install-glue-api/install-the-content-items-glue-api.html
---

{% include pbc/all/install-features/{{page.version}}/install-the-content-items-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-content-items-feature.md -->
