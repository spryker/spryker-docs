...
- title: Install the CMS feature
    link: docs/scos/dev/feature-integration-guides/202507.0/cms-feature-integration.html
- title: "Glue API: Retrieve CMS pages"
    link: docs/pbc/all/content-management-system/202507.0/base-shop/manage-using-glue-api/glue-api-retrieve-cms-pages.html
---

{% include pbc/all/install-features/{{page.version}}/install-glue-api/install-the-cms-glue-api.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-glue-api/install-the-cms-glue-api.md -->
