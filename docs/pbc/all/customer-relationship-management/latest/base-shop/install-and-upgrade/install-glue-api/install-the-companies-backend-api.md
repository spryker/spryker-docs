...
Projects still running the legacy Glue infrastructure additionally need [Integrate API Platform](/docs/integrations/spryker-api/migrate-from-glue-to-api-platform/integrate-api-platform.html), which covers migrating an existing Glue application rather than enabling a new one.
