---
title: How to incrementally import recently updated products with Spryker Middleware Powered by Alumio
...
11. Apply *Then apply transformer*. Populate the fields as follows:
    ...
    5. In *Mappers* -> *Output format*, enter `Y-m-d H:i:s`.
