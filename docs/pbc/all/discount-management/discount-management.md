...
|  |  | [Managing discount vouchers in guest carts](/docs/pbc/all/discount-management/manage-via-glue-api/manage-discount-vouchers-in-guest-carts.html) | [File details: discount_store.csv](/docs/pbc/all/discount-management/import-and-export-data/file-details-discount-store.csv.html) |  |
