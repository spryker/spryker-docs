...
redirect_from:
  - /docs/pbc/all/emails/202602.0/howto-create-and-register-a-mail-type-builder-plugin.html
  - /docs/pbc/all/emails/202507.0/howto-create-and-register-a-mail-type-builder-plugin.html
...
Follow [Tutorial sending an email](/docs/pbc/all/emails/{{page.version}}/tutorial-sending-an-email.html) to get more information.
