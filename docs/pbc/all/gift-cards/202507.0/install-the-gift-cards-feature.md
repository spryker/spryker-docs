...
{% include pbc/all/install-features/{{page.version}}/install-the-gift-cards-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-gift-cards-feature.md -->
