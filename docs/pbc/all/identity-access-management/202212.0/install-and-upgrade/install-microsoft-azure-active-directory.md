...
{% include pbc/all/install-features/{{page.version}}/install-microsoft-azure-active-directory.md %} <!-- To edit, see /_includes/pbc/all/install-features/202212.0/install-microsoft-azure-active-directory.md -->
