...
This endpoint allows authenticating as a customer. As an authenticated customer, you can send requests to [protected resources](/docs/dg/dev/glue-api/{{page.version}}/authentication-and-authorization.html#protected-resources).
