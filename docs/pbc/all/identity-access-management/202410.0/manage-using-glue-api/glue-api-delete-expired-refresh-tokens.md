...
After an authentication refresh token is [revoked](/docs/dg/dev/glue-api/latest/authentication-and-authorization.html) or expires, it remains in the database.
