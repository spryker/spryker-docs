...
redirect_from:
  - /docs/pbc/all/identity-access-management/latest/manage-using-glue-api/glue-api-authenticate-as-a-back-office-user.html
---
...
For detailed information on the modules that provide the API functionality and related installation instructions, see [Install the Customer Account Management Glue API](/docs/pbc/all/identity-access-management/202410.0/install-and-upgrade/install-the-customer-account-management-glue-api.html).
...
| username | String | &check; | Back Office user's username. You define it when [creating](/docs/pbc/all/user-management/202410.0/base-shop/manage-in-the-back-office/manage-users/create-users.html) or [editing users](/docs/pbc/all/user-management/202410.0/base-shop/manage-in-the-back-office/manage-users/edit-users.html). |
