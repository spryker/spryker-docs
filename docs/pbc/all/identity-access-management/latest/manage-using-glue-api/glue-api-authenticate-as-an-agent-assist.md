...
- /docs/pbc/all/identity-access-management/latest/manage-using-glue-api/glue-api-authenticate-as-an-agent-assist.html
related:
...
Log into the Storefront as an [agent assist](/docs/pbc/all/user-management/202410.0/base-shop/agent-assist-feature-overview.html) to help customers by performing actions on their behalf. After you've logged in, you can search by customers and impersonate them to perform any action available to them.

## Installation

For detailed information on the modules that provide the API functionality and related installation instructions, see:

- [Install the Agent Assist Glue API](/docs/pbc/all/user-management/202410.0/base-shop/install-and-upgrade/install-the-agent-assist-glue-api.html)

- [Install the Customer Account Management + Agent Assist feature](/docs/pbc/all/customer-relationship-management/202410.0/base-shop/install-and-upgrade/install-features/install-the-customer-account-management-agent-assist-feature.html)
...
- [Search by customers](/docs/pbc/all/user-management/202410.0/base-shop/manage-using-glue-api/glue-api-search-by-customers-as-an-agent-assist.html#search-by-customers)
- [Impersonate a customer](/docs/pbc/all/user-management/202410.0/base-shop/manage-using-glue-api/glue-api-impersonate-customers-as-an-agent-assist.html#impersonate-a-customer)
