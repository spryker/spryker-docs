...
See the [Table Filter extension](/docs/marketplace/dev/front-end/{{site.version}}/table-design/table-filters.html) to learn more about the Table Filters feature.
