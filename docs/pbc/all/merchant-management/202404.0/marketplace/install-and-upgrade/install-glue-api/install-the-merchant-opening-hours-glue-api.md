...
{% include pbc/all/install-glue-api/{{page.version}}/marketplace/install-the-merchant-opening-hours-glue-api.md %} <!-- To edit, see /_includes/pbc/all/install-glue-api/{{page.version}}/marketplace/install-the-merchant-opening-hours-glue-api.md -->
