...
{% include pbc/all/install-features/{{page.version}}/install-the-merchant-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-merchant-feature.md -->
