...
<table cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            <p>During the <a href="/docs/pbc/all/customer-relationship-management/202507.0/base-shop/reorder-feature-overview.html">reorder</a> process, products that are restricted but exist in a previous order are automatically removed from the cart.</p>
         </td>
         <td>
