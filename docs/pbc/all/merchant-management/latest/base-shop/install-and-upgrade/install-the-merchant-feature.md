...
{% include pbc/all/install-features/latest/install-the-merchant-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/latest/install-the-merchant-feature.md -->
