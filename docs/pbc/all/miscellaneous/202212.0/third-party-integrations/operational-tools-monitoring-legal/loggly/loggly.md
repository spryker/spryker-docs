...
To integrate this plugin you need to have the `QueueHandler` enabled in your Logger configuration. <!-- as described [here](/docs/dg/dev/backend-development/data-manipulation/data-ingestion/spryker-middleware.html).-->
