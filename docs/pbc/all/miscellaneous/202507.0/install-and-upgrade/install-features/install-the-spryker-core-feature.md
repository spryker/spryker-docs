...
{% include pbc/all/install-features/202507.0/install-the-spryker-core-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-spryker-core-feature.md -->
