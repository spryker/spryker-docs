...
redirect_from:
  - /docs/pbc/all/offer-management/202602.0/marketplace/marketplace-product-offer-feature-domain-model-and-relationships/product-offer-storage.html
...
For details about how to use and configure key-value store (Redis or Valkey), see [Using and configuring Redis as a key-value storage](/docs/dg/dev/backend-development/client/use-and-configure-redis-as-a-key-value-storage.html).
