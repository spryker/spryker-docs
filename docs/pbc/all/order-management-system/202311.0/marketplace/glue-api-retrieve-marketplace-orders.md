...
| items.unitPrice      | Integer | Single item price without assuming if it's new or gross. {% info_block warningBox "Note" %}This price should be displayed everywhere when a product price is displayed. It allows switching tax mode without side effects.{% endinfo_block %} |
