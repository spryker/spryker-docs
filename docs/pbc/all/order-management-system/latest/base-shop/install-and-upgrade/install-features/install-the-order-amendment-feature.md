...
| Reorder          | {{page.release_tag}} | [Install the Reorder feature](/docs/pbc/all/order-management-system/latest/base-shop/install-and-upgrade/install-features/install-the-reorder-feature.html)                          |
...
```bash
composer require spryker-feature/order-amendment: "{{page.release_tag}}" --update-with-dependencies
```
...
| ShipmentTypeCheckoutDoSaveOrderPlugin                                  | Creates or updates a sales shipment type entity.                                                                                                                                                           | Must be executed after `ReplaceSalesOrderShipmentCheckoutDoSaveOrderPlugin`.                                                                | Spryker\Zed\SalesShipmentType\Communication\Plugin\Checkout                          |
