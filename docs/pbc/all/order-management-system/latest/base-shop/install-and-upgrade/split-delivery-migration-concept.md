...
| `spryker/orders-rest-api` | 4.0.0 | [Upgrade the OrdersRestApi module](/docs/pbc/all/order-management-system/latest/base-shop/install-and-upgrade/upgrade-modules/upgrade-the-ordersrestapi-module.html#upgrading-from-version-30-to-version-400) |
