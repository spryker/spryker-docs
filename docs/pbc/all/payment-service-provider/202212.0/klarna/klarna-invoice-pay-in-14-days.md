...
redirect_from:
  ...
  - /docs/pbc/all/payment-service-provider/202212.0/third-party-integrations/klarna/klarna-invoice-pay-in-14-days.html
related:
  - title: Klarna
...
In order to perform the needed requests, you can easily use the implemented [Klarna State Machine Commands and Conditions](/docs/pbc/all/payment-service-provider/{{page.version}}/klarna/klarna-state-machine-commands-and-conditions.html). The next section gives a summary of them.
