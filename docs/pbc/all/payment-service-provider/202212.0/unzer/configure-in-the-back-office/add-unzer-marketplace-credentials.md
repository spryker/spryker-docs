...
| STORE RELATION | Defines [stores](/docs/pbc/all/dynamic-multistore/{{site.version}}/base-shop/tutorials-and-howtos/set-up-multiple-stores.html) the Unzer payment method will be available in. |
