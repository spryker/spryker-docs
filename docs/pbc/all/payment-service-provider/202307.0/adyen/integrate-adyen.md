...
redirect_from:
  - /docs/scos/dev/technology-partner-guides/202307.0/payment-partners/adyen/integrating-adyen.html
  - /docs/pbc/all/payment-service-provider/202307.0/third-party-integrations/adyen/integrate-adyen.html
related:
...
Prior to integrating Adyen into your project, make sure you [installed and configured the Adyen module](/docs/pbc/all/payment-service-provider/{{page.version}}/adyen/install-and-configure-adyen.html).
