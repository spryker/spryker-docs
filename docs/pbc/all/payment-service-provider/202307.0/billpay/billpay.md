...
redirect_from:
  - /docs/scos/user/technology-partners/202307.0/payment-partners/billpay.html
  - /docs/pbc/all/payment-service-provider/202307.0/third-party-integrations/billpay/billpay.html
---
...
* [Billpay - Switching invoice payments to a preauthorize mode](/docs/pbc/all/payment-service-provider/{{page.version}}/billpay/billpay-switch-invoice-payments-to-a-preauthorize-mode.html)
* [Integrating Billpay](/docs/pbc/all/payment-service-provider/{{page.version}}/billpay/integrate-billpay.html)
