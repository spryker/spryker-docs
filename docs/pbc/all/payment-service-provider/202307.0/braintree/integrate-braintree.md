...
redirect_from:
  ...
  - /docs/pbc/all/payment-service-provider/202307.0/third-party-integrations/braintree/integrate-braintree.html
related:
...
Before proceeding with the integration, make sure you have [installed and configured](/docs/pbc/all/payment-service-provider/{{page.version}}/braintree/install-and-configure-braintree.html) the Braintree module.
