...
redirect_from:
  ...
  - /docs/scos/dev/technology-partner-guides/202307.0/payment-partners/crefopay/integrating-crefopay.html
  - /docs/pbc/all/payment-service-provider/202307.0/third-party-integrations/crefopay/integrate-crefopay.html
related:
  - title: CrefoPay
...
Before integrating CrefoPay into your project, make sure you [installed and configured the CrefoPay module](/docs/pbc/all/payment-service-provider/{{page.version}}/crefopay/install-and-configure-crefopay.html).
