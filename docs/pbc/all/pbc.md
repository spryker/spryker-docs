...
| [User Management](/docs/pbc/all/user-management/{{site.version}}/base-shop/user-management.html) | Lets the Back Office users manage user access, set rights, and onboard customers. | Ensures high security and compliance through managed user flows. |
