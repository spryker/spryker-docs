...
redirect_from:
  - /docs/pbc/all/price-management/202512.0/base-shop/import-and-export-data/import-file-details-currency.csv.html
...
This document describes the `currency.csv` file to configure [Currency](/docs/pbc/all/price-management/{{page.version}}/base-shop/extend-and-customize/multiple-currencies-per-store-configuration.html) information in your Spryker Demo Shop.
...
Default currency might be set up when setting up the store. Check [this configuration](https://github.com/spryker-shop/b2c-demo-shop/blob/master/config/Shared/stores.php#L38).
