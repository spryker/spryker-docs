...
related:
  - title: Upgrade the Currency
    link: docs/pbc/all/price-management/install-and-upgrade/upgrade-the-currency-module.html
...
1. Infrastructure for multi-currency:
   ...
   * **Currency >= 3.2.** — see [Migration Guide - Currency](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-currency-module.html) for more details.
