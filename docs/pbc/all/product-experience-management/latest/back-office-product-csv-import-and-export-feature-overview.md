---
title: Back Office product CSV import and export feature overview
description: Import and export product data in bulk through the Back Office using CSV files with schema-driven column mapping.
last_updated: Sep 7, 2026
template: concept-topic-template
---

The *Back Office Product CSV Import and Export* feature lets Back Office users import and export product data in bulk through a guided CSV-based workflow. It provides a schema-driven approach to column mapping, batch processing, and per-row error reporting.

To manage products programmatically instead of through files, see [Products Backend API](/docs/pbc/all/product-experience-management/latest/products-backend-api.html).

## Terminology

The following terms are used throughout this feature:
...
| INSTALLATION GUIDES |
| --- |
| [Install the Back Office Product CSV Import and Export feature](/docs/pbc/all/product-experience-management/latest/install/install-the-back-office-product-csv-import-and-export-feature.html) |
