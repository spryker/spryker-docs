...
1. Create the *Installation Service* product as a usual abstract product, like you did in the [Prerequisites](#prerequisites) section. Make sure you set the **Availability** as *Never out of stock*. See [Check availability of products](/docs/pbc/all/warehouse-management-system/{{page.version}}/base-shop/manage-in-the-back-office/check-availability-of-products.html) for details on how to do that.
