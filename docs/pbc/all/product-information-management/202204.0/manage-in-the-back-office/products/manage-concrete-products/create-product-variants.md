...
4. In the *Price & Tax* tab, set prices and taxes for products:
    ...
    3. **B2B only:** In **Merchant Price Dimension**, select the merchant relationship to define a special price per merchant relation. See [Merchants](/docs/pbc/all/price-management/merchant-custom-prices-feature-overview.html) for more information.
