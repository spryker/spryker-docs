...
{% include pbc/all/install-features/{{page.version}}/install-the-discontinued-products-product-labels-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/202212.0/install-the-discontinued-products-product-labels-feature.md -->
