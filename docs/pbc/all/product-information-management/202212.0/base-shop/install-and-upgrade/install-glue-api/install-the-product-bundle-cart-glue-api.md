...
redirect_from:
  ...
  - /docs/scos/dev/feature-integration-guides/202212.0/glue-api/glue-api-product-bundle-cart-feature-integration.html
related:
...
{% include pbc/all/install-features/{{page.version}}/install-glue-api/install-the-product-bundle-cart-glue-api.md %} <!-- To edit, see /_includes/pbc/all/install-features/202212.0/install-glue-api/install-the-product-bundle-cart-glue-api.md -->
