...
redirect_from:
  - /docs/marketplace/user/back-office-user-guides/202212.0/catalog/products/abstract-products/creating-abstract-products.html
---
...
| --- | --- |
| Store relation  | Defines the [stores](/docs/dg/dev/miscellaneous-guides/howtos/howto-set-up-multiple-stores.html) the product will be available in.<br>You can select multiple values. |
