...
redirect_from:
  - /docs/marketplace/user/merchant-portal-user-guides/202212.0/products/abstract-products/managing-marketplace-abstract-products.html
related:
...
| Stores      | Defines the [stores](/docs/dg/dev/miscellaneous-guides/howtos/howto-set-up-multiple-stores.html) the product is available in.<br/>You can select multiple values. |           |
