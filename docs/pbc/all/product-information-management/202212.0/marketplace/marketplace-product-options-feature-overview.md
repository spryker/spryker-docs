...
* [Glue API](/docs/scos/dev/glue-api-guides/{{page.version}}/old-glue-infrastucture/glue-rest-api.html) does not support merchant product option groups and values.
