...
| --- | --- |
| STORE RELATION  | [Stores](/docs/dg/dev/miscellaneous-guides/howtos/howto-set-up-multiple-stores.html) the product is available in. |
...
| STORE | [Store](/docs/dg/dev/miscellaneous-guides/howtos/howto-set-up-multiple-stores.html) in which the scheduled price is displayed. |
