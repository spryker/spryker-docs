...
{% include pbc/all/glue-api-guides/{{page.version}}/concrete-product-prices-response-atributes.md %} <!-- To edit, see /_includes/pbc/all/glue-api-guides/{{page.version}}/concrete-product-prices-response-atributes.md -->
