...
* Product has a URL in at least one locale of the current store, see [General section of the product abstract](https://docs.spryker.com/docs/pbc/all/product-information-management/202404.0/marketplace/manage-in-the-back-office/products/abstract-products/edit-abstract-products.html#editing-general-settings-of-an-abstract-product). 
