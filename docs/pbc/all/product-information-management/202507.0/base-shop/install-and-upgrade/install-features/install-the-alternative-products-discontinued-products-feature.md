...
{% include pbc/all/install-features/{{page.version}}/install-the-alternative-products-discontinued-products-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-alternative-products-discontinued-products-feature.md -->
