...
{% include pbc/all/install-features/{{page.version}}/install-the-product-images-configurable-bundle-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-product-images-configurable-bundle-feature.md -->
