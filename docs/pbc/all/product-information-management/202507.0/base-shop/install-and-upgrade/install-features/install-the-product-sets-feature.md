...
{% include pbc/all/install-features/{{page.version}}/install-the-product-sets-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-product-sets-feature.md -->
