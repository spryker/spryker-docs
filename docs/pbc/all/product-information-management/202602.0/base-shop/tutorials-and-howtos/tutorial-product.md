...
2. Add `product_country` to the data set that goes to the key-value store, such as Redis or Valkey.
3. Run the collectors to bring data to the key-value store.
