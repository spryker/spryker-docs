...
related:
  ...
  - title: Retrieve measurement units
    link: docs/pbc/all/product-information-management/latest/base-shop/manage-using-glue-api/glue-api-retrieve-measurement-units.html
...
| Product Measurement Units | {{page.release_tag}} | [Install the Product Measurement Units feature](/docs/pbc/all/product-information-management/latest/base-shop/install-and-upgrade/install-features/install-the-measurement-units-feature.html) |
