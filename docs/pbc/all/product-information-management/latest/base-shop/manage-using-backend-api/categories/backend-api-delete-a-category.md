...
| --- | --- |
| {% raw %}***{{category_key}}***{% endraw %} | Key of the category to delete. The key is matched case-insensitively. To get it, [retrieve categories](/docs/pbc/all/product-information-management/latest/base-shop/manage-using-backend-api/categories/backend-api-retrieve-categories.html#retrieve-categories). |
