...
- [Storefront API](/docs/integrations/spryker-glue-api/getting-started-with-apis/storefront-api.html) does not support merchant product option groups and values.
