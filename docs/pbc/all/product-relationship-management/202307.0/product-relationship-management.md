...
A product catalog manager can define the [stores](/docs/dg/dev/miscellaneous-guides/howtos/howto-set-up-multiple-stores.html) each product relation is displayed in.
