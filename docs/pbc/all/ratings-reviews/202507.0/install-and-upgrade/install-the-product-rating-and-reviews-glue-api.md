...
related:
  - title: Product Rating and Reviews feature integration
    link: docs/pbc/all/ratings-reviews/202507.0/install-and-upgrade/install-the-product-rating-and-reviews-feature.html
...
{% include pbc/all/install-features/{{page.version}}/install-glue-api/install-the-product-rating-and-reviews-glue-api.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-glue-api/install-the-product-rating-and-reviews-glue-api.md -->
