...
## Next steps
[Configure the Bazzarevoice app](/docs/pbc/all/ratings-reviews/third-party-integrations/manage-in-the-back-office/configure-bazaarvoice.html) for your store.