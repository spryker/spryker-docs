...
Next to the return you want to generate a [return slip](/docs/marketplace/user/features/{{page.version}}/marketplace-return-management-feature-overview.html#return-slip) for, click **Print Slip**.
