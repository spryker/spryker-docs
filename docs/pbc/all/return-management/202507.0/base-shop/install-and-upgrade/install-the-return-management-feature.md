...
related:
    - title: Install the Return Management Glue API
      link: docs/pbc/all/return-management/202507.0/base-shop/install-and-upgrade/install-the-return-management-glue-api.html
---

{% include pbc/all/install-features/{{page.version}}/install-the-return-management-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-return-management-feature.md -->
