...
related:
  - title: Install the Return Management feature
    link: docs/pbc/all/return-management/202507.0/base-shop/install-and-upgrade/install-the-return-management-feature.html
  - title: Managing the returns
    link: docs/pbc/all/return-management/202507.0/base-shop/manage-using-glue-api/glue-api-manage-returns.html
  - title: Retrieving return reasons
    link: docs/pbc/all/return-management/202507.0/base-shop/manage-using-glue-api/glue-api-retrieve-return-reasons.html
---

{% include pbc/all/install-features/{{page.version}}/install-glue-api/install-the-return-management-glue-api.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-glue-api/install-the-return-management-glue-api.md -->
