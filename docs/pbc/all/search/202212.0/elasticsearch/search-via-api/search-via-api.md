...
| `GET https://glue.mysprykershop.com/catalog-search-suggestions?q=c` | Retrieve suggestions for one letter `c`. |
| `GET https://glue.mysprykershop.com/catalog-search-suggestions?q=co` | Retrieve suggestions for two letters `co`. |
| `GET https://glue.mysprykershop.com/catalog-search-suggestions?q=com` | Retrieve suggestions for three letters `com`. |
