...
**Did-you-mean**
Offers typo corrections for the search string.
**Mimic a Dynamic Category**
Leverages the search URL and uses it as a link within your navigation. It looks like a category to a user but enables you to create more sophisticated categories.
