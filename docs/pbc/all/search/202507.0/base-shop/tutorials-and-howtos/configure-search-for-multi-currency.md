...
related:
  - title: Upgrade the Multi-Currency module
    link: docs/pbc/all/price-management/202507.0/base-shop/install-and-upgrade/upgrade-modules/upgrade-to-multi-currency.html
  ...
  - title: Configure Elasticsearch
    link: docs/pbc/all/search/202507.0/base-shop/tutorials-and-howtos/configure-elasticsearch.html
  - title: Configure search features
    link: docs/pbc/all/search/202507.0/base-shop/tutorials-and-howtos/configure-search-features.html
  - title: Configure a search query
    link: docs/pbc/all/search/202507.0/base-shop/tutorials-and-howtos/configure-a-search-query.html
  - title: Expand search data
    link: docs/pbc/all/search/202507.0/base-shop/tutorials-and-howtos/expand-search-data.html
  - title: Facet filter overview and configuration
    link: docs/pbc/all/search/202507.0/base-shop/tutorials-and-howtos/facet-filter-overview-and-configuration.html
---
