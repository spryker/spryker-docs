...
related:
  - title: Search feature overview
    link: docs/pbc/all/search/202507.0/base-shop/search-feature-overview/search-feature-overview.html
---
...
The second idea leverages the fact that Spryker's implementation of [search](/docs/pbc/all/search/{{page.version}}/base-shop/search-feature-overview/search-feature-overview.html) is very flexible and allows configuring additional plugins that are used to build search queries.
...
class CartBoostQueryExpanderPlugin extends AbstractPlugin implements QueryExpanderPluginInterface
{
    ...
    {
        // We get the concrete product from the key-value store (Redis or Valkey).
