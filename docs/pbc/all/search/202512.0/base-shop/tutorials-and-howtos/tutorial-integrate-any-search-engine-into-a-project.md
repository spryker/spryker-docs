...
redirect_from:
  - /docs/pbc/all/search/202602.0/base-shop/tutorials-and-howtos/tutorial-integrate-any-search-engine-into-a-project.html
...
The integration is following the concept described in [Search Migration Concept](/docs/pbc/all/search/{{page.version}}/base-shop/install-and-upgrade/search-migration-concept.html).
