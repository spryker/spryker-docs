...
Spryker PaaS uses OpenSearch, an AWS-maintained fork of Elasticsearch. The configuration principles in this guide apply to both. For OpenSearch-specific features and version information, see the [OpenSearch documentation](https://opensearch.org/docs/{{page.version}}/).
