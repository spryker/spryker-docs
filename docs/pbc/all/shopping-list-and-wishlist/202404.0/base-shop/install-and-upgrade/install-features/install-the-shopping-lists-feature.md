...
{% include pbc/all/install-features/{{page.version}}/install-the-shopping-lists-feature.md %} <!-- To edit, see /_includes/pbc/all/install-features/{{page.version}}/install-the-shopping-lists-feature.md -->
