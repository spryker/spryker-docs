...
related:
    - title: Install the Shopping Lists Glue API
      link: docs/pbc/all/shopping-list-and-wishlist/202507.0/base-shop/install-and-upgrade/install-glue-api/install-the-shopping-lists-glue-api.html
    ...
    - title: Shopping Lists feature overview
      link: docs/pbc/all/shopping-list-and-wishlist/202507.0/base-shop/shopping-lists-feature-overview/shopping-lists-feature-overview.html
---
...
{% include pbc/all/glue-api-guides/{{page.version}}/shopping-lists-response-attributes.md %} <!-- To edit, see /_includes/pbc/all/glue-api-guides/{{page.version}}/shopping-lists-response-attributes.md -->
