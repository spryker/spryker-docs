...
related:
  - title: Managing wishlist items
    link: docs/pbc/all/shopping-list-and-wishlist/202507.0/base-shop/manage-using-glue-api/glue-api-manage-wishlist-items.html
...
{% include pbc/all/glue-api-guides/{{page.version}}/wishlists-response-attributes.md %} <!-- To edit, see /_includes/pbc/all/glue-api-guides/{{page.version}}/wishlists-response-attributes.md -->
