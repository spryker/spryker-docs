...
redirect_from:
  - /docs/pbc/all/tax-management/202602.0/base-shop/import-and-export-data/import-file-details-tax-sets.csv.html
...
This document describes the `tax.csv` file to configure the [tax](/docs/pbc/all/tax-management/{{page.version}}/base-shop/tax-feature-overview.html) information in your Spryker Demo Shop.
