...
redirect_from:
  - /docs/pbc/all/tax-management/202602.0/base-shop/manage-in-the-back-office/create-tax-rates.html
...
- Assign tax rates to tax sets by [creating tax sets](/docs/pbc/all/tax-management/{{page.version}}/base-shop/manage-in-the-back-office/create-tax-sets.html).

- Assign tax rates to existing tax sets by [editing tax sets](/docs/pbc/all/tax-management/{{page.version}}/base-shop/manage-in-the-back-office/edit-tax-sets.html).
