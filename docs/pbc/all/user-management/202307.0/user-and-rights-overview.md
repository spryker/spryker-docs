...
- /docs/scos/dev/feature-walkthroughs/202307.0/customer-account-management-feature-walkthrough/user-and-rights-overview.html
...
See [Managing users](/docs/pbc/all/user-management/{{page.version}}/manage-in-the-back-office/manage-users/create-users.html) to learn how to create and manage users, groups, and roles.
