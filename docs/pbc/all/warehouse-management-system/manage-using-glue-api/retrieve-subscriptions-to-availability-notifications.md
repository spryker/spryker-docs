...
There is an alternative way to retrieve subscriptions to availability notifications of a registered customer. For details, see [Managing customers](/docs/pbc/all/identity-access-manager/{{site.version}}manage-using-glue-api/glue-api-create-customers.html#create-a-customer).
