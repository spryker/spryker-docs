...
As of the [November release](/docs/scos/dev/about-spryker/201811.0/releases/release-notes/release-notes-2018.11.0/release-notes-2), we offer two types of demo shops:
...
To install the B2B Demo Shop, follow the instructions of the [B2B Demo Shop Installation Guide](/docs/scos/dev/developer-guides/201811.0/installation/installation-gu){target="_blank"}.
...
To install the B2C Demo Shop, follow the instructions of the [B2C Demo Shop Installation Guide](/docs/scos/dev/developer-guides/201811.0/installation/installation-gu){target="_blank"}.
