...
**Documentation**
For more information on Heidelpay integration, see [Payment Integration - Heidelpay](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/heidelpay).
...
**Documentation**
For more information,  see the [Risk Solution Services Integration - Arvato](/docs/scos/dev/technology-partners/201811.0/payment-partners/arvato/arvato) documentation.
...
* [Payment Integration - Heidelpay](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/heidelpay)
* [Risk Solution Services Integration - Arvato 2.0](/docs/scos/dev/technology-partners/201811.0/payment-partners/arvato/v.2.0/arvato-2-0)
* [Performance Guidelines](/docs/scos/dev/developer-guides/201811.0/development-guide/guidelines/performance-gui)
* [Performing Core Updates Smoothly](https://documentation.spryker.com/v1/docs/composer#core-updates)
* [CMS Blocks](https://documentation.spryker.com/v1/docs/cms-block-1)
* [CMS Pages](/docs/scos/dev/features/201811.0/cms/cms-page/cms-page)
* [Demo Shop](/docs/scos/dev/about-spryker/201811.0/videos-and-webinars/legacy-demoshop)
* [Navigation](/docs/scos/dev/features/201811.0/navigation/navigation)
* [Product Groups](/docs/scos/dev/about-spryker/201811.0/videos-and-webinars/product-groups)
* [Product Management](/docs/scos/dev/features/201811.0/product-management/product-managem)
* [Product Sets](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-sets/product-sets)
