...
**Documentation**
For module documentation and integration guides, see [ProductNew Module Guide](https://documentation.spryker.com/v1/docs/product-new)
...
* [CMS Block Category Connector Module Guide](https://documentation.spryker.com/v1/docs/cms-block-category-connector)
...
* [CMS Block Category Connector Migration Console](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-cms-block-category-connector-migration-console.html)
