...
{% info_block infoBox %}
This month we released some important [security updates](/docs/scos/dev/about-spryker/201811.0/whats-new/security-update
{% endinfo_block %}.)
...
For other related documentation, see [HowTo - Add New Shipment Method](/docs/scos/dev/tutorials/201811.0/howtos/ht-add-new-ship)
...
* [Queue Integration - Loggly](/docs/scos/dev/technology-partners/201811.0/operational-tools-monitoring-legal-etc./loggly-queue)
* [Payolution — Configuration](/docs/scos/dev/technology-partners/201811.0/payment-partners/payolution/payolution-conf)
* [Payolution — Workflow](/docs/scos/dev/technology-partners/201811.0/payment-partners/payolution/payolution-work)
