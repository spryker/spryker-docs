...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-2018-12-0
redirect_from:
...
**Documentation**: [Catalog Search](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/catalog-search).
...
**Documentation**: [Managing Customers](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/customers/customers-customer-access-customer-groups/managing-custom).
...
**Documentation**: [Managing Carts](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/managing-carts/managing-carts).
...
**Documentation**: [Checking Out Purchases and Getting Checkout Data](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/checking-out-pu).
...
**Documentation**: [Managing Customers](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/customers/customers-customer-access-customer-groups/managing-custom), [Managing Wishlists](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/managing-wishli), [Retrieving Customer's Order History](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/retrieving-orde).
...
**Documentation**: [REST API Reference](/docs/scos/dev/glue-api/201811.0/rest-api-refere).
