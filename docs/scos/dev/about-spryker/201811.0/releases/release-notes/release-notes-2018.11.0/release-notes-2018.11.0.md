...
**Documentation**: [B2B Demo Shop](/docs/scos/dev/about-spryker/201811.0/demo-shops.html).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/v1/docs/quick-order)
