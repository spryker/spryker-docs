...
**Documentation:**
Feature documentation: [Gift Cards](https://documentation.spryker.com/v1/docs/gift-card-purchase-management-201907)
...
**Documentation**: [Scheduled Prices](https://documentation.spryker.com/v1/docs/scheduled-prices-201907)
...
**Documentation**: [Product Image Management](https://documentation.spryker.com/v1/docs/product-image-management-201907)
***
## CMS
### CMS Content Items
...
* [Content Items](https://documentation.spryker.com/v1/docs/content-items-201907)
...
* [Retrieving Company Information](https://documentation.spryker.com/v1/docs/retrieving-company-information-201907)
* [Retrieving Business Unit Information](https://documentation.spryker.com/v1/docs/retrieving-business-unit-information-201907)
* [Retrieving Company User Information](https://documentation.spryker.com/v1/docs/retrieving-company-user-information-201907)
* [Retrieving Company Role Information](https://documentation.spryker.com/v1/docs/retrieving-company-role-information-201907)
...
**Documentation**: [Shared Carts API](https://documentation.spryker.com/v1/docs/sharing-company-user-carts-201907)
...
**Documentation**: [Request for Quote](https://documentation.spryker.com/v1/docs/quotation-process-rfq-201907) 
...
**Documentation**: [Comments](https://documentation.spryker.com/v1/docs/comments-201907)
...
**Documentation**: [Unique URL per Cart for Easy Sharing](https://documentation.spryker.com/v1/docs/unique-url-per-cart-for-easy-sharing-201907)
...
* Vault - We introduce the Vault place where you can store valuable information and get it from there by ID in an encrypted form and vice versa
    **Documentation**: [Vault for Tokens](https://documentation.spryker.com/v1/docs/vault-for-tokens-201907)

* Customer Login by Token - Ability to log in to the Spryker Commerce OS by token
    **Documentation**: [Customer Login by Token](https://documentation.spryker.com/v1/docs/customer-login-by-token-201907)
...
 
Check out [Documentation Updates](/docs/scos/dev/about-spryker/201811.0/whats-new/documentation-updates.html) for all the updates to documentation made with this release. 
