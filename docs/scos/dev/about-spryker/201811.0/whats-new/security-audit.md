...
The evaluation of the Commerce OS was done without having prior knowledge of the source code, to protect it from attackers. Where it was the case, the found vulnerabilities were verified using the B2B and B2C Demo Shops. See the [Demo shops](/docs/scos/dev/about-spryker/201811.0/demoshops) article for more details.
...
To enforce the secure coding practices, our team has improved a custom code sniffer, that prevents usage of potentially vulnerable code patterns. You can find an overview of the sniffer tool in the [Code Sniffer](/docs/scos/dev/features/201811.0/sdk/development-tools/code-sniffer) article. We recommend using a code sniffer when developing a project that uses our Commerce OS.
...
See [Secure Coding Practices](/docs/scos/dev/developer-guides/201811.0/development-guide/guidelines/coding-guidelines/secure-coding-p) for a list of secure coding recommendations.
