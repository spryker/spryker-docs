...
To install the B2B Demo Shop, follow the instructions of the [B2B Demo Shop Installation Guide](/docs/scos/dev/developer-guides/201903.0/installation/b2c-demo-shop-i){target="_blank"}.
