...
{% info_block infoBox %}
This month we released some important [security updates](/docs/scos/dev/about-spryker/201903.0/whats-new/security-updates.html
{% endinfo_block %}.)
...
For detailed migration guides, see [Shipment Module Migration Guide from Version 5. to 6](https://documentation.spryker.com/v2/docs/mg-shipment#upgrading-from-version-5---to-version-6--).
...
**Documentation**
For detailed migration guides, see [RabbitMQ Module Migration Guide from Version 0. to 1](https://documentation.spryker.com/v2/docs/mg-rabbitmq#upgrading-from-version-0---to-version-1--).
