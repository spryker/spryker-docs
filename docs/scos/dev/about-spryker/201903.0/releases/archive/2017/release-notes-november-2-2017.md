...
For detailed migration guides, see [Customer Module Migration Guide from Version 6. to 7](https://documentation.spryker.com/v2/docs/mg-customer#upgrading-from-version-6---to-version-7-0).
