...
**Documentation**
For detailed migration guides, see [ProductManagement Module Migration Guide from Version 0.7. to 0.8.](https://documentation.spryker.com/v2/docs/mg-product-management#upgrading-from-version-0-7---to-version-0-8--)
