...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-201903-0
redirect_from:
...
**Documentation**: [Discount](/docs/scos/dev/features/201903.0/promotions-and-discounts/discount/discount). 
...
**Documentation**: [Assigning a Template for a Category Page](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/category/category)
...
**Documentation**: [CMS Block widget](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/content-management/content-widgets/content-widgets)
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-enrichment/session-handler).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/201903.0/sdk/development-tools/code-sniffer), [Architecture Sniffer](/docs/scos/dev/features/201903.0/sdk/development-tools/architecture-sn), [PHPStan](https://documentation.spryker.com/v2/docs/phpstan-201903).
...
**Documentation**: [Retrieving Related Products](/docs/scos/dev/glue-api/201903.0/glue-api-storefront-guides/managing-products/retrieving-rela).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](/docs/scos/dev/glue-api/201903.0/glue-api-storefront-guides/retrieving-navi).
...
**Documentation**: [Retrieving Alternative Products](/docs/scos/dev/glue-api/201903.0/glue-api-storefront-guides/managing-products/retrieving-alte).
...
**Documentation**: [Configuring Visibility of the Included Section](/docs/scos/dev/tutorials/201903.0/howtos/glue-api-howtos/ht-configuring-).
...
**Documentation**: [Checkout](/docs/scos/dev/user-guides/201903.0/shop-user-guide/checkout/checkout-shop-g), [Business on Behalf](/docs/scos/dev/features/201903.0/company-account-management/business-on-behalf/business-on-beh), [Reclamations](https://documentation.spryker.com/v2/docs/reclamations-201903).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/201903.0/payment-partners/heidelpay/heidelpay-split).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/201903.0/payment-partners/adyen/adyen).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/201903.0/payment-partners/afterpay/afterpay).

Check out [Documentation Updates](/docs/scos/dev/about-spryker/201903.0/whats-new/documentation-u) for all the updates to documentation made with this release. 
