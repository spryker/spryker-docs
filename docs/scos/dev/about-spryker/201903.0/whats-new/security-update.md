...
Check out our Security Release notes in the [Release Notes](/docs/scos/dev/about-spryker/201903.0/releases/release-notes/release-notes) article for each respective release.
