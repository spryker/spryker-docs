...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/code-sniffer), [Architecture Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/architecture-sn), [PHPStan](https://documentation.spryker.com/v2/docs/phpstan-201903).
...
**Documentation**: [Checkout](https://documentation.spryker.com/v2/docs/delivery-address-step-shop-guide), [Business on Behalf](/docs/scos/dev/features/201903.0/company-account-management/business-on-behalf/business-on-beh), [Reclamations](https://documentation.spryker.com/v2/docs/reclamations-201903).
