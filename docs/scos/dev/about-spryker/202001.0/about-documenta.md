...
**[User Guides](/docs/scos/dev/user-guides/202001.0/about-user-guid)**: Meant primarily for the end-users who need assistance navigating and using features of the Spryker Back Office and Storefront.
...
**[Migration and Integration](/docs/scos/dev/migration-and-integration/202001.0/about-migration)**: Holds feature integration and module migration guides for the developers.
...
* **Glue API**: Signifies that feature is also available in the [Spryker Glue API](/docs/scos/dev/glue-api/202001.0/glue-rest-api).
