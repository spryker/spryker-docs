...
**Documentation**
For module documentation, see [Navigation Module Guide](/docs/scos/dev/features/202001.0/navigation/navigation.html), [Under the Hood - Navigation](https://documentation.spryker.com/v4/docs/module-navigation#under-the-hood).
