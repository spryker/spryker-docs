...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v4/docs/back-office-translations-201903).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](https://documentation.spryker.com/v4/docs/phpstan-201903).
...
**Documentation**: [Checkout](/docs/scos/user/user-guides/202001.0/shop-user-guide/shop-guide-checkout/shop-guide-address-step.html), [Business on Behalf](/docs/scos/dev/features/202001.0/company-account-management/business-on-behalf/business-on-behalf.html), [Reclamations](https://documentation.spryker.com/v4/docs/reclamations-201903).
