...
**Documentation**
For module documentation, see [Product Relation](https://documentation.spryker.com/docs/en/product-relations). For integration guides see: [Product Relations Feature Integration](https://documentation.spryker.com/docs/en/product-relation-integration).
...
**Documentation**
For module documentation, see [Event](https://documentation.spryker.com/docs/en/event).
