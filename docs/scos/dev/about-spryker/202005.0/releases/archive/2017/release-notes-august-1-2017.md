...
**Documentation**
For module documentation, see [Shipment Module Guide](https://documentation.spryker.com/docs/en/shipment-module-overview).
...
For guidelines and documentation, see [Code Architecture Guide](https://documentation.spryker.com/docs/en/code-architecture-guide).
...
* [Authorization and Preauthorization-Capture Flows](https://documentation.spryker.com/docs/en/payone-authorization-and-preauthorization-capture-flows)
* [PayPal Express Checkout Payment - Payone](https://documentation.spryker.com/docs/en/payone-paypal-express-checkout)
