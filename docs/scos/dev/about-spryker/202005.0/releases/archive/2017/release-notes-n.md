...
{% info_block infoBox %}
This month we released some important [security updates](https://documentation.spryker.com/docs/en/security-updates
{% endinfo_block %}.)
...
For detailed migration guides, see [Shipment Module Migration Guide from Version 5. to 6](https://documentation.spryker.com/docs/en/mg-shipment#upgrading-from-version-5---to-version-6--).
For store administration guides, see Shipment Store Administration Guide<!--/administration_interface_guide/shipment.htm)-->
For other related documentation, see [HowTo - Add New Shipment Method](https://documentation.spryker.com/docs/en/ht-add-new-shipment-method-2)
...
**Documentation**
For detailed migration guides, see [RabbitMQ Module Migration Guide from Version 0. to 1](https://documentation.spryker.com/docs/en/mg-rabbitmq#upgrading-from-version-0---to-version-1--).
...
* [Queue Integration - Loggly](https://documentation.spryker.com/docs/en/loggly-queue)
* [Payolution — Configuration](https://documentation.spryker.com/docs/en/payolution-configuration)
* [Payolution — Workflow](https://documentation.spryker.com/docs/en/payolution-workflow)
