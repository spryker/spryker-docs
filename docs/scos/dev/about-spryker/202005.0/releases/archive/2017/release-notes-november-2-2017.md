...
For detailed migration guides, see [Customer Module Migration Guide from Version 6. to 7](https://documentation.spryker.com/docs/en/mg-customer#upgrading-from-version-6---to-version-7-0).
...
* [Payment Integration - BS Payone - 1.1](https://documentation.spryker.com/docs/en/payone-v1-1) 
* Integration With Project - Payone
* [PayPal Express Checkout Payment - Payone - 1.1](https://documentation.spryker.com/docs/en/payone-paypal-express-checkout)
 
