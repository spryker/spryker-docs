...
**Documentation**
For module documentation, see [Discount Module Guide](https://documentation.spryker.com/docs/en/discount), Extending the Discount Module, [Discount Promotions](https://documentation.spryker.com/docs/en/promotions-discount).
...
For feature integration, see [Feature Integration - Product Reviews](https://documentation.spryker.com/docs/en/product-review-feature-integration).
...
**Documentation**
For detailed migration guides, see [Currency Module Migration Guide from Version 2. to 3](https://documentation.spryker.com/docs/en/mg-currency#upgrading-from-version-2---to-version-3--).
