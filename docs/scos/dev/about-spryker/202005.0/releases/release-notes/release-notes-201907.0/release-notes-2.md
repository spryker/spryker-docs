...
**Documentation:**
Feature documentation: [Gift Cards](https://documentation.spryker.com/docs/en/gift-card-purchase-management-201907)
...
**Documentation**: [Scheduled Prices](https://documentation.spryker.com/docs/en/scheduled-prices-201907)
...
**Documentation**: [Product Image Management](https://documentation.spryker.com/docs/en/product-image-management-201907)
***
## CMS
### CMS Content Items
...
* [Content Item Widgets](https://documentation.spryker.com/docs/en/content-item-widgets-201907)
***
...
**Documentation**: [B2B Logging in as Company User](https://documentation.spryker.com/docs/en/logging-in-as-company-user-201907)
...
* [Retrieving Company Information](https://documentation.spryker.com/docs/en/retrieving-company-information-201907)
* [Retrieving Business Unit Information](https://documentation.spryker.com/docs/en/retrieving-business-unit-information-201907)
* [Retrieving Company User Information](https://documentation.spryker.com/docs/en/retrieving-company-user-information-201907)
* [Retrieving Company Role Information](https://documentation.spryker.com/docs/en/retrieving-company-role-information-201907)
...
* [Security and Authentication](https://documentation.spryker.com/docs/en/security-and-authentication)
* [B2B Logging in as Company User](https://documentation.spryker.com/docs/en/logging-in-as-company-user-201907)
* [Retrieving Company Role Information](https://documentation.spryker.com/docs/en/retrieving-company-role-information-201907)
...
**Documentation**: [Managing Carts of Registered Users](https://documentation.spryker.com/docs/en/managing-carts-of-registered-users)
...
**Documentation**: [Shared Carts API](https://documentation.spryker.com/docs/en/sharing-company-user-carts-201907)
...
* [Interacting with Third Party Payment Providers via Glue API](https://documentation.spryker.com/docs/en/t-interacting-with-third-party-payment-providers-via-glue-api)
* [B2B-B2C Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/docs/en/checking-out-purchases-and-getting-checkout-data)
...
**Documentation**: [Spryker in Docker](https://documentation.spryker.com/docs/en/spryker-in-docker-201907)
***
## B2B
### Request for Quote
...
**Documentation**: [Request for Quote](https://documentation.spryker.com/docs/en/quotation-process-rfq-201907) 
...
**Documentation**: [Punchout](https://documentation.spryker.com/docs/en/punchout-201907)
...
**Documentation**: [Comments](https://documentation.spryker.com/docs/en/comments-201907)
...
**Documentation**: [Unique URL per Cart for Easy Sharing](https://documentation.spryker.com/docs/en/unique-url-per-cart-for-easy-sharing-201907)
...
* Vault - We introduce the Vault place where you can store valuable information and get it from there by ID in an encrypted form and vice versa
    **Documentation**: [Vault for Tokens](https://documentation.spryker.com/docs/en/vault-for-tokens-201907)

* Customer Login by Token - Ability to log in to the Spryker Commerce OS by token
    **Documentation**: [Customer Login by Token](https://documentation.spryker.com/docs/en/customer-login-by-token-201907)
...
**Documentation**: [Payone - Cash on Delivery](https://documentation.spryker.com/docs/en/payone-cash-on-delivery)
...
**Documentation**: [Heidelpay - Easy Credit](https://documentation.spryker.com/docs/en/heidelpay-easy-credit)
...
* [RatePay - Prepayment](https://documentation.spryker.com/docs/en/ratepay-prepayment)
* [RatePay - Invoice](https://documentation.spryker.com/docs/en/ratepay-invoice)
* [RatePay - Direct Debit](https://documentation.spryker.com/docs/en/ratepay-direct-debit)
* [RatePay - Installment](https://documentation.spryker.com/docs/en/ratepay-installment)
...
**Documentation**: [Episerver](https://documentation.spryker.com/docs/en/episerver) 
...
**Documentation**: [Ratenkauf by Easycredit - Installation and Configuration](https://documentation.spryker.com/docs/en/ratenkauf-by-easycredit-installation-and-configuration)
...
**Documentation**: [CrefoPay](https://documentation.spryker.com/docs/en/crefopay-configuration) 
