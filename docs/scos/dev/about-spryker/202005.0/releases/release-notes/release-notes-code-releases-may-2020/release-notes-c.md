...
originalLink: https://documentation.spryker.com/v5/docs/release-notes-code-releases-may-2020
redirect_from:
  - /v5/docs/release-notes-code-releases-may-2020
  - /v5/docs/en/release-notes-code-releases-may-2020
---

The Spryker Commerce OS is an end-to-end solution for digital commerce. This document contains a business level description of new features and enhancements we are announcing in May of 2020 as part of the [code release](https://documentation.spryker.com/docs/en/spryker-release-process#atomic--code--releases).
...
#### Documentation
[Custom Order Reference](https://documentation.spryker.com/docs/en/custom-order-reference)
...
#### Documentation
[Filter and Search in Order Archive](https://documentation.spryker.com/docs/en/shop-guide-order-history#sorting-and-filtering-orders--b2b-shop-)
...
#### Documentation
[Quotation Process and RFQ](https://documentation.spryker.com/docs/en/quotation-process-rfq-201907)
...
#### Documentation
[Importing Data with a Configuration File](https://documentation.spryker.com/docs/en/importing-data)
...
#### Documentation
[Demo Shop Data Import](https://documentation.spryker.com/docs/en/about-demo-shop-data-import)
...
#### Documentation
[Measurement Units API](https://documentation.spryker.com/docs/en/retrieving-measurement-units)
...
#### Documentation
[Shopping Lists API](https://documentation.spryker.com/docs/en/managing-shopping-lists)
...
#### Documentation
[Promotions API](https://documentation.spryker.com/docs/en/retrieving-promotional-items)
...
* [Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/docs/en/checking-out-purchases-and-getting-checkout-data-201907)
* [Retrieving Customer's Order History](https://documentation.spryker.com/docs/en/retrieving-customers-order-history)
...
#### Documentation
[Token Revocation](https://documentation.spryker.com/docs/en/authentication-and-authorization#token-revocation)
...
#### Documentation
[Resource Relationships](https://documentation.spryker.com/docs/en/documenting-glue-api-resources#resource-relationships)
