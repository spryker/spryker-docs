...
The detailed view of modules allows you to analyze the changes, and if needed, upgrade the modules. To upgrade to the latest minor module versions, run the module [composer update](/docs/scos/dev/setup/managing-scos-dependencies-with-composer.html#composer-update) command. To upgrade to a major version, follow the [migration guide](/docs/scos/dev/module-migration-guides/about-migration-guides.html) of the respective module.
