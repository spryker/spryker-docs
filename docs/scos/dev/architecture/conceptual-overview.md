...
* *Storefront API*—an application providing resources for customers' interaction, provided by Glue Application Layer, and can work either based on REST or [JSON API convention](https://jsonapi.org/).
