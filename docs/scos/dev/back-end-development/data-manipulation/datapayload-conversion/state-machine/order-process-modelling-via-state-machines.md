...
If you are looking for information on the OMS State Machine, see [OMS State Machine](/docs/scos/user/features/order-management-feature-overview/oms-order-management-system-matrix.html).
{% endinfo_block %}
...
In the default implementation for Master Suite, the timeout processor in [OmsTimeout/Initiation](/docs/scos/dev/feature-integration-guides/order-management-feature-integration.html) plugin starts the timeout immediately, from the current time:
