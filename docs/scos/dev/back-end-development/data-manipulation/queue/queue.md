...
For more information and examples of how to get started with the Queue module, see [Tutorial - Set Up a "Hello World" Queue](/docs/scos/dev/legacy-demoshop/{{site.version}}/set-up-a-hello-world-queue-legacy-demoshop.html).
