...
By default, the .yml export configuration file resides in `./data/export/config/`.  You can adjust your .yml export configuration file, but when doing so, stick to its [structure](/docs/scos/dev/developer-guides/202009.0/development-guide/data-export/exporting-data.html#structure) and take the possible [data filtering options](/docs/scos/dev/developer-guides/202009.0/development-guide/data-export/exporting-data.html#filter) into account.
...
See[ Data Export Ordres .csv Files Format](/docs/scos/dev/developer-guides/202009.0/development-guide/data-export/data-export-orders-.csv-files-format.html)  for details on the content of each of the files.
<a name="filter"></a>
