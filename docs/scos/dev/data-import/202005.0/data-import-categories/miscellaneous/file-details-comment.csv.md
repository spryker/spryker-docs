...
This article contains content of the **comment.csv** file to configure [Comment](/docs/scos/user/features/{{page.version}}/mailing-and-communication/comments/comments.html)  information on your Spryker Demo Shop.
