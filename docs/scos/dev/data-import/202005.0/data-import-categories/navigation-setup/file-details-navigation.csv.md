...
This article contains content of the **navigation.csv** file to configure [Navigation](/docs/scos/user/features/{{page.version}}/navigation/navigation/navigation-feature-overview.html) information on your Spryker Demo Shop.
