...
This article contains content of the **product_set.csv** file to configure [Product Set](/docs/scos/dev/features/202009.0/product-sets/product-sets.html) information on your Spryker Demo Shop.
