...
| meta_title.{ANY_LOCALE_NAME}<br>Example value: *meta_title.de_DE*  |  | String | N/A | Title in the specified location (DE for our example). |
| meta_description.{ANY_LOCALE_NAME}<br>Example value: *meta_description.de_DE* |  | String | N/A | Description in the specified location (DE for our example). |
| meta_keywords.{ANY_LOCALE_NAME}<br>Example value: *meta_keywords.de_DE* |  | String | N/A | Keywords in the specified location (DE for our example). |
...
| node_order |  | Integer | N/A| Order of the category node. |
| template_name |  | String |N/A | Template name of the category. |
| category_image_name.{ANY_LOCALE_NAME} |  | String |N/A | Name of the image for the category in the locale. |
