...
This article contains content of the **cms_slot.csv** file to configure [CMS Slot](/docs/scos/user/features/{{page.version}}/cms/cms-feature-overview/templates-and-slots-overview.html) information on your Spryker Demo Shop.
