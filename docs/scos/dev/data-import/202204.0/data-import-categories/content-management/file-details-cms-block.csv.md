...
This document describes the `cms_block.csv` file to configure [CMS Block](/docs/scos/user/features/{{page.version}}/cms-feature-overview/cms-blocks-overview.html) information about your Spryker Demo Shop.
