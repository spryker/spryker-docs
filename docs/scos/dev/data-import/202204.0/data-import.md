...
---
Spryker’s customers need to import data from other systems into their Spryker Commerce OS project. The _Data import_ section holds information all the needed information for that. For more specific details, see the following subsections:
