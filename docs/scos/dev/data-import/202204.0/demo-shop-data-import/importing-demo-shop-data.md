...
To import data into a Spryker Demo Shop, you need to do the following:
...
2. [Populate the CSV files with import data](/docs/scos/dev/data-import/{{page.version}}/data-import-categories/about-data-import-categories.html).
