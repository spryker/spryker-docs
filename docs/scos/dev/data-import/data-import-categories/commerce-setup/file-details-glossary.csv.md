...
This document describes the `glossary.csv` file to configure [Customer](/docs/scos/user/back-office-user-guides/administration/glossary/managing-glossary.html) information in your Spryker Demo Shop.
