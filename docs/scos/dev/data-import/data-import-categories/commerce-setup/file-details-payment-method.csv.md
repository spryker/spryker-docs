...
This document describes the `payment_method.csv` file to configure the [Payment Method](/docs/scos/user/features/payments-feature-overview.html) information in your Spryker Demo Shop.
