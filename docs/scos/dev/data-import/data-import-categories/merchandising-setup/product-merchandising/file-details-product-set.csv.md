...
redirect_from:
  ...
  - /docs/scos/dev/data-import/data-import-categories/merchandising-setup/product-merchandising/file-details-product-set.csv.html
---

This document describes the `product_set.csv` file to configure [Product Set](/docs/scos/user/features/product-sets-feature-overview.html) information in your Spryker Demo Shop.
