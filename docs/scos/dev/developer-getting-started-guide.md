...
When working with a local environment, you should use the [deploy.dev.yml](/docs/dg/dev/sdks/the-docker-sdk/{{site.version}}/deploy-file/deploy-file.html) file.
