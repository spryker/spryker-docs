...
originalLink: https://documentation.spryker.com/v1/docs/programming-concepts
originalArticleId: 6b2ff11a-df7a-4934-8238-7b8afb463cf1
redirect_from:
...
* To find out how data flows are separated in Spryker Commerce OS, refer to [Commerce OS and Frontend Apps](/docs/scos/dev/developer-guides/201811.0/architecture-guide/commerce-os-and-frontend-apps.html).
