...
Queue pool is designed to allow P&S ([Publish and Synchronization](https://documentation.spryker.com/v1/docs/publish-and-synchronization )) messages to be sent to several queues.
