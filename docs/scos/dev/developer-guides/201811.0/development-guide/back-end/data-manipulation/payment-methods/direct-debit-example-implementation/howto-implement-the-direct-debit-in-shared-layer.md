---
title: HowTo - Implement the Direct Debit in Shared Layer
...
originalLink: https://documentation.spryker.com/v1/docs/dd-shared-implementation
originalArticleId: 51daae8c-d1ce-4f07-8fd3-a4080be271dc
redirect_from:
...
After you've completed the front end, back end and shared implementation of the Direct Debit payment method, you can test it. See [Testing your Direct Debit Implementation](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/payment-methods/direct-debit-example-implementation/howto-test-the-direct-debit-implementation.html) for information on how to do that.
