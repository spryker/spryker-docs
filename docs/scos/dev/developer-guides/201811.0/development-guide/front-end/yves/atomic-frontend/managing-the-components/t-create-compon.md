...
originalLink: https://documentation.spryker.com/v1/docs/t-create-component
redirect_from:
  - /v1/docs/t-create-component
  - /v1/docs/en/t-create-component
---

As Spryker Shop implements the [Component Model](https://documentation.spryker.com/v1/docs/atomic-frontend#component-model), adding new functionality to it usually means implementing a new component. In this document, we shall review creation of a new component on the example of a simple block that displays the count of DOM elements of a certain type. To implement it:
