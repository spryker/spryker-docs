...
originalLink: https://documentation.spryker.com/v2/docs/modularity-and-shop-suite
redirect_from:
...
* To find out how data flows are separated in Spryker Commerce OS, refer to [Commerce OS and Frontend Apps](/docs/scos/dev/developer-guides/201903.0/architecture-guide/commerce-os-and).
