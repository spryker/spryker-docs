...
originalLink: https://documentation.spryker.com/v2/docs/console
originalArticleId: 714e58b4-0c4e-4b7d-8633-0c621000fb07
redirect_from:
  - /v2/docs/console
  - /v2/docs/en/console
---

The [list of console commands](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-enrichment/console-commands/getting-the-list-of-console-commands-and-available-options.html) contains the command names together with a short description of what the command does. The most important commands in Spryker can be split into 3 categories : collector commands, order managemenet system commands and setup commands. This article provides details on each of the commands.
