...
originalLink: https://documentation.spryker.com/v2/docs/flysystem
originalArticleId: e69ea0e5-dd7c-49fe-900d-0e44363869e1
redirect_from:
  - /v2/docs/flysystem
...
See [Plugin Configuration](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/file-system.html) for details.
...
Mapping between Filesystem and the type it can handle is done via configuration, see [Plugin Configuration](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/file-system.html) for details.
