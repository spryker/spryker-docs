...
originalLink: https://documentation.spryker.com/v2/docs/redis-as-kv
originalArticleId: 72edfb7e-d8fb-4c5c-a19c-bdc091745ee1
redirect_from:
  - /v2/docs/redis-as-kv
...
See [Publish and Synchronization](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-publishing/publish-and-synchronization.html) to find out more about how the Publish and Synchronization works and how to extend it.
...
For more information, see [Cronjob Scheduling](/docs/scos/dev/features/201903.0/sdk/cronjob-scheduling.html).
...
The `StorageClientcan` can be obtained as an external dependency for Yves, in the client layer. In the dependency provider of the client layer from your module, add the `StorageClient` dependency as in the example below:
