...
To learn more about URL routing in Yves, check out [Implementing URL Routing in Yves](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/yves/implementing-url-routing-in-yves.html).
