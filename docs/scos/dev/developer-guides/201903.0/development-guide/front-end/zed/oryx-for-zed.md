...
originalLink: https://documentation.spryker.com/v2/docs/oryx-for-zed
originalArticleId: e7e8e412-0233-4688-b1a2-dbd1509a2513
redirect_from:
...
Settings are extended and changed by using the onyx-for-zed [API](/docs/scos/dev/developer-guides/201903.0/development-guide/front-end/zed/oryx-for-zed.html#api).
...
`webpack` is customised by using the `onyx-for-zed` [API](/docs/scos/dev/developer-guides/201903.0/development-guide/front-end/zed/oryx-for-zed.html#api). 
