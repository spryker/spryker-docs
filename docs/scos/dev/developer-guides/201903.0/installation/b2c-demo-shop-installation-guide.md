...
originalLink: https://documentation.spryker.com/v2/docs/b2c-demo-shop-installation-mac-os-or-linux-with-devvm
originalArticleId: f5886585-cce7-4fa6-bb9e-396acd508a2c
redirect_from:
...
![Run git bash as administrator](https://spryker.s3.eu-central-1.amazonaws.com/docs/Developer+Guide/Installation/B2C+Demo+Shop+Installation+Guide/run-git-bash-as-administrator.png)
