...
originalLink: https://documentation.spryker.com/v2/docs/debugging-setup
originalArticleId: c43d20b6-424e-4315-a412-1500b32bd2bc
redirect_from:
...
To configure debugging for old version of the VM prior 91, see [Debugging Setup for VM Prior Version 91](https://documentation.spryker.com/v2/configuring-debugging-in-vagrant-with-vm-below-version-91
{% endinfo_block %}.)
