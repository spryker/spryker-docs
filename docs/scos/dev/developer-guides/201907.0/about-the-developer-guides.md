...
originalArticleId: ae2bd567-8e17-45f7-aa28-b7fe00649ac4
redirect_from:
...
* [Spryker OS installation guides](/docs/scos/dev/developer-guides/201907.0/installation/about-the-installation-guides.html), including the B2B Demo Shop, B2C Demo Shop,  Spryker in Docker installation guides.
* [Spryker architecture guide](/docs/scos/dev/developer-guides/201907.0/architecture-guide/about-the-architecture-guide.html) that provides an overview of the architecture, structure and technologies  of the Spryker OS.
* [Develoment guides](/docs/scos/dev/developer-guides/201907.0/development-guide/about-the-development-guide.html) that will help you understand technical details of the Spryker OS as well as customize it to your project's needs.
