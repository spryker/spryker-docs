...
A Page module typically contains a `ControllerProvider` plugin for routing (see [URL Routing](/docs/scos/dev/developer-guides/202001.0/development-guide/back-end/yves/yves-url-routin)) and some Controllers with their twig templates (see [Controllers and Actions](https://documentation.spryker.com/v4/docs/controllers-actions)). The implementation scope of a *Page* module should be decided individually, depending on its need of re-usability. 
