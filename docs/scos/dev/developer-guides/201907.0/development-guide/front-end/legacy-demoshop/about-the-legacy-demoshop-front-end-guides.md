...
The Legacy Demoshop Front-end guides provide information of how the front-end was built in the [Legacy Demoshop](/docs/scos/user/intro-to-spryker/{{site.version}}/master-suite.html). Here you will find the following information:
