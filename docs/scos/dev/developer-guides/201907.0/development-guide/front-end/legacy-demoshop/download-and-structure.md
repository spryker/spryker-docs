...
originalLink: https://documentation.spryker.com/v3/docs/download-structure
originalArticleId: bd46ed66-89a2-4e1b-9a1d-3e3d2eaeedad
redirect_from:
...
{% endinfo_block %}, [Oryx](/docs/scos/dev/developer-guides/201907.0/development-guide/front-end/zed/oryx-builder-overview-and-setup.html) (Our frontend helper tool)and Oryx for Zed (Zed's frontend full automation tool). Make sure you are familiar with these tools before continuing.)
