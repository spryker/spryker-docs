...
originalLink: https://documentation.spryker.com/v3/docs/installation-guide-chose-modules
originalArticleId: 4a702bcd-c67f-4db4-b3b0-1475c3fbc9be
redirect_from:
...
2. Add or remove modules as necessary using [Composer](/docs/scos/dev/developer-guides/201907.0/installation/composer.html). All available modules can be found in the following repositories:
