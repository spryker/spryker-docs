...
originalLink: https://documentation.spryker.com/v4/docs/ht-data-import
originalArticleId: ec808a2b-648d-4622-97f6-99d1154198fd
redirect_from:
  - /v4/docs/ht-data-import
  - /v4/docs/en/ht-data-import
---
...
Find or create `spy_product_image_set`. Add the following code to the `ProductImageWriterStep`:
...
Find or create the `spy_product_image`. Add the following code to the `ProductImageWriterStep`:
...
Add the relation `spy_product_image_set_to_product_image`. Add the following code to the `ProductImageWriterStep`:
