...
More information about transfer objects and how to define them in Spryker can be read in [Creating, Using and Extending the Transfer Objects](https://documentation.spryker.com/v4/docs/ht-use-transfer-objects-201903).
