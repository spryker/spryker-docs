---
title: Client
originalLink: https://documentation.spryker.com/v4/docs/client
redirect_from:
  - /v4/docs/client
  - /v4/docs/en/client
---
...
The following example shows the usage of the cart client inside the `CartController`. As you can see the Client uses [transfer objects](https://documentation.spryker.com/v4/docs/ht-use-transfer-objects-201903) as an input parameter.
