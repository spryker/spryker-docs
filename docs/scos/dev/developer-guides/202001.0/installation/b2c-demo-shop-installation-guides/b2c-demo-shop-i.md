...
To install the [Demo Shop for B2C implementations](/docs/scos/dev/about-spryker/202001.0/b2c-suite) on Mac OS or Linux with Development Virtual Machine, follow the steps below.
