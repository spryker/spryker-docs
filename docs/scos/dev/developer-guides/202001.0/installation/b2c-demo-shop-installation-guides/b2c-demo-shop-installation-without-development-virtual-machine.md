...
To install the [Demo Shop for B2C implementations](/docs/scos/dev/about-spryker/202001.0/b2c-suite.html) without Development Virtual Machine, follow the steps below.
