...
originalLink: https://documentation.spryker.com/v4/docs/post-installation-steps-and-additional-info
originalArticleId: a50c3107-4870-46e3-877a-28b26832481c
redirect_from:
...
|Management UI|15672|See [Default Queue Engine](/docs/scos/dev/developer-guides/202001.0/development-guide/back-end/data-manipulation/queue/queue.html#default-queue-engine) for more information. |
...
To check for newer released versions, we recommend that you follow the steps described in [Core Updates](/docs/scos/dev/developer-guides/202001.0/installation/composer.html#core-updates).
