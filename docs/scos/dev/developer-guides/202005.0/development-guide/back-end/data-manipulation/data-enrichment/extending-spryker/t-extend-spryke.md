...
Replacement rules, described in the [Extending the Core](https://documentation.spryker.com/docs/en/core-extension ) article work for the next classes in Spryker module:
