...
See [Plugin Configuration](https://documentation.spryker.com/docs/en/filesystem) for details.
...
Mapping between Filesystem and the type it can handle is done via configuration, see [Plugin Configuration](https://documentation.spryker.com/docs/en/filesystem) for details.
