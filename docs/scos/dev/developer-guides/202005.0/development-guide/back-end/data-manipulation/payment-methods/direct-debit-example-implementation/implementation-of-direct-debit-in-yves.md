...
originalLink: https://documentation.spryker.com/v5/docs/dd-fe-implementation
originalArticleId: ced91edf-8420-4a4d-b38f-afa757ee3ed2
redirect_from:
...
After the form has been created and the payment handler has been set up, you need to [integrate them into the Checkout module](/docs/scos/dev/developer-guides/202005.0/development-guide/back-end/data-manipulation/payment-methods/direct-debit-example-implementation/integrate-direct-debit-into-checkout.html).
