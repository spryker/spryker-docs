...
This article contains content of the **product_concrete.csv** file to configure [Concrete Product](https://documentation.spryker.com/docs/en/product-abstraction) information on your Spryker Demo Shop.
