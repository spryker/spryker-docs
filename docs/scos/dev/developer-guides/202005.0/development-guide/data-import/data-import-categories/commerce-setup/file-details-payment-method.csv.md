...
This article contains content of the **payment_method.csv** file to configure [Payment Method](https://documentation.spryker.com/docs/en/payment) information on your Spryker Demo Shop.
