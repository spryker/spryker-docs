...
This article contains content of the **product_alternative.csv** file to configure [Alternative Product](https://documentation.spryker.com/docs/en/alternative-products) information on your Spryker Demo Shop.
