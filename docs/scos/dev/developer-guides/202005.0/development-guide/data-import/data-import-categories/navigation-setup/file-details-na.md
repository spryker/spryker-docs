...
This article contains content of the **navigation.csv** file to configure [Navigation](https://documentation.spryker.com/docs/en/navigation-feature-overview) information on your Spryker Demo Shop.
