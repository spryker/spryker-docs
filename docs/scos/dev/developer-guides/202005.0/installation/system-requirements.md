...
### Supported browsers
The Spryker Commerce OS supports the following browsers for all frontend-related projects/products ([B2B Demo Shop](/docs/scos/user/intro-to-spryker/{{site.version}}/b2b-suite.html), [B2C Demo Shop](/docs/scos/user/intro-to-spryker/{{site.version}}/b2c-suite.html), [Master Suite](/docs/scos/user/intro-to-spryker/{{site.version}}/master-suite.html)):
