...
originalLink: https://documentation.spryker.com/v6/docs/redis-as-kv
originalArticleId: 5c2d1875-8b14-45bb-92a0-c47701842730
redirect_from:
  - /v6/docs/redis-as-kv
...
See [Publish and Synchronization](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-publishing/publish-and-synchronization.html) to find out more about how the Publish and Synchronization works and how to extend it.
...
For more information, see [Cronjob Scheduling](/docs/scos/dev/sdk/202009.0/cronjob-scheduling.html).
