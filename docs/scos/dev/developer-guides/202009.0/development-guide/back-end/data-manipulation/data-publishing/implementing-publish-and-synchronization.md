...
originalArticleId: 23135cbe-1cf2-4e92-ab04-98fefc5a94a0
redirect_from:
...
Now, you need to create a publication queue. It will be used to synchronize published data to the frontend. It is recommended to have a separate queue for each *Redis* or *Elasticsearch* entity. For information on how to create a queue, see [Set Up a "Hello World" Queue](https://documentation.spryker.com/v6/docs/setup-hello-world-queue), section **Creating a Simple Queue**.
...
Implementing a listener is detailed in [Listening to Events](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/event/listening-to-events.html). Follow the guide to create your listener classes.
...
1. Turn off [Jenkins](/docs/scos/dev/sdk/202009.0/cronjob-scheduling.html) to stop processing all queues. This can be done using the following command:
