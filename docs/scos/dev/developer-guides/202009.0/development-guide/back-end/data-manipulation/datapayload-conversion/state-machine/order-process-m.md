...
originalLink: https://documentation.spryker.com/v6/docs/order-process-modelling-state-machines
redirect_from:
...
In the default implementation for Master Suite, the timeout processor in [OmsTimeout/Initiation](/docs/scos/dev/migration-and-integration/202009.0/feature-integration-guides/order-managemen) plugin starts the timeout immediately, from the current time:
