...
This article contains content of the **product_set.csv** file to configure [Product Set](https://documentation.spryker.com/docs/product-set) information on your Spryker Demo Shop.
