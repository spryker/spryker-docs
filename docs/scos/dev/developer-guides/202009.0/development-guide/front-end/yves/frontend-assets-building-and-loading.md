...
originalArticleId: a582e8de-fc40-40be-ba79-e2cd2b776a18
redirect_from:
...
The main purpose of the page-critical-path layout is to use the CSS Lazy Load only for the landing pages. To enable the CSS Lazy Load for your project, see [Frontend CSS Lazy Load integration](/docs/scos/dev/migration-and-integration/202009.0/technical-enhancements/frontend-css-lazy-load-integration.html).
...
To create a frontend build in different ES5 and ES6 modes, use the list of commands from [Frontend-related commands](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-enrichment/console-commands/console-commands-in-spryker.html#frontend-related-commands). See the YVES section.
