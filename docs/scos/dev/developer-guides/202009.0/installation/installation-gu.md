...
2. Add or remove modules as necessary using [Composer](/docs/scos/dev/developer-guides/202001.0/installation/composer). All available modules can be found in the following repositories:
