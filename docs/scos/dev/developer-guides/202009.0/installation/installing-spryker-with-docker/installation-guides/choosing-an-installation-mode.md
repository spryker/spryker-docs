...
* To check or show the functionalities of [[B2B](/docs/scos/user/intro-to-spryker/{{site.version}}/b2b-suite.html)/[B2C demo shops](/docs/scos/user/intro-to-spryker/{{site.version}}/b2c-suite.html)].
