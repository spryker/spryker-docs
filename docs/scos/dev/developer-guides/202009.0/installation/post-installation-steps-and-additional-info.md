...
originalLink: https://documentation.spryker.com/v6/docs/post-installation-steps-and-additional-info
originalArticleId: 1406412c-8f57-4172-9e13-2eb5434fb112
redirect_from:
...
|Management UI|15672|See [Default Queue Engine](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/queue/queue.html#default-queue-engine) for more information. |
...
To check for newer released versions, we recommend that you follow the steps described in [Core Updates](/docs/scos/dev/developer-guides/202009.0/installation/composer.html#core-updates).
