...
This article contains content of the **cms_slot.csv** file to configure [CMS Slot](https://documentation.spryker.com/docs/templates-slots) information on your Spryker Demo Shop.
