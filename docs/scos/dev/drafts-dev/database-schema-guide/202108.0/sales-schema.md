...
See description of the [Product Bundle](/docs/scos/dev/database-schema-guide/catalog-schema.html#product-bundles) and [Product Option](/docs/scos/dev/database-schema-guide/catalog-schema.html#product-options) schemas for more details.
