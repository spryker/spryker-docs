...
originalLink: https://documentation.spryker.com/v2/docs/prices-per-merchant-relation-integration
originalArticleId: 6a612dff-8e78-4b72-a2ad-25f78bc17a2d
redirect_from:
  - /v2/docs/prices-per-merchant-relation-integration
  - /v2/docs/en/prices-per-merchant-relation-integration
---
...
If you have not installed plugins needed for Merchant and Merchant Relations
, add them here as well. See _Merchant and Merchant Relations feature integration guide_ for more details.)
...
{% info_block infoBox %}
See  [Migration Guide - PriceProduct](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-priceproduct-module.html) for information on how to migrate to a newer version of the `PriceProduct` module with price dimensions support.
