...
related:
  ...
  - title: Getting Suggestions for Auto-Completion and Search
    link: docs/scos/dev/glue-api-guides/page.version/retrieving-autocomplete-and-search-suggestions.html
---
...
- https://glue.mysprykershop.commm/catalog-search?q={% raw %}{{{% endraw %}q_term{% raw %}}}{% endraw %}
- https://glue.mysprykershop.commm/catalog-search-suggestions?q={% raw %}{{{% endraw %}q_term{% raw %}}}{% endraw %}
...
- Send a request to `https://glue.mysprykershop.commm/catalog-search?q={% raw %}{{{% endraw %}q_term{% raw %}}}{% endraw %}&include=abstract-products` and verify that the response includes relationships to `abstract-products` resources.
- Send a request to `https://glue.mysprykershop.commm/catalog-search-suggestions?q={% raw %}{{{% endraw %}q_term{% raw %}}}{% endraw %}&include=abstract-products` and verify that the response includes relationships to `abstract-products` resources.
