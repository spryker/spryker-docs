...
| --- | --- | --- |
| Spryker Core | 201907.0 | [Glue Application](https://documentation.spryker.com/v4/docs/glue-application-feature-integration-201907) |
| Cart | 201907.0 | [Cart API](/docs/scos/dev/feature-integration-guides/{{page.version}}/glue-api/glue-api-cart-feature-integration.html) |
| Customer Account Management | 201907.0 | Login API |
| Glue API: Payments | 201907.0 | [Payments API feature integration](/docs/scos/dev/migration-and-integration/{{page.version}}/feature-integration-guides/glue-api/payments-api-feature-integration.html) |
|Shipments| 201907.0 | |
