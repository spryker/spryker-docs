...
`https://glue.mysprykershop.comm/customer-access`
    ...
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.mysprykershop.comm/customer-access"
            }
        }
    ],
    "links": {
...
* Make a request to: `https://glue.mysprykershop.comm/abstract-products/{% raw %}{{{% endraw %}abstract-sku{% raw %}}}{% endraw %}/abstract-product-prices`
