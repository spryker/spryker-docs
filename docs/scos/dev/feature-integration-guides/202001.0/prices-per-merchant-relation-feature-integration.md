...
originalLink: https://documentation.spryker.com/v4/docs/prices-per-merchant-relation-integration
originalArticleId: 758aa0ab-9b12-48dd-bd58-660cc246b7d6
redirect_from:
  - /v4/docs/prices-per-merchant-relation-integration
  - /v4/docs/en/prices-per-merchant-relation-integration
---
...
If you have not installed plugins needed for Merchant and Merchant Relationsб add them here as well. See _Merchant and Merchant Relations feature integration guide_ for more details.
{% endinfo_block %}
...
{% info_block infoBox %}
See  [Migration Guide - PriceProduct](/docs/pbc/all/price-management/{{site.version}}/base-shop/install-and-upgrade/upgrade-modules/upgrade-the-priceproduct-module.html
