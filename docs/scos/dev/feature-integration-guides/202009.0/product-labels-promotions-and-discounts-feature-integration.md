...
1. [Create a discount](/docs/scos/user/back-office-user-guides/{page.version}}/merchandising/discount/creating-a-cart-rule.html) and define its condition as a query string with a *product-label* field.
