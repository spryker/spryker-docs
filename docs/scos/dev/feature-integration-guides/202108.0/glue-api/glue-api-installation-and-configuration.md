...
```
After performing this change, you should be able to access `http://glue.de.project-name.local/` URL with a 404 error and JSON response indicating that the resource is not found.
