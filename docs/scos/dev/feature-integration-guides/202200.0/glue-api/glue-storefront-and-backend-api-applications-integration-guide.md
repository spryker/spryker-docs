...
| RequestCorsValidatorPlugin                            | Validates cors headers for Glue Storefront API application.                                                | Spryker\Glue\GlueStorefrontApiApplication\Plugin\GlueStorefrontApiApplication |
