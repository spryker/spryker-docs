...
|-------------------------|-------------------|---------------------------|
| Backend API                     | {{site.version}}  | [Backend API feature integration](/docs/scos/dev/feature-integration-guides/backend-api-feature-integration.html)                                          |
| Merchants and Merchant Relations | {{site.version}}  | [Merchants and Merchant Relations feature integration](/docs/scos/dev/feature-integration-guides/merchants-and-merchant-relations-feature-integration.html) |
