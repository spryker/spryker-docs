...
redirect_from:
  ...
  - /docs/scos/dev/feature-integration-guides/checkout-feature-integration.html
---
...
This integration guide expects the basic feature to be in place. It only adds the [Order Threshold](/docs/scos/user/features/checkout-feature-overview/order-thresholds-overview.html) functionality.
