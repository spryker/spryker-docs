...
redirect_from:
  ...
  - /docs/scos/dev/feature-integration-guides/glue-api/glue-api-customer-account-management-feature-integration.html
related:
...
1. [Add a customer address](/docs/scos/dev/glue-api-guides/managing-customers/managing-customer-addresses.html#add-an-address).
