...
| --- | --- | --- |
| Spryker Core | {{site.version}} | [Feature API](/docs/scos/dev/feature-integration-guides/spryker-core-feature-integration.html) |
| Return Management | {{site.version}} | [Return Management feature integration](https://archive.docs.spryker.com/docs/scos/dev/feature-integration-guides/202204.0/return-management-feature-integration.html) |
