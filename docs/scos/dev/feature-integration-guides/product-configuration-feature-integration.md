...
This document describes how to integrate the [Product Configuration](/docs/scos/user/features/configurable-product-feature-overview.html) feature into a Spryker project.
