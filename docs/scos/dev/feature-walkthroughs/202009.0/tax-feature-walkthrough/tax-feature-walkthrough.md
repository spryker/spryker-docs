...
|---|---|---|---|
|Tax migration guide | [Retrieving tax sets](/docs/pbc/all/tax-management/manage-taxes-via-glue-api/retrieve-tax-sets.html) | [File details: tax.csv](/docs/scos/dev/data-import/{{page.version}}/data-import-categories/commerce-setup/file-details-tax.csv.html) | |
