...
|  |  | [File details: warehouse_store.csv](/docs/scos/dev/data-import/{{page.version}}/data-import-categories/commerce-setup/file-details-warehouse-store.csv.html) | [HowTo - Overcome current limitations with the Multi-store functionality](/docs/scos/dev/tutorials-and-howtos/howtos/howto-overcome-current-limitations-with-the-multistore-functionality.html) |
