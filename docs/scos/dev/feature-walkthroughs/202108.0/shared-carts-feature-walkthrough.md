...
To learn more about the feature and to find out how end users use it, see [Shared Carts feature overview](/docs/scos/dev/features/{{page.version}}/shared-carts-feature-overview.html) for business users.
