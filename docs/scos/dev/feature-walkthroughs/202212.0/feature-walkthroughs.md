...
The [Tax](/docs/pbc/all/tax-management/{{page.version}}/tax-management.html) feature lets you define taxes for the items you sell. The feature is represented by two entities: tax rates and tax sets.
