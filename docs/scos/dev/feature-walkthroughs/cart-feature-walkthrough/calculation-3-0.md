...
Discount calculation is a separate topic and is explained in the [Discount](/docs/scos/user/features/promotions-discounts-feature-overview.html) article.
