...
<table cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            <p>During the <a href="/docs/scos/dev/feature-walkthroughs/reorder-feature-walkthrough.html">reorder</a> process, products that are restricted but exist in a previous order are automatically removed from the cart.</p>
         </td>
         <td>
