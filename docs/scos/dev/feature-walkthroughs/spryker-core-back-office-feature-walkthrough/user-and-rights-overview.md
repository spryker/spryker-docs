...
See [Managing users](/docs/scos/user/back-office-user-guides/users/managing-users/creating-users.html) to learn how to create and manage users, groups, and roles .
