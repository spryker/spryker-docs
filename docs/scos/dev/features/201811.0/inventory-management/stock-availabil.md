...
originalLink: https://documentation.spryker.com/v1/docs/stock-availability-management
redirect_from:
...
AvailabilityStorage publishes all availability information for abstract and concrete products. Items are grouped by abstract product. This process is handled by [Publish and Synchronize](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-publishing/publish-and-syn).
...
The Back Office is provided to allow assigning stocks to products. See [Availability](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/availability/managing-produc) for details on how to manage product stocks in the Back Office.
