...
- In the [Quick Order](/docs/scos/dev/features/201811.0/shopping-cart/quick-order/quick-order-201) form and [search widget](https://documentation.spryker.com/v1/docs/search-widget-for-concrete-products-201903), the products use the default measurement units that cannot be changed.
