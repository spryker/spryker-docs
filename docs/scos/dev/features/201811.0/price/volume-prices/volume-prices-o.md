...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/dev/features/201811.0/price/prices-per-merchant-relation/price-per-merch).
