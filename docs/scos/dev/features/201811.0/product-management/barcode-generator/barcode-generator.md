...
originalLink: https://documentation.spryker.com/v1/docs/barcode-generator
originalArticleId: 6b019a7d-87d5-4f17-b76c-74ac72d16d74
redirect_from:
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v1/docs/barcode-generator" class="mr-link">Familiarize yourself with the Barcode Generator feature</a></li>
                <li><a href="https://documentation.spryker.com/v1/docs/product-barcode" class="mr-link">Module Guide: ProductBarcode</a></li>
                <li><a href="https://documentation.spryker.com/v1/docs/product-barcode-gui" class="mr-link">Module Guide: ProductBarcodeGui</a></li>
                <li><a href="https://documentation.spryker.com/v1/docs/product-barcode-widget" class="mr-link">Module Guide: ProductBarcodeWidget</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/v1/docs/barcode-generator" class="mr-link">Familiarize yourself with the Barcode Generator feature</a></li>
                <li><a href="https://documentation.spryker.com/v1/docs/product-barcodes" class="mr-link">View product barcode details</a></li>
            </ul>
        </div>
    </div>
</div>
