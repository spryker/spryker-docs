    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v1/docs/cart-widget-overview" class="mr-link">Get a general idea of the Shopping Cart Widget feature</a></li>
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-red">
                ...
                <li><a href="https://documentation.spryker.com/v1/docs/creating-shopping-cart" class="mr-link">Create a shopping cart</a></li>
                <li><a href="https://documentation.spryker.com/v1/docs/shop-guide-managing-shopping-carts" class="mr-link">Manage a shopping cart</a></li>
                ...
                <li><a href="https://documentation.spryker.com/v1/docs/shop-guide-managing-shopping-carts#sharing-a-shopping-cart-via-link" class="mr-link">Share a Shopping Cart via Link</a></li>
            </ul>
        </div>
    </div>
</div>
