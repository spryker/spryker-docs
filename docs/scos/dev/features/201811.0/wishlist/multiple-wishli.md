...
Customers can create one or multiple wishlists with [different names](/docs/scos/dev/features/201811.0/wishlist/named-wishlists), add products to them and [transfer wishlists to carts](/docs/scos/dev/features/201811.0/wishlist/convert-wishlis) (either the entire list, or a specific item from the list)
