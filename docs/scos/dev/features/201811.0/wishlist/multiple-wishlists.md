...
originalLink: https://documentation.spryker.com/v1/docs/multiple-wishlists
originalArticleId: be3f7ad4-5d38-4497-bd91-5d5a3aa0f121
redirect_from:
...
Customers can create one or multiple wishlists with [different names](/docs/scos/dev/features/201811.0/wishlist/named-wishlists.html), add products to them and [transfer wishlists to carts](/docs/scos/dev/features/201811.0/wishlist/convert-wishlist-to-cart.html) (either the entire list, or a specific item from the list)
