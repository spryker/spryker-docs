...
Every [business unit](/docs/scos/dev/features/201903.0/company-account-management/business-unit-management/business-unit-m) includes some company users that have specific permissions within this business unit. Business on Behalf feature allows having multiple company users per customer account with a possibility to select one company user to be a default user. This default user can switch between the assigned business units.
