...
originalArticleId: f709b9ce-794e-4d46-8543-aae7a355a666
redirect_from:
...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/dev/features/201903.0/price/prices-per-merchant-relation/prices-per-merchant-relation-customer-specific-prices.html).
