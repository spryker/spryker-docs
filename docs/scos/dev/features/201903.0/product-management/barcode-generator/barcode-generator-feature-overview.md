...
{% info_block infoBox %}
You can read more about the product types we differentiate in [Product Abstraction](/docs/scos/dev/features/201903.0/product-management/product-abstraction.html
{% endinfo_block %}.)
