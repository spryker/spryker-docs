...
In this video we explain how to use [Shopping Carts](/docs/scos/dev/features/201903.0/shopping-cart/multiple-carts-per-user/multiple-cart-p) in the Spryker [B2B Demo Shop](https://documentation.spryker.com/v2/docs/demoshops#b2b-demo-shop).
