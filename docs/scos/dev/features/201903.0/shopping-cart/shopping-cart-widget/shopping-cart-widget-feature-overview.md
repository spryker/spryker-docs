...
* Access level to a shopping cart (see [Shared Cart Feature Overview](/docs/scos/dev/features/201903.0/shopping-cart/shared-cart/shared-cart-feature-overview.html) for more details)
* Price mode
* Cart Total
