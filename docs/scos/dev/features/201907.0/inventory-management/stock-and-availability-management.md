...
The Back Office is provided to allow assigning stocks to products. See [Availability](/docs/scos/user/user-guides/201907.0/back-office-user-guide/products/availability/managing-products-availability.html) for details on how to manage product stocks in the Back Office.
