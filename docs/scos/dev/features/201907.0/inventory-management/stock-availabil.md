...
The Back Office is provided to allow assigning stocks to products. See [Availability](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/products/availability/managing-produc) for details on how to manage product stocks in the Back Office.
