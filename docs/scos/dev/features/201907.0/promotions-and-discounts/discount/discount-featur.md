...
Voucher codes are generated in the Back Office > *Discount* section > *Edit discount* page > [Voucher codes](https://documentation.spryker.com/v4/docs/discount#voucher-codes-tab) tab. See [Creating a Discount Voucher](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/discount/creating-a-discount/creating-a-cart) for more information.
...
See [Creating a cart rule](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/discount/creating-a-discount/creating-a-cart) for information on how to create a cart rule discount in the Back Office.
