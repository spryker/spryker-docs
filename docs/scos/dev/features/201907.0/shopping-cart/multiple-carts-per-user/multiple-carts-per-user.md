...
In this video we explain how to use [Shopping Carts](/docs/scos/dev/features/201907.0/shopping-cart/multiple-carts-per-user/multiple-carts-per-user.html) in the Spryker [B2B Demo Shop](/docs/scos/user/intro-to-spryker/{{site.version}}/b2b-suite.html).
