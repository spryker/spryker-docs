...
The detailed information on managing shopping lists is covered in the [Shop User Guide](/docs/scos/user/user-guides/201907.0/shop-user-guide/shop-guide-shopping-lists.html).
...
* Product attribute
* Product options
* Product comments (see [Shopping List Notes](/docs/scos/dev/features/201907.0/shopping-list/shopping-list-notes/shopping-list-notes.html) for more details)
* Quantity
* Item price
* Availability
...
3. **Printing shopping list**: See [Printing Shopping list](/docs/scos/dev/features/201907.0/shopping-list/printing-a-shopping-list/printing-a-shopping-list.html) to learn how it works
...
3. **Printing shopping list**: See [Printing a Shopping List](/docs/scos/dev/features/201907.0/shopping-list/printing-a-shopping-list/printing-a-shopping-list.html) to learn how it works
