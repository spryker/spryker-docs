...
Learn to create and manage Users, Groups and Roles in the [Users Control](/docs/scos/user/user-guides/202001.0/back-office-user-guide/users-control/users-control.html) Manual.
