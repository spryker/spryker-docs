...
originalLink: https://documentation.spryker.com/v4/docs/splittable-order-items
originalArticleId: bf77a4ed-3234-4be6-8c75-0f7034665d1b
redirect_from:
  - /v4/docs/splittable-order-items
  - /v4/docs/en/splittable-order-items
---
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v4/docs/splittable-order-items-feature-overview" class="mr-link">Get a general idea of the Splittable Order Items feature</a></li>
