...
originalLink: https://documentation.spryker.com/v4/docs/volume-prices-overview
redirect_from:
...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/dev/features/202001.0/price/prices-per-merchant-relation/price-per-merch).
