...
## Current Constraints
Price Range Filter is not supported with the Merchant Relations, that is why this filter is not included in the B2B demo shop. However, in [the B2C demo shop](https://documentation.spryker.com/v4/docs/demoshops#b2b-demo-shop), you can still filter the products using the price range filter.
