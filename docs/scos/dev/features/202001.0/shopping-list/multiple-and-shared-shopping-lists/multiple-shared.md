...
* through a [shopping list widget](/docs/scos/dev/features/202001.0/shopping-list/shopping-list-widget/shopping-list-w) in the header of the shop
* from Shopping Lists page in My Account menu. See [Creating a shopping list](https://documentation.spryker.com/v4/docs/shopping-lists-shop-guide#create-shopping-list) for more detailed instruction.
...
The detailed information on managing shopping lists is covered in the [Shop User Guide](/docs/scos/dev/user-guides/202001.0/shop-user-guide/shopping-lists-).
...
* Product attribute
* Product options
* Product comments (see [Shopping List Notes](/docs/scos/dev/features/202001.0/shopping-list/shopping-list-notes/shopping-list-n) for more details)
* Quantity
* Item price
* Availability
...
3. **Printing shopping list**: See [Printing Shopping list](/docs/scos/dev/features/202001.0/shopping-list/printing-a-shopping-list/printing-shoppi) to learn how it works
...
1. Reading Shopping list: On the _Shopping List View_ page, the user sees the name of owner, access level (Full access), number of users the shopping list is shared with, as well as table of items with the following information:
   ...
   * Product attribute
   * Product options 
   * Product notes (see [Shopping List Notes](/docs/scos/dev/features/202001.0/shopping-list/shopping-list-notes/shopping-list-n) for more details)
   * Quantity
   * Item price
   * Availability
...
3. **Printing shopping list**: See [Printing a Shopping List](/docs/scos/dev/features/202001.0/shopping-list/printing-a-shopping-list/printing-shoppi) to learn how it works
