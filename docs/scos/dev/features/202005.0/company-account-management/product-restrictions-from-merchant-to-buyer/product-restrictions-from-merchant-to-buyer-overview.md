...
In terms of [Merchant concept](https://documentation.spryker.com/docs/en/merchants-and-merchant-relations-overview), the **merchant** is the one who sells products on a marketplace and can set prices.
...
Product Restrictions from Merchant to Buyer give merchants [another layer](https://documentation.spryker.com/docs/en/hide-content-from-logged-out-users) of control over the information, a customer can see in the shop application. Based on product restrictions, you can:
...
To create product lists, follow the [guideline for the Back Office](https://documentation.spryker.com/docs/en/creating-a-product-list).

You can check more cases of product restrictions workflow on the [Restricted Products Behavior](https://documentation.spryker.com/docs/en/restricted-products-behavior) page.
