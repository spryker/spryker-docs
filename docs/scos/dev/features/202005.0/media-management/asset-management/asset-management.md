    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/asset-management-feature-overview" class="mr-link">Get a general idea of the Asset Management feature</a></li>
            </ul>
        </div>
      <!-- col2 -->
        <div class="mr-col">
