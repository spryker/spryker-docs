...
originalLink: https://documentation.spryker.com/v5/docs/packaging-units
originalArticleId: 5e376584-8e3c-4691-b637-e6b7886f6c5d
redirect_from:
  - /v5/docs/packaging-units
  - /v5/docs/en/packaging-units
---
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/packaging-units-overview" class="mr-link">Get a general idea of the Packaging Units feature</a></li>
                                 <li><a href="https://documentation.spryker.com/docs/en/howto-import-packaging-units" class="mr-link">Import Packaging Units information into the system</a></li>
                   <li><a href="https://documentation.spryker.com/docs/en/product-packaging-unit-feature-integration" class="mr-link">Integrate the Packaging Units feature v.202001.0 into your project</a></li>
                 <li><a href="https://documentation.spryker.com/docs/en/decimal-stock-concept" class="mr-link">Integrate Decimal Stock into your project</a></li> 
                <li><a href="https://documentation.spryker.com/docs/en/ht-integrate-and-use-precise-decimal-numbers" class="mr-link">HowTo - Integrate and Use Precise Decimal Numbers</a></li>
                            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/packaging-units-overview" class="mr-link">Get a general idea of the Packaging Units feature</a></li>
                           <li><a href="https://documentation.spryker.com/docs/en/packaging-units-overview#current-constraints" class="mr-link">Learn about the current constraints for the Back Office</a></li>
                <li><a href="https://documentation.spryker.com/docs/en/howto-import-packaging-units" class="mr-link">Import Packaging Unit Types</a></li>
            </ul>
        </div>
    </div>
</div>
