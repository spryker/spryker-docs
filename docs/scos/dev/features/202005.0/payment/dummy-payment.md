...
originalArticleId: e9c80407-de06-43dd-b25c-da6faf235820
redirect_from:
...
* how to add a state machine, commands and conditions to the [Oms module](/docs/scos/dev/features/202005.0/order-management/oms-order-management-system-matrix.html)
* how to add CheckoutPlugins to the Payment module
* how to handle refunds with the [Refund module](https://documentation.spryker.com/v5/docs/en/refund)
