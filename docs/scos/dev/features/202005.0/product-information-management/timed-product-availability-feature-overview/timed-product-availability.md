...
originalLink: https://documentation.spryker.com/v5/docs/product-ttl
originalArticleId: c66b8dc5-71d5-4fd6-84ee-4f448cfca89a
redirect_from:
  - /v5/docs/product-ttl
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/product-ttl" class="mr-link">Familiarize yourself with the Timed Product Availability feature and its usage scenarios</a></li>
                <li><a href="https://documentation.spryker.com/docs/en/mg-product-validity" class="mr-link">Install the Product Validity module for Timed Product Availability</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/product-ttl" class="mr-link">Familiarize yourself with the Timed Product Availability feature and its usage scenarios</a></li>
                <li><a href="https://documentation.spryker.com/docs/en/creating-a-product-variant" class="mr-link">Manage concrete product validity dates</a></li>
            </ul>
        </div>
    </div>
</div>
