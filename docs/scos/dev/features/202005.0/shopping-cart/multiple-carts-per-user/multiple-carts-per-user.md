...
In this video we explain how to use [Shopping Carts](https://documentation.spryker.com/v5/docs/en/multiple-cart-per-user) in the Spryker [B2B Demo Shop](https://documentation.spryker.com/v5/docs/en/b2b-suite).
