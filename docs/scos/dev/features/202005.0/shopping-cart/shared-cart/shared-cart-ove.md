...
## Current Constraints
With the current functionality, the shopping cart cannot be shared outside of a [Business Unit](https://documentation.spryker.com/docs/en/business-unit-management-feature-overview) where the owner belongs.
