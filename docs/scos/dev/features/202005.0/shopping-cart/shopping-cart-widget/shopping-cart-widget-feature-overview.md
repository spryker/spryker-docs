...
originalLink: https://documentation.spryker.com/v5/docs/cart-widget-overview
originalArticleId: 6a28b061-03b6-49de-b9d2-16442e5685ad
redirect_from:
  - /v5/docs/cart-widget-overview
  - /v5/docs/en/cart-widget-overview
---
...
* Access level to a shopping cart (see [Shared Cart Feature Overview](/docs/scos/dev/features/202005.0/shopping-cart/shared-cart/shared-cart-feature-overview.html) for more details)
* Price mode
* Cart Total
