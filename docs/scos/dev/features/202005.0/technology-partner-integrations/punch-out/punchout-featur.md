...
3. Authentication is handled with the help of the [Customer login by token](https://documentation.spryker.com/docs/en/customer-login-by-token-201907) feature. So, the buyer doesn't need to enter any login details to get to the customer account. The [Vault for Tokens](https://documentation.spryker.com/docs/en/vault-for-tokens-201907) feature allows securely keeping the sensitive data (username and password) and retrieving it on request.
