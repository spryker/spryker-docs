    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/file-details-sales-order-thresholdcsv">Import thresholds</a></li>
                <li>Enable Order Thresholds:</li>
                <li><a href="https://documentation.spryker.com/docs/checkout-feature-integration">Integrating the Checkout feature</a></li>
                <li><a href="https://documentation.spryker.com/docs/merchant-feature-integration">Integrate the Merchant feature</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/docs/managing-merchant-order-thresholds" class="mr-link">Manage merchant order thresholds</a></li>
                <li><a href="https://documentation.spryker.com/docs/managing-threshold-settings" class="mr-link">Manage threshold settings</a></li>
            </ul>
        </div>
    </div>
</div>
