...
|---|
| [Get a general idea of the Splittable Order Items feature](/docs/scos/dev/features/{{page.version}}/order-management/order-management-feature-overview/splittable-order-items-overview.html)  |
