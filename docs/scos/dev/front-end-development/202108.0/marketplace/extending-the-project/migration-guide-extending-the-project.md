...
This document outlines the changes that need to be made at a project level in order to [extend the frontend part of your project](/docs/scos/dev/front-end-development/{{page.version}}/marketplace/extending-the-project/index.html).
