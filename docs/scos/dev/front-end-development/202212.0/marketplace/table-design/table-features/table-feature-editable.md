...
- `columns`—only required properties are listed; the entire interface can be found in [Table Design](/docs/scos/dev/front-end-development/{{page.version}}/marketplace/table-design/#interfaces) document:  
    - `id`—a cell `id`.  
    - `type`—a cell `type`.  
    - `typeOptions`–to learn more about the column types available, see [Column Type](/docs/scos/dev/front-end-development/{{page.version}}/marketplace/table-design/table-column-types/):  
