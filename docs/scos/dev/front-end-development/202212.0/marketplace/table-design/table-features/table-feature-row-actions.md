...
- `actions`—an array with actions that are displayed in the drop down menu and their type of registered [action](/docs/scos/dev/front-end-development/{{page.version}}/marketplace/on}}/marketplace/on}}/marketplace/on}}/marketplace/ui-components-library/actions/).  
