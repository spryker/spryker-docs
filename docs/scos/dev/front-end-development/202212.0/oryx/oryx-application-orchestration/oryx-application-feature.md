...
- Providers
- [Plugins](/docs/scos/dev/front-end-development/{{page.version}}/oryx/app-plugins.md)
<!-- TODO: Link to resources -->
- Resources
- [Feature options](#feature-options)
- [Builder options](/docs/scos/dev/front-end-development/{{page.version}}/oryx/index.md#options)
