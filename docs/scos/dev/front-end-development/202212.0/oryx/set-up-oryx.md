...
For more information about the boilerplate project, see the [boilerplate guide](/docs/scos/dev/front-end-development/{{page.version}}/oryx/oryx-boilerplate.md).
...
Oryx [packages](/docs/scos/dev/front-end-development/{{page.version}}/oryx/packages.md) are distributed on [npmjs.com](https://www.npmjs.com/org/spryker-oryx).
