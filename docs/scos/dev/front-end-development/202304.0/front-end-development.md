...
This section contains overviews and instructions for the frontend development on the Spryker Commerce OS. It includes the following components and topics:
...
* [Migration guide – Switch from Yarn to npm v9](/docs/scos/dev/front-end-development/{{page.version}}/migration-guide-switch-from-yarn-to-npm.html)
