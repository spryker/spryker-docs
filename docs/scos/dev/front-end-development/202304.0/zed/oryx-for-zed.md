...
`Oryx-for-zed` is a small utility for the Zed build system and should not be confused with the frontend framework [Oryx](/docs/scos/dev/front-end-development/{{page.version}}/oryx/oryx.html) that can be used to create composable front-end applications on Spryker.
