...
Compositions in Oryx are a tool for organizing components and defining their [layout](/docs/scos/dev/front-end-development/{{page.version}}/oryx/building-pages/oryx-layout.html). It removes page-specific layout concerns from the component implementation, which makes the components less opinionated and more reusable.
