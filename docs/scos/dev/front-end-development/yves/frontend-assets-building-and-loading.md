...
To create a frontend build in different ES5 and ES6 modes, use the list of commands from [Frontend-related commands](/docs/scos/dev/back-end-development/console-commands/{{site.version}}/console-commands.html#frontend-related-commands). See the YVES section.
