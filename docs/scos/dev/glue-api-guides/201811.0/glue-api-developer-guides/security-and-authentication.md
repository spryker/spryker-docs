...
originalArticleId: 90e8843b-0ce2-48a1-b952-990827eff3d2
redirect_from:
  - /v1/docs/security-and-authentication
  - /v1/docs/en/security-and-authentication
---
...
{% info_block infoBox %}
For details, see [Resource Routing](/docs/scos/dev/glue-api/201811.0/glue-api-developer-guides/glue-infrastructure.html#resource-routing
{% endinfo_block %}.)
