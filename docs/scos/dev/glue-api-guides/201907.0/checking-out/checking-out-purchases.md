...
| payments | RestPayment | x | Payment options, such as the payment system, method of payment, etc.</br>For details, see [Payment Step](/docs/scos/user/features/{{page.version}}/checkout/multi-step-checkout/checkout-steps.html#payment-step){target="_blank"}. |
| shipment | RestShipmentTransfer | x | Shipment details.</br>For details, see [Shipment Step](/docs/scos/user/features/{{page.version}}/checkout/multi-step-checkout/checkout-steps.html#shipment-step){target="_blank"}. |
...
| payments | RestPayment | v | Payment options, such as the payment system, method of payment, etc.</br>For details, see [Payment Step](/docs/scos/user/features/{{page.version}}/checkout/multi-step-checkout/checkout-steps.html#payment-step){target="_blank"}. |
| shipment | RestShipmentTransfer | v | Shipment details.</br>For details, see [Shipment Step](/docs/scos/user/features/{{page.version}}/checkout/multi-step-checkout/checkout-steps.html#shipment-step){target="_blank"}. |
