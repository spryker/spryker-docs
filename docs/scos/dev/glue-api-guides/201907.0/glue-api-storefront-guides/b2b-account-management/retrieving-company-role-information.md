...
In corporate environments, where users act as company representatives rather than private buyers, companies can leverage [Company Roles](/docs/scos/dev/features/201907.0/company-account-management/company-user-roles-and-permissions/company-user-roles-and-permissions-feature-overview.html) in order to distribute scopes and permissions among [Company Users](/docs/scos/dev/features/201907.0/company-account-management/company-account-overview/company-account-overview.html). To identify which roles company users are assigned to, you can use the endpoints provided by the **Company Role API**.
...
[/company-roles/mine](/docs/scos/dev/glue-api/201907.0/rest-api-reference.html#//company-roles)
...
[/company-roles/{% raw %}{{{% endraw %}role_id{% raw %}}}{% endraw %}](/docs/scos/dev/glue-api/201907.0/rest-api-reference.html#//company-roles){target="_blank"}
