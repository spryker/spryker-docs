...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Carts API](/docs/scos/dev/migration-and-integration/202001.0/feature-integration-guides/glue-api/glue-api-cart-feature-integration.html).
...
The the *X-Anonymous-Customer-Unique-Id* header is passed every time the API client creates or updates a guest cart. The header is managed by the client exclusively. For details, see section [Resources for Accessing Guest Carts](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-carts/managing-guest-carts.html#resources-for-accessing-guest-carts
{% endinfo_block %}.)

Upon login, the behavior depends on whether your project is a single cart or [multiple cart](/docs/scos/dev/features/202001.0/shopping-cart/multiple-carts-per-user/multiple-carts-per-user.html) environment:
