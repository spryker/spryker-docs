...
Sample request: *GET https://glue.mysprykershop.comm/company-business-units/mine*
    ...
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.mysprykershop.comm/company-business-units/5a6032dc-fbce-5d0d-9d57-11ade1947bac"
            }
        }
    ],
    "links": {
        "self": "https://glue.mysprykershop.comm/company-business-units/mine"
    }
}
```
...
Sample request: *GET https://glue.mysprykershop.comm/company-business-units/**b8a06475-73f5-575a-b1e9-1954de7a49ef***
...
```json
{
    "data": {
        ...
        "links": {
            "self": "https://glue.mysprykershop.comm/company-business-units/b8a06475-73f5-575a-b1e9-1954de7a49ef"
        }
    }
}
```
...
Sample request to include companies: *GET https://glue.mysprykershop.comm/company-business-units/32b44d30-3c2d-5f0a-91d3-e66adad10dc1?include=companies*
    ...
    "included": [
        {
            ...
            "links": {
                "self": "https://glue.mysprykershop.comm/companies/0818f408-cc84-575d-ad54-92118a0e4273"
            }
        }
    ]
}
...
Sample request to include Business Unit addresses: *GET https://glue.mysprykershop.comm/company-business-units/32b44d30-3c2d-5f0a-91d3-e66adad10dc1?include=company-business-unit-addresses*
    ...
    "included": [
        {
            ...
            "links": {
                "self": "https://glue.mysprykershop.comm/company-business-unit-addresses/19a55c0d-7bf0-580c-a9e8-6edacdc1ecde"
            }
        }
    ]
}
...
Sample request: *GET https://glue.mysprykershop.comm/company-business-unit-addresses/**eec036ee-b999-5753-a7dd-8d0710a2312f***
...
```json
{
    "data": {
        ...
        "links": {
            "self": "https://glue.mysprykershop.comm/company-business-unit-addresses/eec036ee-b999-5753-a7dd-8d0710a2312f"
        }
    }
}
```
