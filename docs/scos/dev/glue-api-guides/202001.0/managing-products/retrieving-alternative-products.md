...
{% info_block infoBox %}
For more details, see [Alternative Products](/docs/scos/user/features/{{page.version}}/product-information-management/alternative-products/alternative-products.html
