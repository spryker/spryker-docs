...
[/company-business-units/mine](https://documentation.spryker.com/docs/en/rest-api-reference#/company-business-units)
...
[/company-business-units/{% raw %}{{{% endraw %}business_unit_id{% raw %}}}{% endraw %}](https://documentation.spryker.com/docs/en/rest-api-reference#/company-business-units)
...
[/company-business-unit-addresses/{% raw %}{{{% endraw %}address_id{% raw %}}}{% endraw %}](https://documentation.spryker.com/docs/en/rest-api-reference#/company-business-unit-addresses)
