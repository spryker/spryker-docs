...
Shopping lists are available in B2B scenarios only. This means that access to them is provided upon proper authentication as a **Company User**. For more details, see [Logging In as Company User](/docs/scos/dev/glue-api-guides/202005.0/b2b-account-management/logging-in-as-company-user.html).
...
| Status code | Reason |
| --- | --- |
| 400 | The provided access token is not an [access token of a Company User](/docs/scos/dev/glue-api-guides/202005.0/b2b-account-management/logging-in-as-company-user.html). </br>**OR** </br> The shopping list ID is not specified. |
