...
See [Retrieving Product Information](/docs/scos/dev/glue-api-guides/{{page.version}}/managing-products/retrieving-product-information.html) to learn more about the `/abstract-products` resource.
...
*To identify the node ID of a category,  [get full category tree](/docs/scos/dev/glue-api-guides/{{page.version}}//retrieving-categories/retrieving-category-trees.html#get-full-category-tree). The ID is located in the `nodeId` field.
