...
To configure the lifetime of refresh tokens, [extend](/docs/scos/dev/developer-guides/202009.0/back-end-development/extending-spryker/extending-the-spryker-core-functionality.html) the `Spryker\Shared\Oauth\OauthConfig` class on a project level.
