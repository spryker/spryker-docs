...
originalLink: https://documentation.spryker.com/v6/docs/retrieving-related-products
originalArticleId: 8cbe58e5-4b40-43c7-aa1f-bf32ff14f2cd
redirect_from:
  - /v6/docs/retrieving-related-products
...
Only [abstract](https://documentation.spryker.com/v6/docs/products-overview) products support product relations. For more details, see [Product Relations feature overview](/docs/scos/user/features/{{page.version}}/product-relations-feature-overview.html).)
...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue API: Product Relations feature integration](/docs/scos/dev/migration-and-integration/202009.0/feature-integration-guides/glue-api/glue-api-product-relations-feature-integration.html).
