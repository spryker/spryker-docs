...
originalLink: https://documentation.spryker.com/v6/docs/managing-wishlists
originalArticleId: 8504b9f4-b3b6-48ea-b3a7-0bc03023c080
redirect_from:
  - /v6/docs/managing-wishlists
  - /v6/docs/en/managing-wishlists
---

The Wishlists API allows creating list and deleting [wishlists](/docs/scos/dev/features/202009.0/wishlist/wishlist.html), as well as managing the items inside them. 

## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see 
* [Glue API: Wishlist feature integration](/docs/scos/dev/migration-and-integration/202009.0/feature-integration-guides/glue-api/glue-api-wishlist-feature-integration.html)
