...
* [Retrieve an abstract product](https://documentation.spryker.com/2021080/docs/retrieving-abstract-products#abstract-products-response-attributes)
...
| --- | --- |
| ***cart_uuid*** | A unique identifier of a cart. [Create a cart](https://documentation.spryker.com/docs/managing-items-in-carts-of-registered-users#create-a-cart) or [Retrieve a registered user's carts](https://documentation.spryker.com/docs/managing-items-in-carts-of-registered-users#retrieve-a-registered-users-carts) to get it. |
...
| templateUuid | String | &check; | Unique identifier of the configurable bundle template. To get it, [retrieve all configurable bundle templates](https://documentation.spryker.com/2021080/docs/retrieving-configurable-bundle-templates#retrieve-all-configurable-bundle-templates). |
...
For the attributes of the response sample, see [Add an item a to a registered user's cart](https://documentation.spryker.com/2021080/docs/managing-items-in-carts-of-registered-users#add-an-item-to-a-registered-user-s-cart).
...
| PATH PARAMETER | DESCRIPTION |
| --- | --- |
| ***{% raw %}{{{% endraw %}cart_uuid{% raw %}}}{% endraw %}*** | A unique identifier of a cart.[ Create a cart](https://documentation.spryker.com/docs/managing-items-in-carts-of-registered-users#create-a-cart) or [Retrieve a registered user's carts](https://documentation.spryker.com/docs/managing-items-in-carts-of-registered-users#retrieve-a-registered-users-carts) to get it. |
