...
1. Create a resource using the steps described in the [How to create a resource](/docs/scos/dev/glue-api-guides/{{page.version}}/decoupled-glue-infrastructure/how-to-guides/how-to-create-a-resource.html) guide.
