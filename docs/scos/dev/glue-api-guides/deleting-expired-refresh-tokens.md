...
After an authentication refresh token is [revoked](/docs/scos/dev/glue-api-guides/authentication-and-authorization.html) or expires, it remains in the database.
