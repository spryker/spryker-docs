...
redirect_from:
  ...
  - /docs/scos/dev/glue-api-guides/managing-customers/managing-customer-authentication-tokens-via-oauth-2.0.html
---
...
For detailed information on the modules that provide the API functionality and related installation instructions, see [GLUE: Customer Account Management feature integration](/docs/scos/dev/feature-integration-guides/glue-api/glue-api-customer-account-management-feature-integration.html).
...
| password | String | &check; | Customer's password. You define it when [creating a customer](/docs/scos/dev/glue-api-guides/managing-customers/managing-customers.html#create-a-customer). |
