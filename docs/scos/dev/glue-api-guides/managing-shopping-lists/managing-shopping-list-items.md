...
redirect_from:
  ...
  - /docs/scos/dev/glue-api-guides/managing-shopping-lists/managing-shopping-list-items.html
related:
...
| 400 | Provided access token is not an [access token of a company user](/docs/scos/dev/glue-api-guides/managing-b2b-account/authenticating-as-a-company-user.html). |
