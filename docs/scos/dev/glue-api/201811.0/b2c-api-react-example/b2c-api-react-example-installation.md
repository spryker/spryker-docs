...
1. Make sure that you have Spryker Glue REST API [installed and working](/docs/scos/dev/migration-and-integration/201811.0/feature-integration-guides/glue-api/glue-api-installation-and-configuration.html).
