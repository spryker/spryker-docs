...
{% info_block infoBox %}
For more information on managing the category tree, see [Category Hierarchy](/docs/scos/dev/features/201811.0/catalog-management/define-category-hierarchy.html
{% endinfo_block %}.)
