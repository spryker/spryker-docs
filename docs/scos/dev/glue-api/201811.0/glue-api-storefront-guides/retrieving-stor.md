...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue Application Feature Integration](https://documentation.spryker.com/v1/docs/glue-application-feature-integration-201907).
