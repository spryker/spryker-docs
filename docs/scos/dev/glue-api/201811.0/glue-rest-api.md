...
{% info_block infoBox %}
For more details, see [Glue Infrastructure](/docs/scos/dev/glue-api/201811.0/glue-api-developer-guides/glue-infrastruc
{% endinfo_block %}.)
...
{% info_block infoBox %}
For more details, see [REST API Reference](/docs/scos/dev/glue-api/201811.0/rest-api-refere
{% endinfo_block %}.)
...
{% info_block infoBox %}
[Install and run!](/docs/scos/dev/glue-api/201811.0/b2c-api-react-example/b2c-api-react-e
{% endinfo_block %})
