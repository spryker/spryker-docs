---
title: Glue REST API
originalLink: https://documentation.spryker.com/v1/docs/glue-rest-api
originalArticleId: a8460b19-b0d7-4142-9ed4-017a68eb47ab
redirect_from:
  - /v1/docs/glue-rest-api
...
{% info_block infoBox %}
For more details, see [Glue Infrastructure](/docs/scos/dev/glue-api/201811.0/glue-api-developer-guides/glue-infrastructure.html
{% endinfo_block %}.)
...
{% info_block infoBox %}
For more details, see [REST API Reference](/docs/scos/dev/glue-api/201811.0/rest-api-reference.html
{% endinfo_block %}.)
...
{% info_block infoBox %}
[Install and run!](/docs/scos/dev/glue-api/201811.0/b2c-api-react-example/b2c-api-react-example.html
{% endinfo_block %})
