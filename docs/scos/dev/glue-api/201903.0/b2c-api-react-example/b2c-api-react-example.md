...
| --- | --- |
| Search API | [Catalog Search](/docs/scos/dev/glue-api/201903.0/glue-api-storefront-guides/catalog-search.html)<br>[Getting Suggestions for Auto-Completion and Search](https://documentation.spryker.com/v2/docs/retrieving-suggestions-for-auto-completion-and-search) |
