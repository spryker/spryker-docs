...
{% endinfo_block %} products support Product Relations. For more details, see [Product Relations](/docs/scos/dev/features/201903.0/product-management/product-relations/product-relatio).)
...
{% info_block infoBox %}
To be able to use **Product Relations API**, first, you need to have the Product Relations feature integrated with your project. For details, see [Product Relation Integration](/docs/scos/dev/migration-and-integration/201903.0/feature-integration-guides/product-relatio
{% endinfo_block %}.)
...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Product Relations API Feature Integration](/docs/scos/dev/migration-and-integration/201903.0/feature-integration-guides/glue-api/product-relatio).
...
{% info_block infoBox %}
For details on how to retrieve and manage the identifier, see [Managing Guest Carts](/docs/scos/dev/glue-api/201903.0/glue-api-storefront-guides/managing-carts/managing-guest-
{% endinfo_block %}.)
