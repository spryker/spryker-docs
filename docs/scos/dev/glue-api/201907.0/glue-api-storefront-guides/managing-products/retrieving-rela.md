...
{% endinfo_block %} products support Product Relations. For more details, see [Product Relations](/docs/scos/dev/features/201907.0/product-management/product-relations/product-relatio).)
...
{% info_block infoBox %}
For details on peculiarities of managing carts of registered users, see [Managing Carts of Registered Users](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-carts/managing-carts-
{% endinfo_block %}.)
...
{% info_block infoBox %}
For details on how to retrieve and manage the identifier, see [Managing Guest Carts](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-carts/managing-guest-
{% endinfo_block %}.)
