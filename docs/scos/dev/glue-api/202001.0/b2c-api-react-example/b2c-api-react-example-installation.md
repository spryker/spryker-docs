...
originalLink: https://documentation.spryker.com/v4/docs/b2c-api-react-example-installation
originalArticleId: 7417db09-ca62-4a7e-b3b0-290471a8791f
redirect_from:
  - /v4/docs/b2c-api-react-example-installation
  - /v4/docs/en/b2c-api-react-example-installation
---

B2C API React Example can be installed inside [Spryker Development Virtual Machine](/docs/scos/dev/features/202001.0/sdk/development-virtual-machine-docker-containers-and-console.html) (VM) or on a separate dedicated server. Below, you will find detailed steps on how to perform both the installation scenarios.
...
1. Make sure that you have Spryker Glue REST API [installed and working](/docs/scos/dev/migration-and-integration/202001.0/feature-integration-guides/glue-api/glue-api-installation-and-configuration.html).
