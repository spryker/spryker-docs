...
## Installation
To enable the API functionality, you need to install version **201911** of Spryker Glue API. For detailed information and installation instructions, see [GLUE: Spryker Core Feature Integration](https://documentation.spryker.com/v4/docs/glue-spryker-core-feature-integration).
