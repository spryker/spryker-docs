...
originalLink: https://documentation.spryker.com/v1/docs/mg-product-option-cart-connector
originalArticleId: 2bc4065c-8443-4bd8-a716-f884a2a677a8
redirect_from:
...
1. Update `spryker/product-option` to at least version 6.0.0. See [Migration Guide - Product Option](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-product-option.html).
