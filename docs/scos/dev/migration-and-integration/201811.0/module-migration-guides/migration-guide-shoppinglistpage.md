...
1. Upgrade the CompanyUser module to version 2.0.0. See [Migration Guide - CompanyUser](https://documentation.spryker.com/v1/docs/mg-companyuser#upgrading-from-version-1-0-0-to-version-2-0-0)  for more details:
