...
2. Create validation configuration:
    ...
    b. In the file, describe validation rules for endpoints. See see [Validating REST Request Format](/docs/scos/dev/tutorials/201903.0/introduction/glue-api/validating-rest-request-format.html) for more details. Example:
