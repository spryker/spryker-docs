...
2. Update/install `spryker/touch` to at least `4.0.0` version. For more information, see [Migration Guide - Touch](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-touch).
