...
**Currency >= 3.2.*** - see [Migration Guide - Currency](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-currency) for more details.
...
**Sales >= 8.*** - see [Migration Guide - Sales](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-sales) for more details.
...
**Shipment >= 6.*** - see [Migration Guide - Shipment](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-shipment).
...
**Price >= 5.*** - see [Migration Guide - Price](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-price).
**PriceProduct** - new module handling price product prices. Migration is a part of [Migration Guide - Price](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-price).
**PriceCartConnector >= 4.*** -  [Migration Guide - PriceCartConnector](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-price-cart-c) uses the new PriceProduct module.
**PriceDataFeed >= 0.2.*** - uses the new `PriceProduct` module.
**ProductBundle >= 4.*** - [Migration Guide - ProductBundle](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-bund) uses the new `PriceProduct` module, the new plugin to watch cart item reload action.
**ProductLabelGui >= 2.*** - see [Migration Guide - ProductLabelGui](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-labe).
**ProductManagement >= 0.9.*** - see [Migration Guide - ProductManagement](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-mana). New forms and views have been added.
**ProductRelation >= 2.*** - see [Migration Guide - ProductRelation](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-rela).
**ProductRelationCollector >= 2.*** - see [Migration Guide - ProductRelationCollector](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-rela).
**ProductSetGui >= 2.*** - see [Migration Guide - ProductSetGui](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-set-).
**Wishlist >= 2.*** - see [Migration Guide - Wishlist](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-wishlist).
**Search >= 7.0** - see [Migration Guide - Search](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-search).
...
**ProductOptionCartConnector >= 5.*** - see [Migration Guide - Product Option Cart Connector](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-opti).
**ProductOption >= 6.*** - see [Migration Guide - Product Option](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/mg-product-opti).
