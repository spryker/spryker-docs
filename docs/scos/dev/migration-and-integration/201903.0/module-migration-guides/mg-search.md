...
See the Search documentation for a detailed [example](/docs/scos/dev/features/201903.0/search-and-filter/search-widget-for-concrete-products/configure-searc).
