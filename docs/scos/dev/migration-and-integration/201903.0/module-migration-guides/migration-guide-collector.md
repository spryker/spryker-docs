...
originalLink: https://documentation.spryker.com/v2/docs/mg-collector
originalArticleId: c680a0c5-2257-4f45-81ce-8ceeb41b3a4b
redirect_from:
...
2. Update/install `spryker/touch` to at least `4.0.0` version. For more information, see [Migration Guide - Touch](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-touch.html).
