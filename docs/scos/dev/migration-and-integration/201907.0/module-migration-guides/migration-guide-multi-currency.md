...
originalArticleId: 84634aa8-8c77-455f-b8cf-c2a523659bb8
redirect_from:
...
**Currency >= 3.2.*** - see [Migration Guide - Currency](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-currency.html) for more details.
...
**Sales >= 8.*** - see [Migration Guide - Sales](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-sales.html) for more details.
...
**CartCurrencyConnector** - new module provides plugin for cart rebuilding. See [Currency configuration](https://documentation.spryker.com/v3/docs/currency) for more details.
...
**Shipment >= 6.*** - see [Migration Guide - Shipment](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-shipment.html).
...
**Price >= 5.*** - see [Migration Guide - Price](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-price.html).
**PriceProduct** - new module handling price product prices. Migration is a part of [Migration Guide - Price](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-price.html).
**PriceCartConnector >= 4.*** -  [Migration Guide - PriceCartConnector](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-price.html-cart-connector) uses the new PriceProduct module.
**PriceDataFeed >= 0.2.*** - uses the new `PriceProduct` module.
**ProductBundle >= 4.*** - [Migration Guide - ProductBundle](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-bundle.html) uses the new `PriceProduct` module, the new plugin to watch cart item reload action.
**ProductLabelGui >= 2.*** - see [Migration Guide - ProductLabelGui](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-label-gui.html).
**ProductManagement >= 0.9.*** - see [Migration Guide - ProductManagement](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-productmanagement.html). New forms and views have been added.
**ProductRelation >= 2.*** - see [Migration Guide - ProductRelation](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-relation.html).
**ProductRelationCollector >= 2.*** - see [Migration Guide - ProductRelationCollector](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-relation.html-collector).
**ProductSetGui >= 2.*** - see [Migration Guide - ProductSetGui](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-set-gui.html).
**Wishlist >= 2.*** - see [Migration Guide - Wishlist](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-wishlist.html).
**Search >= 7.0** - see [Migration Guide - Search](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-search.html).
...
**ProductOptionCartConnector >= 5.*** - see [Migration Guide - Product Option Cart Connector](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-option-cart-connector.html).
**ProductOption >= 6.*** - see [Migration Guide - Product Option](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-option.html).
