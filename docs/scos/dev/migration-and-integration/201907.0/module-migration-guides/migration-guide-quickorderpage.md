...
originalLink: https://documentation.spryker.com/v3/docs/mg-quick-order-page
originalArticleId: 555723e9-3682-42f0-9b54-33194858caec
redirect_from:
...
1. This feature requires `ProductPageSearch` 3.x.x.
    ...
    * Follow the steps from  [Migration guide - ProductPageSearch](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-productpagesearch.html).
