...
| --- | --- | --- |
| Spryker Core | 202001.0 | [Glue Application Feature Integration](/docs/scos/dev/migration-and-integration/202001.0/feature-integration-guides/glue-api/glue-api-glue-a) |
...
2. Create validation configuration:
    ...
    b. In the file, describe validation rules for endpoints. See see [Validating REST Request Format](/docs/scos/dev/tutorials/202001.0/introduction/glue-api/validating-rest) for more details. Example:
