...
redirect_from:
  - /v4/docs/shipment-feature-integration
  - /v4/docs/en/shipment-feature-integration
---
...
```bash
composer require spryker-feature/shipment:"^202001.0" --update-with-dependencies
```
