...
originalLink: https://documentation.spryker.com/v4/docs/migration-guide-form
originalArticleId: 6a788a7b-13bd-42e7-b267-d1825c3f5b65
redirect_from:
  - /v4/docs/migration-guide-form
  - /v4/docs/en/migration-guide-form
---
...
For information on how to eliminate Silex Validator, see  [Migration Guide - Validator](/docs/scos/dev/migration-and-integration/202001.0/migration-concepts/silex-replacement/silex-migration-guides/migration-guide-validator.html).
