...
1. Upgrade the **ContentBanner** module to version 2.0.0. See [Migration Guide - ContentBanner](/docs/scos/dev/migration-and-integration/202001.0/module-migration-guides/mg-contentbanne) for  details on how to upgrade.
