...
originalLink: https://documentation.spryker.com/v4/docs/mg-search
redirect_from:
  - /v4/docs/mg-search
...
<!-- See the Search documentation for a detailed [example](/docs/scos/dev/features/202001.0/search-and-filter/search-widget-for-concrete-products/configure-searc).-->
