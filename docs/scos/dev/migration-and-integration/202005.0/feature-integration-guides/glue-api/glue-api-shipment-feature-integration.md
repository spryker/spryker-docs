...
| --- | --- |--- |
| Spryker Core	 | master |[Spryker Core API](/docs/scos/dev/migration-and-integration/202005.0/feature-integration-guides/glue-api/glue-api-spryker-core-feature-integration.html) |
| Shipments	 | master | |
...
| Feature | Link |
| --- | --- |
| Checkout API | [Glue API: Checkout Feature Integration](/docs/scos/dev/migration-and-integration/202005.0/feature-integration-guides/glue-api/glue-api-checkout-feature-integration.html) |
