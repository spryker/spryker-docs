...
**Currency >= 3.2.*** - see [Migration Guide - Currency](https://documentation.spryker.com/docs/en/mg-currency) for more details.
...
**Sales >= 8.*** - see [Migration Guide - Sales](https://documentation.spryker.com/docs/en/mg-sales) for more details.
...
**CartCurrencyConnector** - new module provides plugin for cart rebuilding. <!-- See [Currency configuration](https://documentation.spryker.com/docs/en/currency) for more details.-->
...
**Shipment >= 6.*** - see [Migration Guide - Shipment](https://documentation.spryker.com/docs/en/mg-shipment).
...
**Price >= 5.*** - see [Migration Guide - Price](https://documentation.spryker.com/docs/en/mg-price).
**PriceProduct** - new module handling price product prices. Migration is a part of [Migration Guide - Price](https://documentation.spryker.com/docs/en/mg-price).
**PriceCartConnector >= 4.*** -  [Migration Guide - PriceCartConnector](https://documentation.spryker.com/docs/en/mg-price-cart-connector) uses the new PriceProduct module.
**PriceDataFeed >= 0.2.*** - uses the new `PriceProduct` module.
**ProductBundle >= 4.*** - [Migration Guide - ProductBundle](https://documentation.spryker.com/docs/en/mg-product-bundle) uses the new `PriceProduct` module, the new plugin to watch cart item reload action.
**ProductLabelGui >= 2.*** - see [Migration Guide - ProductLabelGui](https://documentation.spryker.com/docs/en/mg-product-label-gui).
**ProductManagement >= 0.9.*** - see [Migration Guide - ProductManagement](https://documentation.spryker.com/docs/en/mg-product-management). New forms and views have been added.
**ProductRelation >= 2.*** - see [Migration Guide - ProductRelation](https://documentation.spryker.com/docs/en/mg-product-relation).
**ProductRelationCollector >= 2.*** - see [Migration Guide - ProductRelationCollector](https://documentation.spryker.com/docs/en/mg-product-relation-collector).
**ProductSetGui >= 2.*** - see [Migration Guide - ProductSetGui](https://documentation.spryker.com/docs/en/mg-product-set-gui).
**Wishlist >= 2.*** - see [Migration Guide - Wishlist](https://documentation.spryker.com/docs/en/mg-wishlist).
**Search >= 7.0** - see [Migration Guide - Search](https://documentation.spryker.com/docs/en/mg-search).
...
**ProductOptionCartConnector >= 5.*** - see [Migration Guide - Product Option Cart Connector](https://documentation.spryker.com/docs/en/mg-product-option-cart-connector).
**ProductOption >= 6.*** - see [Migration Guide - Product Option](https://documentation.spryker.com/docs/en/mg-product-option).
