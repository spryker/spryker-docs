...
1. Follow the steps in the individual migration guide for the **Stock** module. For more information, see [Migration Guide - Stock](https://documentation.spryker.com/docs/en/mg-stock#upgrading-from-version-7---to-version-8-0-0). 
