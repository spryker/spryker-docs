...
**Oms version >= 4** is required. See the [Migration Guide - OMS](https://documentation.spryker.com/docs/en/mg-oms) to version 4 step by step guide how to migrate OMS to have the new Availability module integrated.
