...
**Oms version >= 4** is required. See the [Migration Guide - OMS](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-oms.html) to version 4 step by step guide how to migrate OMS to have the new Availability module integrated.
