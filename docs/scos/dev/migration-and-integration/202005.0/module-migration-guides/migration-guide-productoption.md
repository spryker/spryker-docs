...
2. Install/Update `spryker/currency` to at least version 3.0.0. See [Migration Guide - Currency](https://documentation.spryker.com/docs/en/mg-currency) for more details.
3. Install/Update `spryker/price` to at least version 5.0.0. See [Migration Guide - Price](https://documentation.spryker.com/docs/en/mg-price) for more details.
4. Update `spryker/product-option-cart-connector` to at least version 5.0.0 (if you have this module already installed). See [Migration Guide - Product Option Cart Connector](https://documentation.spryker.com/docs/en/mg-product-option-cart-connector) for more details.
...
To learn how to migrate to new structure, see the [Upgrading from version 3.* to version 4.*](https://documentation.spryker.com/docs/en/mg-calculation#upgrading-from-version-3---to-version-4--) section in *Migration Guide - Calculation*.
