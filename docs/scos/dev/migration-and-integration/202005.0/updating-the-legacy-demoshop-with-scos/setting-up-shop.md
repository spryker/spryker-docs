...
The `ShopUiCompatibility` module is the main module necessary for the [Atomic Frontend](https://documentation.spryker.com/docs/en/atomic-frontend). This module is provided in SCOS by default.
