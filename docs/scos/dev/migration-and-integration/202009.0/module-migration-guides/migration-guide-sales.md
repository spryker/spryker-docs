...
originalLink: https://documentation.spryker.com/v6/docs/mg-sales
originalArticleId: a6e6c4b0-16ba-4b07-be2a-6d1421e601a4
redirect_from:
  - /v6/docs/mg-sales
  - /v6/docs/en/mg-sales
---
...
1. To keep old calculation logic, see [Updating calculator stacks](/docs/scos/dev/migration-and-integration/202009.0/module-migration-guides/migration-guide-calculation.html).
2. To migrate to the new structure, see [Migrating sales to new calculator logic](/docs/scos/dev/migration-and-integration/202009.0/module-migration-guides/migration-guide-calculation.html). 
