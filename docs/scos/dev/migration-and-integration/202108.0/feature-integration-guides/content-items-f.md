...
This document describes how. to integrate the [Content Items](https://documentation.spryker.com/docs/content-items-feature-overview) feature into a Spryker project.
