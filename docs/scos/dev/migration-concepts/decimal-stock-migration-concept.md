...
| `spryker/cart-variant` | 2.0.0 | [Upgrade the CartVariant module](/docs/pbc/all/cart-and-checkout/install-and-upgrade/upgrade-the-cartvariant-module.html#upgrading-from-version-1-to-version-200) |
