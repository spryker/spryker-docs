...
| spryker/price-product-volume | 2.0.0 | [Migration Guide - PriceProductVolume](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-priceproduct-modulevolume.html) |
| spryker/price-product-volume-gui | 2.0.0 | [Migration Guide - PriceProductVolumeGui](/docs/pbc/all/price-management/install-and-upgrade/upgrade-the-priceproduct-modulevolumegui.html) |
