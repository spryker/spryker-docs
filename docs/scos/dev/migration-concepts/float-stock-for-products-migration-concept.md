...
| --- | --- | --- |
| spryker/availability | 7.0.0 | [Migration Guide - Availability](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availability-module.html) |
| spryker/availability-cart-connector | 5.0.0 | [Migration Guide - AvailabilityCartConnector](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availabilitycartconnector-module.html) |
| spryker/availability-gui | 4.0.0 | [Migration Guide - AvailabilityGui](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availabilitygui-module.html) |
| spryker/availability-offer-connector | 2.0.0 | [Migration Guide - AvailabilityOfferConnector](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availability-moduleofferconnector.html) |
