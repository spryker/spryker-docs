...
| --- | --- | --- |
| spryker/availability | 7.0.0 | [Upgrade the Availability module](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availability-module.html) |
| spryker/availability-cart-connector | 5.0.0 | [Upgrade the AvailabilityCartConnector module](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availabilitycartconnector-module.html) |
| spryker/availability-gui | 4.0.0 | [Upgrade the AvailabilityGui module](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availabilitygui-module.html) |
| spryker/availability-offer-connector | 2.0.0 | [Upgrade the AvailabilityOfferConnector module](/docs/pbc/all/warehouse-management-system/install-and-upgrade/upgrade-the-availability-moduleofferconnector.html) |
| spryker/cart | 6.0.0 | [Upgrade the Cart module](/docs/scos/dev/module-migration-guides/migration-guide-cart.html) |
| spryker/cart-extension | 3.0.0 | [Upgrade the CartExtension module](/docs/scos/dev/module-migration-guides/migration-guide-cartextension.html) |
...
| spryker/checkout | 5.0.0 | [Upgrade the Checkout module](/docs/scos/dev/module-migration-guides/migration-guide-checkout.html) |
...
| spryker-shop/cart-page | 2.0.0 | [Upgrade the CartPage module](/docs/scos/dev/module-migration-guides/migration-guide-cartpage.html) |
