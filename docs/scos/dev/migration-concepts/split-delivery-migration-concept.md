...
| `spryker-shop/checkout-page` | 3.0.0 | [Upgrade the CheckoutPage module](/docs/scos/dev/module-migration-guides/migration-guide-checkoutpage.html#upgrading-from-version-2-to-version-3) |
...
| `spryker/checkout-rest-api` | 2.0.0 | [Upgrade the CheckoutRestApi module](/docs/scos/dev/module-migration-guides/glue-api/migration-guide-checkoutrestapi.html#upgrading-from-version-1-to-version-200) |
