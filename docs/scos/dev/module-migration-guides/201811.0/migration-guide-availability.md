...
Oms version >= 4 is required. See the [Migration Guide - OMS](/docs/scos/dev/module-migration-guides/{{page.version}}/migration-guide-oms.html) to version 4 step by step guide how to migrate OMS to have new availability integrated.
