...
For more details, see [Performance Monitoring - New Relic](/docs/scos/dev/technology-partner-integration-guides/{{page.version}}/operational-tools-monitoring-legal-etc/new-relic.html).
