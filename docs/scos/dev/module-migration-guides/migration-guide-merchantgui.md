...
Keep in mind that `MerchantGui` module migration depends on the [Merchant](/docs/scos/dev/module-migration-guides/migration-guide-merchant.html#upgrading-from-version-2-to-version-3) module migration.
