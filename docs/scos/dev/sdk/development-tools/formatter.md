...
## Installation
For details on how to install Formatter for your project, see [Formatter integration guide](/docs/scos/dev/technical-enhancements/development-tools/integrating-formatter.html).
