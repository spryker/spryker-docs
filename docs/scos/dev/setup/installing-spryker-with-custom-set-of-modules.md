...
2. Add or remove modules as necessary using [Composer](/docs/scos/dev/setup/composer.html). All available modules can be found in the following repositories:
