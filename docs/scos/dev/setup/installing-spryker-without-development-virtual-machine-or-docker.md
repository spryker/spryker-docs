...
Configure RabbitMQ permissions and virtual hosts. <!-- according to the instructions in [Tutorial - Set Up a "Hello World" Queue - Legacy Demoshop](/docs/scos/dev/legacy-demoshop/201811.0/set-up-a-hello-world-queue-legacy-demoshop.html#rabbitmq-management-ui).  link to archive -->
