...
The detailed view of modules allows you to analyze the changes, and if needed, upgrade the modules. To upgrade to the latest minor module versions, run the module [composer update](/docs/scos/dev/setup/composer.html#composer-update) command. To upgrade to a major version, follow the [migration guide](/docs/scos/dev/migration-and-integration/{{site.version}}/about-migration-and-integration-guides.html) of the respective module.
