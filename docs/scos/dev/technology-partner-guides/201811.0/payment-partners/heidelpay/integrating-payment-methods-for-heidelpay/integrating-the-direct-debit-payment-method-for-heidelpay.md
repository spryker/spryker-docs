...
originalLink: https://documentation.spryker.com/v1/docs/integrating-the-direct-debit-payment-method-for-heidelpay.html
originalArticleId: cba54b1e-33a2-4456-83cf-bd11447f14df
redirect_from:
  - /v1/docs/integrating-the-direct-debit-payment-method-for-heidelpay.html
  - /v1/docs/en/integrating-the-direct-debit-payment-method-for-heidelpay.html
related:
  - title: Heidelpay
...
## Setup
The following configuration should be made after Heidelpay has been [installed](/docs/scos/user/technology-partners/201811.0/payment-partners/heidelpay/heidelpay-installation.html) and [integrated](/docs/scos/user/technology-partners/201811.0/payment-partners/heidelpay/integrating-heidelpay.html).
