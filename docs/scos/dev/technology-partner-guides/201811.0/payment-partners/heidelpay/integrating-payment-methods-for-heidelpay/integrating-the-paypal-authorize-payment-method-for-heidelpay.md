...
originalLink: https://documentation.spryker.com/v1/docs/heidelpay-authorize
originalArticleId: 719daf9e-84fd-4538-bdf0-d626816ac4e0
redirect_from:
  - /v1/docs/heidelpay-authorize
  - /v1/docs/en/heidelpay-authorize
related:
  - title: Heidelpay
...
The following configuration should be made after Heidelpay has been [installed](/docs/scos/user/technology-partners/201811.0/payment-partners/heidelpay/heidelpay-installation.html) and [integrated](/docs/scos/user/technology-partners/201811.0/payment-partners/heidelpay/configuring-heidelpay.html).
