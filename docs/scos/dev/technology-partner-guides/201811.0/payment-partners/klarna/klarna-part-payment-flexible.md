...
originalLink: https://documentation.spryker.com/v1/docs/klarna-part-payment-flexible
originalArticleId: 10be374c-694c-47ea-8c1f-92cb876ba917
redirect_from:
  - /v1/docs/klarna-part-payment-flexible
  - /v1/docs/en/klarna-part-payment-flexible
related:
  - title: Klarna
...
## Perform Requests
In order to perform the needed requests, you can easily use the implemented [Klarna State Machine Commands and Conditions](/docs/scos/user/technology-partners/{{page.verison}}/payment-partners/klarna/klarna-state-machine-commands-and-conditions.html). The next section gives you a summary of them.
