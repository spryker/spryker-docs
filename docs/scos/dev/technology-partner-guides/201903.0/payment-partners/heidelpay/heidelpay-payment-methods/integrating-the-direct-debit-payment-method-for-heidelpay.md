...
originalLink: https://documentation.spryker.com/v2/docs/integrating-the-direct-debit-payment-method-for-heidelpay.html
originalArticleId: 726392c4-9ef3-4d7e-8e51-b753df745ab0
redirect_from:
  - /v2/docs/integrating-the-direct-debit-payment-method-for-heidelpay.html
  - /v2/docs/en/integrating-the-direct-debit-payment-method-for-heidelpay.html
related:
  - title: Heidelpay
...
## Setup
The following configuration should be made after Heidelpay has been [installed](/docs/scos/user/technology-partners/201903.0/payment-partners/heidelpay/heidelpay-installation.html) and [integrated](/docs/scos/user/technology-partners/201903.0/payment-partners/heidelpay/scos-integration/heidelpay-integration-into-scos.html).
...
{
	public const CHECKOUT_HEIDELPAY_DIRECT_DEBIT_REGISTRATION = 'checkout-integrating-the-direct-debit-payment-method-for-heidelpay.html-registration';
	...
	protected function addDirectDebitRegistrationRoute()
	{
		$this->createController(
			'/{checkout}/integrating-the-direct-debit-payment-method-for-heidelpay.html-registration',
