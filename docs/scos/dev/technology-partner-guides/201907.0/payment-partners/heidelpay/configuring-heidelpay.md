...
redirect_from:
  ...
  - /docs/scos/user/technology-partners/201907.0/payment-partners/heidelpay/configuring-heidelpay.html
related:
  - title: Heidelpay
...
Also, you have to add payment methods to [State Machine (OMS) configuration](/docs/scos/user/technology-partners/{{page.version}}/payment-partners/heidelpay.html#building-a-state-machine-workflow-to-use-heidelpay-payment-methods):
