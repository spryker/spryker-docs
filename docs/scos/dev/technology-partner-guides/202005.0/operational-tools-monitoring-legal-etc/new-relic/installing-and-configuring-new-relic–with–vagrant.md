...
redirect_from:
  - /docs/scos/dev/technology-partner-guides/202005.0/operational-tools-monitoring-legal-etc/new-relic/installing-and-configuring-new-relic��with–vagrant.html
related:
