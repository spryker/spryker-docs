...
originalLink: https://documentation.spryker.com/v6/docs/heidelpay-invoice-secured-b2c
originalArticleId: 35da5dd2-c353-46e6-aeb0-8e0c1439e01c
redirect_from:
  - /v6/docs/heidelpay-invoice-secured-b2c
  - /v6/docs/en/heidelpay-invoice-secured-b2c
related:
  - title: Heidelpay
...
## Setup
The following configuration should be made after Heidelpay has been [installed](/docs/scos/user/technology-partners/202009.0/payment-partners/heidelpay/heidelpay-installation.html) and [integrated](/docs/scos/user/technology-partners/202009.0/payment-partners/heidelpay/integrating-heidelpay.html).
