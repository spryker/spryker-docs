...
originalLink: https://documentation.spryker.com/v6/docs/payolution-requests
originalArticleId: 87ab726b-fcdb-40d3-960d-b94d7a67a6df
redirect_from:
  - /v6/docs/payolution-requests
  - /v6/docs/en/payolution-requests
related:
