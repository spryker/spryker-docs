...
Make sure, that FactFinder modules were [installed and configured](/docs/scos/user/technology-partners/{{page.version}}/marketing-and-conversion/analytics/fact-finder/fact-finder-installation-and-configuration.html) before proceeding with the integration.
