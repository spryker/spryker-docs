...
For more details, see [Checkout process review and implementation](/docs/pbc/all/cart-and-checkout/{{page.version}}/extend-and-customize/checkout-process-review-and-implementation.html).
