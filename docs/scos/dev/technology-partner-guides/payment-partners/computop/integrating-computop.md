...
Prior to integrating Computop into your project, make sure you [installed and configured the Computop module](/docs/scos/dev/technology-partner-guides/payment-partners/computop/installing-and-configuring-computop.html).
...
To configure [CRIF](/docs/scos/dev/technology-partner-guides/payment-partners/computop/integrating-payment-methods-for-computop/integrating-the-crif-payment-method-for-computop.html), do the following:
...
To integrate the Computop module, make sure you [installed and configured it](/docs/scos/dev/technology-partner-guides/payment-partners/computop/installing-and-configuring-computop.html).
