...
Before proceeding with the integration, make sure you have [installed and configured](/docs/scos/dev/technology-partner-guides/payment-partners/payolution/installing-and-configuring-payolution.html) the Payolution module.
