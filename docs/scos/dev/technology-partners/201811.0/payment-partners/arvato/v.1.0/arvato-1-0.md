...
Services:
* [Risk Check](/docs/scos/dev/technology-partners/201811.0/payment-partners/arvato/v.1.0/arvato-risk-che)

To implement Arvato RSS you should be familiar with concept of extending the Spryker Commerce OS. See [Extending Spryker](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-enrichment/extending-spryker/ht-extend-inuse) for more details.
