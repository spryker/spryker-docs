...
originalLink: https://documentation.spryker.com/v1/docs/heidelpay-paypal-debit
redirect_from:
  - /v1/docs/heidelpay-paypal-debit
  - /v1/docs/en/heidelpay-paypal-debit
---

### Setup

The following configuration should be made after Heidelpay has been [installed](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/heidelpay-insta) and [integrated](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/scos-integration/heidelpay-integ).
