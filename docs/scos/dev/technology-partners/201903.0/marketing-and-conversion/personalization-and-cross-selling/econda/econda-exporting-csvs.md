...
originalLink: https://documentation.spryker.com/v2/docs/econda-export-csvs
originalArticleId: 8670c8e5-e15b-45c6-87df-6c8500249f78
redirect_from:
  - /v2/docs/econda-export-csvs
  - /v2/docs/en/econda-export-csvs
---

To implement Econda plugin you should be familiar with the concept of [extending Spryker](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-enrichment/extending-spryker/extending-a-core-module-that-is-used-by-another.html) and [plugins.](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-enrichment/implementing-and-using-plugins.html)
