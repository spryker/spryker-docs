...
In order to perform the needed requests, you can easily use the implemented [Klarna State Machine Commands and Conditions](https://documentation.spryker.com/v2/docs/klarna-state-machine.htm). The next section gives a summary of them.
