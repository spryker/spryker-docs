...
To implement Econda plugin you should be familiar with the concept of [extending Spryker](/docs/scos/dev/developer-guides/201907.0/back-end-development/extending-spryker/extending-a-core-module-that-is-used-by-another.html) and [plugins.](/docs/scos/dev/{{site.version}}/back-end-development/implementing-and-using-plugins.html)
