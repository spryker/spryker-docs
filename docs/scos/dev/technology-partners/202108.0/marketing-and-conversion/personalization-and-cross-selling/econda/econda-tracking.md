...
To add tracking, you should also be familiar with [Twig.](/docs/scos/dev/developer-guides/{{ page.version }}/development-guide/front-end/legacy-demoshop/twig-templates/overview-twig.html)
...
Before getting started we recomend that you read the following topics: [asset management](/docs/scos/dev/developer-guides/{{ page.version }}/development-guide/front-end/legacy-demoshop/frontend-overview.html#asset-management)
and [Twig](/docs/scos/dev/developer-guides/{{ page.version }}/development-guide/front-end/legacy-demoshop/twig-templates/overview-twig.html)
