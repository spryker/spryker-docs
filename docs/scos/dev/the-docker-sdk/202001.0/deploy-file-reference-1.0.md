...
Find B2B/B2C deploy file examples for [development](/docs/scos/dev/set-up/install-spryker/install/choose-an-installation-mode.html#development-mode) and [demo](/docs/scos/dev/set-up/install-spryker/install/choose-an-installation-mode.html#demo-mode) environments in the table:
