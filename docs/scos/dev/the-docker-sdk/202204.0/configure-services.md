...
Once you have enabled New Relic in your deploy file and have completed a new deploy, please [contact Spryker Support](/docs/scos/user/intro-to-spryker/support/how-to-contact-spryker-support.html) to have these changes integrated into your cloud-hosted environment. This can be done by submitting an infrastructure change request through the [Support Portal](/docs/scos/user/intro-to-spryker/support/how-to-use-the-support-portal.html). The Support team will confirm that a New Relic APM account is available for you and will ensure that the correct application naming convention is set up to cascade to the appropriate APM.
