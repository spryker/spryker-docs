...
* [deployment](https://github.com/spryker/docker-sdk/tree/master/deployment): generated Docker images, configs, and assets that are necessary to build containers.
...
Fontend (Nginx), translates HTTP to FastCGI proxy for Glue, Yves, Zed, and serves assets.
...
![docker-sdk-in-sccos](https://s3.console.aws.amazon.com/s3/object/spryker?region=eu-central-1&prefix=docs/scos/dev/the-docker-sdk/the-docker-sdk/docker-sdk-in-sccos.png)
...
- To use custom PHP/nginx image and add extensions or libraries, you can change the application image:
   ...
   ```
  This approach supports SCCOS, but has limited customization possibilities.

- To make major customizations and keep control of the code, you can fork the [docker/sdk repository](https://github.com/spryker/docker-sdk).
  This approach offers all the customization possibilities but does not support SCCOS.

- To introduce mocks for development and for CI/CD testing, you can use the [Docker-compose extension](https://docs.docker.com/compose/extends/):
  ```
  docker:
   compose:
      yamls:
  ...
  This approach works great for dev/CI/CD, but requires SCCOS customizations.
