...
redirect_from:
  ...
  - /docs/scos/dev/the-docker-sdk/deploy-file-reference-1.0.html
...
The files must exist on a [project or base layer](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file.html).
...
Defines the [dynamic parameters](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file.html#dynamic-parameters) to be used when parsing the included deploy file. In the included deploy file, the parameter name should be wrapped in `%`.
...
* `{import_name}: parameters:` - defines the [dynamic parameters](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file.html#dynamic-parameters) to be used when parsing the included deploy file. In the included deploy file, the parameter name should be wrapped in `%`.
...
* `{deploy_file_name}: parameters:` - defines the [dynamic parameters](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file.html#dynamic-parameters) to be used when parsing the included deploy file. In the included deploy file, the parameter name should be wrapped in `%`.
...
Defines the [New Relic](/docs/scos/dev/the-docker-sdk/configuring-services.html#new-relic) configuration.
