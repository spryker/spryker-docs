...
1. [Install and configure New Relic](/docs/dg/dev/sdks/the-docker-sdk/configure-services.html#new-relic).
...
1. Install and configure [Blackfire](/docs/dg/dev/sdks/the-docker-sdk/configure-services.html#blackfire).
