...
originalLink: https://documentation.spryker.com/v6/docs/howto-create-a-visibility-condition-for-cms-blocks
originalArticleId: 2f53207b-1f3a-4a91-9f6d-48e497db9014
redirect_from:
  - /v6/docs/howto-create-a-visibility-condition-for-cms-blocks
  - /v6/docs/en/howto-create-a-visibility-condition-for-cms-blocks
---

Visibility Condition is a [Templates & Slots](/docs/scos/dev/features/202009.0/cms/cms-feature-overview/templates-and-slots/templates-and-slots-feature-overview.html) feature functionality that allows you to define in which cases a CMS block is displayed on a page. The [Spryker CMS Blocks content provider](/docs/scos/dev/features/202009.0/cms/cms-feature-overview/templates-and-slots/templates-and-slots-feature-overview.html#spryker-cms-blocks) for slots has the following [visibility conditions](/docs/scos/dev/features/202009.0/cms/cms-feature-overview/templates-and-slots/templates-and-slots-feature-overview.html#visibility-conditions) by default:
...
Each page type has a dedicated template with several [slot widgets](/docs/scos/dev/features/202009.0/cms/cms-feature-overview/templates-and-slots/templates-and-slots-feature-overview.html#slot-widget). The visibility conditions of each template are defined in module configuration. 
...
* [Creating Forms](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-enrichment/forms/creating-forms.html#creating-forms) to learn about form creation procedure in Spryker.
