...
originalArticleId: c918b721-7959-4a83-9d55-c5b2991995ad
redirect_from:
...
3. Overloaded product abstract search documents cause issues with memory limit and slow down [Publish and Synchronization](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-publishing/publish-and-synchronization.html). Average document size is bigger than 1 MB.
...
1. The [Product Reviews feature](https://documentation.spryker.com/v6/docs/product-reviews) is disabled because it requires multiple document types per index. 
