...
originalLink: https://documentation.spryker.com/v6/docs/extending-a-rest-request-resource
originalArticleId: d30c9a6e-7955-4a83-9b85-20a06dd89b43
redirect_from:
...
The following guide relies on your knowledge of the structure of a Glue REST API resource module and the behavior of its constituents. For more details, see the [Resource Modules](/docs/scos/dev/developer-guides/202009.0/development-guide/glue-api/glue-infrastructure.html#resource-modules
...
* [Install Spryker Development Machine](/docs/scos/dev/sdk/202009.0/development-virtual-machine-docker-containers-and-console.html); 
* [Enable Glue Rest API](/docs/scos/dev/migration-and-integration/202009.0/feature-integration-guides/glue-api/glue-api-installation-and-configuration.html); 
* [Integrate Products API](/docs/scos/dev/migration-and-integration/202009.0/feature-integration-guides/glue-api/glue-api-products-feature-integration.html).

{% info_block infoBox %}
If you have a development virtual machine with the [B2C Demo Shop](/docs/scos/user/intro-to-spryker/{{site.version}}/about-spryker.html#spryker-b2b-b2c-demo-shops
...
For more details, see [Product Attributes](/docs/scos/dev/database-schema-guide/202009.0/catalog-schema.html#product-attributes
{% endinfo_block %} and [Extending the Database Schema](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/extending-the-database-schema.html).)
...
You can also use a [Spryk](/docs/scos/dev/developer-guides/202009.0/development-guide/glue-api/glue-spryks.html) to extend Glue transfers. Run the following command:  
```Bash
...
You can also use a [Spryk](/docs/scos/dev/developer-guides/202009.0/development-guide/glue-api/glue-spryks.html) to put data. Run the following command:  
```Bash
...
You can also use a [Spryk](/docs/scos/dev/developer-guides/202009.0/development-guide/glue-api/glue-spryks.html) to override mapper initialization. Run the following command:  
```Bash
