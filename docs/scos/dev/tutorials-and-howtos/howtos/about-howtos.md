...
**Glue API HowTos**  provide guides and instructions for tasks related to [Spryker Glue Rest API](/docs/scos/dev/glue-api-guides/{{site.version}}/old-glue-infrastucture/glue-rest-api.html). These guides walk you through the following topics:
