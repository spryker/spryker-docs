...
The corresponding XML for this transition is as follows:
...
To add a new shipment method to a carrier, follow these steps:
1. Click **Add New Shipment Method**.
The **Add a new shipment method** dialog opens.
