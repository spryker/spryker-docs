...
The necessary list of files is provided in the [Project structure document, Module structure section](/docs/dg/dev/frontend-development/{{site.version}}/marketplace/project-structure.html#module-structure).
