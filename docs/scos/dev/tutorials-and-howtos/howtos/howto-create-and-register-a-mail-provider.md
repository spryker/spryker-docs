...
If a `MailType` can be handled by more than one provider, the email is sent by both of them.
...
* [Tutorial: Sending a mail](/docs/scos/dev/tutorials-and-howtos/introduction-tutorials/tutorial-sending-an-email.html)
* -->
