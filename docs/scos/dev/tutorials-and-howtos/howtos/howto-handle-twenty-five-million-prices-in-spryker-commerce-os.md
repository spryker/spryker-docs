...
1. The [Product Reviews feature](/docs/scos/user/features/product-rating-and-reviews-feature-overview.html) is disabled because it requires multiple document types per index.
