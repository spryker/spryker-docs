...
***Намалювати нову діаграму на якій буде показано як основа регіон***

![dynamic multi-store setup 1](https://spryker.s3.eu-central-1.amazonaws.com/docs/scos/dev/tutorials-and-howtos/howtos/how-to-set-up-multiple-stores.md/multi-store-setup-configuration-option-1.png)
...
![dynamic multi-store setup 2](https://spryker.s3.eu-central-1.amazonaws.com/docs/scos/dev/tutorials-and-howtos/howtos/how-to-set-up-multiple-stores.md/multi-store-setup-configuration-option-2.png)
...
![dynamic multi-store setup 3](/images/)
...
1. Опис по конфігуруванні 
***Додати посилання на інструкцію по конфігурації***
