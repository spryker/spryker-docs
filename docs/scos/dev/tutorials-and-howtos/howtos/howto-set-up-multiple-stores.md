...
2. Optional: Define store-specific configuration:
  ...
  In the following example, the `docker_de` environment name points to the `config/Shared/config-default_docker_de.php` store-specific configuration file. For more information about this deploy file parameter, see [environment](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html#environment):
...
#### 4. Adjust all the [import files and import configuration](/docs/scos/dev/data-import/data-importers-overview-and-implementation.html) to import data for the stores you’ve added.
...
For more information about deploy file configuration, see [Deploy file reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html).
