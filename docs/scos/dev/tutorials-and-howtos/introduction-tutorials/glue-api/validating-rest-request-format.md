...
By default, a validation cache will be generated for the current store. In order to generate it for a specific store, please use the `APPLICATION_STORE` variable.
For example:
```bash
