...
originalLink: https://documentation.spryker.com/v1/docs/implementing-rest-api-resource
originalArticleId: 35dafd25-4e9c-4c0f-9818-8a8a299b42cb
redirect_from:
...
{% info_block infoBox %}
For information on how to define the objects and syntax, see [How to create transfer objects](https://documentation.spryker.com/v1/docs/ht-use-transfer-objects
{% endinfo_block %}.)
