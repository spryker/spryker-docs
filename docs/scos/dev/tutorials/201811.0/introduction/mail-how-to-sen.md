...
Now, create the `MailType` plugin for this example. See [HowTo - Create and Register a MailTypePlugin](/docs/scos/dev/tutorials/201811.0/howtos/ht-mail-create-) for more information on creating a MailTypePlugin:
