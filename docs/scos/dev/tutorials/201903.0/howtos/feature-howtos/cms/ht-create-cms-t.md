...
In order to have a template to select in the Template drop-down list when creating a new [CMS page](/docs/scos/dev/features/201903.0/cms/cms-page/cms-page) on the [Create new CMS Block](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/content-management/pages/assigning-block) page in the Back Office, first you need to create the template itself.
...
In order to have a template to select in the Template drop-down list when creating a new [CMS block](/docs/scos/dev/features/201903.0/cms/cms-block/cms-block) on the [Create new CMS Block](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/content-management/blocks/creating-cms-bl) page in the Back Office, first you need to create the template itself.
