...
Besides setting [global and merchant relation thresholds](/docs/scos/user/user-guides/201903.0/back-office-user-guide/thresholds/threshold.html)  for minimum order values manually in the Administration Interface, they can also be imported in bulk from a .csv file.
