...
* [Install Spryker Development Machine](/docs/scos/dev/features/201903.0/sdk/devvm); 
* [Enable Glue Rest API](/docs/scos/dev/migration-and-integration/201903.0/feature-integration-guides/glue-api/glue-api-instal); 
* [Integrate Products API](/docs/scos/dev/migration-and-integration/201903.0/feature-integration-guides/glue-api/product-api-fea).

{% info_block infoBox %}
If you have a development virtual machine with the [B2C Demo Shop](/docs/scos/dev/about-spryker/201903.0/demoshops
...
{% endinfo_block %} and [Extending the Database Schema](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/t-extend-db-sch).)
