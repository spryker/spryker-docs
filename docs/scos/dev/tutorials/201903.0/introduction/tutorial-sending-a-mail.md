...
originalLink: https://documentation.spryker.com/v2/docs/mail-how-to-send
originalArticleId: 7980a154-68d3-4ee3-98c7-d0765750dc41
redirect_from:
  - /v2/docs/mail-how-to-send
  - /v2/docs/en/mail-how-to-send
---
...
Now, create the `MailType` plugin for this example. See [HowTo - Create and Register a MailTypePlugin](/docs/scos/dev/tutorials/201903.0/howtos/howto-create-and-register-a-mailtypeplugin.html) for more information on creating a MailTypePlugin:
