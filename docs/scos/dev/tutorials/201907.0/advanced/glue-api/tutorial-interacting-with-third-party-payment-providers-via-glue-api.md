...
originalArticleId: cc2f382a-8333-4b32-bd18-eedc9944d8b6
redirect_from:
...
{% info_block infoBox %}
For details, see [Checking Out Purchases and Getting Checkout Data](/docs/scos/dev/glue-api/201907.0/glue-api-storefront-guides/checking-out-purchases-and-getting-checkout-data.html
{% endinfo_block %}.)
...
{% info_block infoBox %}
For details, see [Updating Payment Data](/docs/scos/dev/glue-api/201907.0/glue-api-storefront-guides/checking-out-purchases-and-getting-checkout-data.html#updating-payment-data
{% endinfo_block %}.)
