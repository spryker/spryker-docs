...
{% info_block infoBox %}
The article describes the steps on how to create a template for [content item widgets](/docs/scos/dev/features/201907.0/cms/content-item-widgets/content-items-widgets-overview.html
{% endinfo_block %}.)
