...
originalLink: https://documentation.spryker.com/v3/docs/ht-configuring-visibility-included-section-201903
originalArticleId: 92492f6a-4834-48f3-bd75-9f3b276b0983
redirect_from:
...
By default, the option is enabled on the Spryker Core level, but disabled on the project level in all [Spryker Demo Shops](/docs/scos/user/about-spryker/201907.0/demo-shops.html) (B2B Demo Shop, B2C Demo Shop and Master Shop Suite).
