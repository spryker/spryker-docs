...
originalLink: https://documentation.spryker.com/v3/docs/validating-rest-request-format
originalArticleId: c85cbca4-19aa-4375-9736-950da4f99d07
redirect_from:
  - /v3/docs/validating-rest-request-format
  - /v3/docs/en/validating-rest-request-format
---
...
## 1. Installation
To be able to validate REST requests, first, you need to install the `RestRequestValidation` Module that provides the functionality. For details, see [Request Validation Integration](https://documentation.spryker.com/v3/docs/rest-schema-validation-feature-integration-201903). 
...
3. Provide validation for the endpoints provided by the API. For details, see [Validation Rule Format](/docs/scos/dev/tutorials/201907.0/introduction/glue-api/validating-rest-request-format.html#4--validation-rule-format).
