...
A content manager can apply this template when [creating a CMS page](/docs/scos/dev/user-guides/202001.0/back-office-user-guide/content-management/pages/creating-a-cms-) in the Back Office.

## Template with Slots

[Template with slots](/docs/scos/dev/features/202001.0/cms/templates-and-slots/templates-slots) is a Twig file that defines the layout of slots across a Storefront page and has at least one slot assigned. 
...
3. [Import](/docs/scos/dev/developer-guides/202001.0/development-guide/back-end/data-manipulation/data-ingestion/data-importers/data-importers-) template and slot lists. Learn about the lists in the [Correlation](https://documentation.spryker.com/v4/docs/templates-slots-feature-overview#correlation) section of **Templates & Slots Feature Overview**.

Templates with slots are universal. In the Back Office, a content manager can:

*     apply this template when [creating a CMS page](/docs/scos/dev/user-guides/202001.0/back-office-user-guide/content-management/pages/creating-a-cms-).
*     apply this template when [creating a category](/docs/scos/dev/user-guides/202001.0/back-office-user-guide/category/creating-catego).
...
CMS block template is a Twig file that, when applied to a [CMS block](/docs/scos/dev/features/202001.0/cms/cms-block/cms-block), defines its design and layout. 
...
A content manager can apply this template when [creating a CMS block](/docs/scos/dev/user-guides/202001.0/back-office-user-guide/content-management/blocks/creating-cms-bl) in the Back Office.
