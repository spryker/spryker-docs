...
originalLink: https://documentation.spryker.com/v4/docs/implementing-rest-api-resource
originalArticleId: 3b76694c-415f-4c3f-8abf-d6a6caae7da6
redirect_from:
...
{% info_block infoBox %}
For information on how to define the objects and syntax, see [How to create transfer objects](/docs/scos/dev/developer-guides/202001.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/creating-using-and-extending-the-transfer-objects.html
{% endinfo_block %}.)
