...
{% info_block infoBox %}
For information on how to define the objects and syntax, see [How to create transfer objects](https://documentation.spryker.com/v4/docs/ht-use-transfer-objects-201903
{% endinfo_block %}.)
