...
To explore further before starting, you can read about the [Checkout](https://documentation.spryker.com/v4/docs/checkout-steps-201903) and the [StepEngine](/docs/scos/dev/features/202001.0/order-management/step-engine.html) modules.
