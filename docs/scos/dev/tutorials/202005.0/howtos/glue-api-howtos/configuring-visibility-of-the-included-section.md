...
originalLink: https://documentation.spryker.com/v5/docs/ht-configuring-visibility-included-section-201903
originalArticleId: 4e7eb7fe-a3ce-4d5b-83b3-f1a14c7160ae
redirect_from:
...
By default, the option is enabled on the Spryker Core level, but disabled on the project level in all [Spryker Demo Shops](/docs/scos/user/intro-to-spryker/{{site.version}}/about-spryker.html#spryker-b2b-b2c-demo-shops) (B2B Demo Shop, B2C Demo Shop and Master Shop Suite).
