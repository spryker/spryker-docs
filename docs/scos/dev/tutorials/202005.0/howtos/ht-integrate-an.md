...
For more information about how to work with Data Transfer Objects, see [Creating, Using and Extending the Transfer Objects](https://documentation.spryker.com/docs/en/ht-use-transfer-objects-201903).
