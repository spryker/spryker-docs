...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-april-1-2017
originalArticleId: c873629f-d685-4b9e-8b94-38207cea7b2c
redirect_from:
  - /v1/docs/release-notes-april-1-2017
  - /v1/docs/en/release-notes-april-1-2017
---
...
**Documentation**
For module documentation, see [Product Relation](https://documentation.spryker.com/v1/docs/product-relations-1). For integration guides see: [Product Relations Feature Integration](/docs/scos/dev/migration-and-integration/201811.0/feature-integration-guides/product-relation-integration.html).
...
**Documentation**
For module documentation, see [Event](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-publishing/event/event.html).
