...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-august-2-2017
originalArticleId: a507600a-e1a7-4b4e-8894-24cb94be5b9f
redirect_from:
  - /v1/docs/release-notes-august-2-2017
  - /v1/docs/en/release-notes-august-2-2017
---
...
**Documentation**
For detailed migration guides, see [Sales Module Guide from Version 6.* to 7.*](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-sales.html#upgrading-from-version-6---to-version-7--).
...
To enable this change, please adjust `\Pyz\Zed\Calculation\CalculationDependencyProvider::getQuoteCalculatorPluginStack` according to [Calculation Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-calculation.html). Place `InitialGrandTotalCalculatorPlugin()` in the right sequence.
...
* [Fact-Finder - Campaigns](/docs/scos/dev/technology-partners/201811.0/marketing-and-conversion/analytics/fact-finder/fact-finder-campaigns.html)
* [Fact-Finder - Recommendation](/docs/scos/dev/technology-partners/201811.0/marketing-and-conversion/analytics/fact-finder/fact-finder-recommendation.html)
