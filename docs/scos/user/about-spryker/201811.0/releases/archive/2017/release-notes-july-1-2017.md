...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-july-1-2017
originalArticleId: 95e98352-8f66-42bd-b6da-e68a124ac723
redirect_from:
  - /v1/docs/release-notes-july-1-2017
  - /v1/docs/en/release-notes-july-1-2017
---
...
**Documentation**
For integration guides, see [Cart Integration](/docs/scos/dev/migration-and-integration/201811.0/feature-integration-guides/cart-integration.html). 
...
**Documentation**
For relevant documentation, see [CMS Block](/docs/scos/dev/features/201811.0/cms/cms-block/cms-block.html).

For detailed migration guides, see [CMS Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-cms.html), [CMS Block Migration Console](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-cms.html-block-category-connector-console)
...
**Documentation**
For relevant documentation, see [File System File Manager Module Guide](https://documentation.spryker.com/v1/docs/file-system), [Flysystem Module Guide](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/flysystem.html)
...
**Documentation**
For relevant documentation, see [Product Label Module Guide](/docs/scos/dev/features/201811.0/product-management/product-label.html), [Discount Module Guide](/docs/scos/dev/features/201811.0/promotions-and-discounts/discount/discount.html)
...
**Documentation**
For module documentation, see [Payment Module Guide](/docs/scos/dev/features/201811.0/payment/payment.html)
For detailed migration guides, see [Payment Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-payment.html)
