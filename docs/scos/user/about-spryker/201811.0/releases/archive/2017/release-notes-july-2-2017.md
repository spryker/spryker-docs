...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-july-2-2017
originalArticleId: fb9e6476-c4c4-46fe-89c3-fdd129ac5115
redirect_from:
  - /v1/docs/release-notes-july-2-2017
  - /v1/docs/en/release-notes-july-2-2017
---
...
**Documentation**
For module documentation, see [Product Label Module Guide](/docs/scos/dev/features/201811.0/product-management/product-label.html)
For detailed migration guides, see [Product Label Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-product-label.html).
...
**Documentation**
For module documentation, see [HowTo - Import Data](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-ingestion/data-importers/creating-a-data-importer.html).
...
**Documentation**
For module documentation and integration guides, see [ProductNew Module Guide](/docs/scos/dev/features/201811.0/product-management/new-products.html)
...
* [CMS Block Category Connector Module Guide](/docs/scos/dev/features/201811.0/cms/cms.html-block-category-connector)
* [Content Management Module Guide](/docs/scos/dev/features/201811.0/cms/cms.html)

For migration guides, see: 

* [Category Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-category.html) 
* [CMS Block Category Connector Migration Guide](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-cms-block-category-connector.html)
* Category Template Migration Console <!-- add a link -->
* [CMS Block Category Connector Migration Console](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-cms-block-category-connector.html-console)
