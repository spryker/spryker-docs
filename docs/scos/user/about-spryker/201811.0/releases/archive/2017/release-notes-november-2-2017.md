...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-november-2-2017
originalArticleId: ee21672d-c866-4b72-b164-8435426c3d42
redirect_from:
  - /v1/docs/release-notes-november-2-2017
  - /v1/docs/en/release-notes-november-2-2017
---
...
For detailed migration guides, see [Customer Module Migration Guide from Version 6. to 7](/docs/scos/dev/migration-and-integration/201811.0/module-migration-guides/migration-guide-customer.html#upgrading-from-version-6---to-version-7-0).
...
* [Payment Integration - BS Payone - 1.1](/docs/scos/dev/technology-partners/201811.0/payment-partners/bs-payone/bs-payone.html) 
* Integration With Project - Payone
* [PayPal Express Checkout Payment - Payone - 1.1](https://documentation.spryker.com/v1/docs/payone-paypal-express-checkout-payment-1)
 
