...
originalArticleId: f16a9ae1-0590-4166-b7bf-9e0d412364a1
redirect_from:
...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/v1/docs/availability-notification).
...
**Documentation**: [Discount](/docs/scos/dev/features/201811.0/promotions-and-discounts/discount/discount.html). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v1/docs/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/user/user-guides/201811.0/back-office-user-guide/category/category.html-management).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v1/docs/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v1/docs/cms-pages-in-search-results-overview).
...
**Documentation**: [Assigning a Template for a Category Page](/docs/scos/user/user-guides/201811.0/back-office-user-guide/category/category.html)
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/201811.0/development-guide/back-end/data-manipulation/data-enrichment/session-handlers.html).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/201811.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/201811.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](https://documentation.spryker.com/v1/docs/phpstan).
...
**Documentation**: [Spryk](https://documentation.spryker.com/v1/docs/spryk).
...
**Documentation**: [Retrieving Alternative Products](https://documentation.spryker.com/v1/docs/retrieving-alternative-products).
...
**Documentation**: [Quick Order](/docs/scos/dev/features/201811.0/shopping-cart/quick-order/quick-order.html).
...
**Documentation**: [Checkout](https://documentation.spryker.com/v1/docs/delivery-address-step-shop-guide), [Business on Behalf](https://documentation.spryker.com/v1/docs/business-on-behalf-overview), [Reclamations](https://documentation.spryker.com/v1/docs/reclamations).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/heidelpay-split-payment-marketplace.html).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/201811.0/payment-partners/adyen/payment-integration-adyen.html).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/201811.0/payment-partners/afterpay/afterpay.html).
