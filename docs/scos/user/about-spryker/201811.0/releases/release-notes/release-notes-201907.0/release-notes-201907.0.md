...
originalLink: https://documentation.spryker.com/v1/docs/release-notes-201907-0
originalArticleId: 5f44af5e-b92f-4764-8165-25091c753f09
redirect_from:
...
**Documentation:**
Feature documentation: [Gift Cards](https://documentation.spryker.com/v1/docs/gift-card)
...
**Documentation**: [Scheduled Prices](https://documentation.spryker.com/v1/docs/scheduled-prices)
...
**Documentation**: [Product Image Management](https://documentation.spryker.com/v1/docs/product-images-overview)
***
## CMS
### CMS Content Items
...
* [Content Items](https://documentation.spryker.com/v1/docs/content-items)
* [Content Item Widgets](https://documentation.spryker.com/v1/docs/content-item-widgets-201907)
***
...
**Documentation**: [B2B Logging in as Company User](https://documentation.spryker.com/v1/docs/logging-in-as-company-user-201907)
...
* [Retrieving Company Information](https://documentation.spryker.com/v1/docs/retrieving-companies)
* [Retrieving Business Unit Information](https://documentation.spryker.com/v1/docs/retrieving-business-units)
* [Retrieving Company User Information](https://documentation.spryker.com/v1/docs/retrieving-company-users)
* [Retrieving Company Role Information](https://documentation.spryker.com/v1/docs/retrieving-company-roles)
...
* [Security and Authentication](/docs/scos/dev/glue-api/201811.0/glue-api-developer-guides/security-and-authentication.html)
...
**Documentation**: [Managing Carts of Registered Users](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/managing-carts/managing-carts-of-registered-users.html)
...
**Documentation**: [Shared Carts API](https://documentation.spryker.com/v1/docs/managing-shared-company-user-carts)
...
* [B2B-B2C Checking Out Purchases and Getting Checkout Data](/docs/scos/dev/glue-api/201811.0/glue-api-storefront-guides/checking-out-purchases-and-getting-checkout-data.html)
...
**Documentation**: [Spryker in Docker](https://documentation.spryker.com/v1/docs/spryker-in-docker-201907)
***
## B2B
### Request for Quote
...
**Documentation**: [Request for Quote](https://documentation.spryker.com/v1/docs/quotation-process) 
...
**Documentation**: [Punchout](https://documentation.spryker.com/v1/docs/punchout-201907)
...
**Documentation**: [Comments](https://documentation.spryker.com/v1/docs/comments)
...
**Documentation**: [Unique URL per Cart for Easy Sharing](https://documentation.spryker.com/v1/docs/resource-sharing-feature-overview)
...
* Vault - We introduce the Vault place where you can store valuable information and get it from there by ID in an encrypted form and vice versa
    **Documentation**: [Vault for Tokens](https://documentation.spryker.com/v1/docs/vault-for-tokens-overview)

* Customer Login by Token - Ability to log in to the Spryker Commerce OS by token
    **Documentation**: [Customer Login by Token](https://documentation.spryker.com/v1/docs/customer-login-by-token-overview)
...
**Documentation**: [Payone - Cash on Delivery](/docs/scos/dev/technology-partners/201811.0/payment-partners/bs-payone/scos-integration/payone-cash-on-delivery.html)
...
**Documentation**: [Heidelpay - Easy Credit](/docs/scos/dev/technology-partners/201811.0/payment-partners/heidelpay/heidelpay-easy-credit.html)
...
**Documentation**: [Episerver](/docs/scos/dev/technology-partners/201811.0/marketing-and-conversion/customer-communication/episerver/episerver.html) 
...
**Documentation**: [Ratenkauf by Easycredit - Installation and Configuration](/docs/scos/dev/technology-partners/201811.0/payment-partners/ratenkauf-by-easycredit/ratenkauf-by-easycredit-installation-and-configuration.html)
...
**Documentation**: [CrefoPay](/docs/scos/dev/technology-partners/201811.0/payment-partners/crefopay/crefopay.html) 
...
 
Check out [Documentation Updates](/docs/scos/user/about-spryker/201811.0/whats-new/documentation-updates.html) for all the updates to documentation made with this release. 
