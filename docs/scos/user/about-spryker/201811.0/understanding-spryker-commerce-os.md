...
originalArticleId: 577b6397-34bd-4ab1-8525-e2cc60607355
redirect_from:
...
If you would like to see our Shop App in action, check out our [live demo](https://now.spryker.com/en/demoshop), watch one of our feature [videos](/docs/scos/user/about-spryker/201811.0/videos-and-webinars/spryker-videos.html){target="_blank"} of check out our feature list:
...
* If you would like to check out past release visit our [release notes](/docs/scos/user/about-spryker/201811.0/releases/release-notes/release-notes.html){target="_blank"} section and archive.
