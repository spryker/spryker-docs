...
originalArticleId: dc8041e2-c4fa-418c-8340-ad576c213ad6
redirect_from:
...
The evaluation of the Commerce OS was done without having prior knowledge of the source code, to protect it from attackers. Where it was the case, the found vulnerabilities were verified using the B2B and B2C Demo Shops. See the [Demo shops](/docs/scos/user/about-spryker/201811.0/demo-shops.html) article for more details.
