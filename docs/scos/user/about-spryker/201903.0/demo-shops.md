...
originalLink: https://documentation.spryker.com/v2/docs/demoshops
originalArticleId: 9aba1d55-aa04-4ba1-8801-275bff6937dc
redirect_from:
  - /v2/docs/demoshops
...
As of the [November release](/docs/scos/user/about-spryker/201903.0/releases/release-notes/release-notes-2018.11.0/release-notes-2018.11.0.html), we offer two types of demo shops:
...
To install the B2B Demo Shop, follow the instructions of the [B2B Demo Shop Installation Guide](/docs/scos/dev/developer-guides/201903.0/installation/b2c-demo-shop-installation-guide.html){target="_blank"}.
...
To install the B2C Demo Shop, follow the instructions of the [B2C Demo Shop Installation Guide](https://documentation.spryker.com/v2/docs/b2b-b2c-demo-shop-installation-mac-os-or-linux-with-devvm){target="_blank"}.
