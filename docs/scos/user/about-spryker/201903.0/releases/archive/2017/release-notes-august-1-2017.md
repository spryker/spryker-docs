...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-august-1-2017
originalArticleId: fcf3468e-8b6a-431e-b74b-7bc421acdc40
redirect_from:
  - /v2/docs/release-notes-august-1-2017
  - /v2/docs/en/release-notes-august-1-2017
---
...
**Documentation**
For module documentation, see [Shipment Module Guide](https://documentation.spryker.com/v2/docs/shipment-module-overview).
...
For guidelines and documentation, see [Code Architecture Guide](/docs/scos/dev/developer-guides/201903.0/development-guide/guidelines/coding-guidelines/code-architecture-guide.html).
...
* [Authorization and Preauthorization-Capture Flows](/docs/scos/dev/technology-partners/201903.0/payment-partners/bs-payone/legacy-demoshop-integration/payone-authorization-and-preauthorization-capture-flows.html)
* [PayPal Express Checkout Payment - Payone](/docs/scos/dev/technology-partners/201903.0/payment-partners/bs-payone/legacy-demoshop-integration/payone-paypal-express-checkout-payment.html)
