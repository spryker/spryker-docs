...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-august-2-2017
originalArticleId: d5af62d0-5652-42d7-a503-0468aa87086f
redirect_from:
  - /v2/docs/release-notes-august-2-2017
  - /v2/docs/en/release-notes-august-2-2017
---
...
**Documentation**
For detailed migration guides, see [Sales Module Guide from Version 6.* to 7.*](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-sales.html#upgrading-from-version-6---to-version-7--).
...
To enable this change, please adjust `\Pyz\Zed\Calculation\CalculationDependencyProvider::getQuoteCalculatorPluginStack` according to [Calculation Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-calculation.html). Place `InitialGrandTotalCalculatorPlugin()` in the right sequence.
...
* [Fact-Finder - Campaigns](/docs/scos/dev/technology-partners/201903.0/marketing-and-conversion/analytics/fact-finder/fact-finder-campaigns.html)
* [Fact-Finder - Recommendation](/docs/scos/dev/technology-partners/201903.0/marketing-and-conversion/analytics/fact-finder/fact-finder-recommendation.html)
