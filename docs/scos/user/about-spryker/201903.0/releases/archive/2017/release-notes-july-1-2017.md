...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-july-1-2017
originalArticleId: 260bf809-61f6-496a-adee-a8d7fad81988
redirect_from:
  - /v2/docs/release-notes-july-1-2017
  - /v2/docs/en/release-notes-july-1-2017
---
...
**Documentation**
For integration guides, see [Cart Integration](/docs/scos/dev/migration-and-integration/201903.0/feature-integration-guides/cart-integration.html). 
...
**Documentation**
For relevant documentation, see [CMS Block](/docs/scos/dev/features/201903.0/cms/cms-block/cms-block.html).

For detailed migration guides, see [CMS Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-cms.html), [CMS Block Migration Console](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-cms.html-block-category-connector-console)
...
**Documentation**
For relevant documentation, see [File System File Manager Module Guide](https://documentation.spryker.com/v2/docs/file-system), [Flysystem Module Guide](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-ingestion/structural-preparations/flysystem.html)
...
**Documentation**
For relevant documentation, see [Product Label Module Guide](/docs/scos/dev/features/201903.0/product-management/product-label.html), [Discount Module Guide](/docs/scos/dev/features/201903.0/promotions-and-discounts/discount/discount.html)
...
**Documentation**
For module documentation, see [Payment Module Guide](/docs/scos/dev/features/201903.0/payment/payment.html)
For detailed migration guides, see [Payment Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-payment.html)
