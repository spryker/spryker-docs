...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-july-2-2017
originalArticleId: ded15117-e2f6-4125-9576-48265ce628e4
redirect_from:
  - /v2/docs/release-notes-july-2-2017
  - /v2/docs/en/release-notes-july-2-2017
---
...
**Documentation**
For module documentation, see [Product Label Module Guide](/docs/scos/dev/features/201903.0/product-management/product-label.html)
For detailed migration guides, see [Product Label Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-product-label.html).
...
**Documentation**
For module documentation, see [HowTo - Import Data](/docs/scos/dev/developer-guides/201903.0/development-guide/back-end/data-manipulation/data-ingestion/data-importers/creating-a-data-importer.html).
...
**Documentation**
For module documentation and integration guides, see [ProductNew Module Guide](/docs/scos/dev/features/201903.0/product-management/new-products.html)
...
* [CMS Block Category Connector Module Guide](/docs/scos/dev/features/201903.0/cms/cms.html-block-category-connector)
* [Content Management Module Guide](/docs/scos/dev/features/201903.0/cms/cms.html)

For migration guides, see: 

* [Category Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-category.html) 
* [CMS Block Category Connector Migration Guide](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-cms-block-category-connector.html)
* Category Template Migration Console <!-- add a link -->
* [CMS Block Category Connector Migration Console](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-cms-block-category-connector.html-console)
