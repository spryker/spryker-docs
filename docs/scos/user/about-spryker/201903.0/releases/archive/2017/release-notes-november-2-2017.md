...
originalLink: https://documentation.spryker.com/v2/docs/release-notes-november-2-2017
originalArticleId: 79b8530b-9fe4-4000-898e-9487714d810e
redirect_from:
  - /v2/docs/release-notes-november-2-2017
  - /v2/docs/en/release-notes-november-2-2017
---
...
For detailed migration guides, see [Customer Module Migration Guide from Version 6. to 7](/docs/scos/dev/migration-and-integration/201903.0/module-migration-guides/migration-guide-customer.html#upgrading-from-version-6---to-version-7-0).
...
* [Payment Integration - BS Payone - 1.1](/docs/scos/dev/technology-partners/201903.0/payment-partners/bs-payone/bs-payone.html) 
* Integration With Project - Payone
* [PayPal Express Checkout Payment - Payone - 1.1](https://documentation.spryker.com/v2/docs/payone-paypal-express-checkout-payment-1)
 
