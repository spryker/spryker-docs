...
originalArticleId: 30333f60-1e54-4aec-8811-972159ba824e
redirect_from:
...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/v2/docs/availability-notification).
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v2/docs/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/dev/features/201903.0/catalog-management/category-management/category-management.html).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v2/docs/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v2/docs/cms-pages-in-search-results-overview).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/201903.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/201903.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](/docs/scos/dev/features/201903.0/sdk/development-tools/phpstan.html).
...
**Documentation**: [Spryk](/docs/scos/dev/features/201903.0/sdk/spryk-code-generator.html).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/v2/docs/quick-add-to-cart).
...
**Documentation**: [Checkout](/docs/scos/user/user-guides/201903.0/shop-user-guide/checkout/shop-guide-checkout.html), [Business on Behalf](/docs/scos/dev/features/201903.0/company-account-management/business-on-behalf/business-on-behalf.html), [Reclamations](/docs/scos/dev/features/201903.0/order-management/reclamations/reclamations.html).
