...
originalLink: https://documentation.spryker.com/v2/docs/understanding-spryker
originalArticleId: bdb5fa8c-f39b-4b49-b28a-b6224250231e
redirect_from:
...
If you would like to see our Shop App in action, check out our [live demo](https://now.spryker.com/en/demoshop), watch one of our feature [videos](/docs/scos/user/about-spryker/201903.0/videos-and-webinars/spryker-videos.html){target="_blank"} of check out our feature list:
...
* If you would like to check out past release visit our [release notes](/docs/scos/user/about-spryker/201903.0/releases/release-notes/release-notes.html){target="_blank"} section and archive.
