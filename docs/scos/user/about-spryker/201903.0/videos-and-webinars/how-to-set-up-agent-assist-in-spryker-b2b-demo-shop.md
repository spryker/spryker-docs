...
originalArticleId: c1065bff-3f99-44d5-9e34-d172acb4f3bd
redirect_from:
  - /v2/docs/how-to-setup-agent-assist-b2b
  - /v2/docs/en/how-to-setup-agent-assist-b2b
---

In this video we explain how to set up [Agent Assist](/docs/scos/dev/features/201903.0/company-account-management/agent-assist/agent-assist.html){target="_blank"} in Spryker [B2B Demo Shop](/docs/scos/user/about-spryker/201903.0/demo-shops.html#b2b-demo-shop):
