...
originalArticleId: 20a128c1-30cd-4e31-ab68-fb54e6b5cb0b
redirect_from:
...
The evaluation of the Commerce OS was done without having prior knowledge of the source code, to protect it from attackers. Where it was the case, the found vulnerabilities were verified using the B2B and B2C Demo Shops. See the [Demo shops](/docs/scos/user/about-spryker/201903.0/demo-shops.html) article for more details.
