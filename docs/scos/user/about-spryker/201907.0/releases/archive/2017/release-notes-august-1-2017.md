...
originalLink: https://documentation.spryker.com/v3/docs/release-notes-august-1-2017
originalArticleId: 108ca581-1685-4e3a-83c1-539bbe479392
redirect_from:
  - /v3/docs/release-notes-august-1-2017
  - /v3/docs/en/release-notes-august-1-2017
---
...
**Documentation**
For module documentation, see [Shipment Module Guide](https://documentation.spryker.com/v3/docs/shipment-module-overview).
...
For guidelines and documentation, see [Code Architecture Guide](/docs/scos/dev/developer-guides/201907.0/development-guide/guidelines/coding-guidelines/code-architecture-guide.html).
...
* [Authorization and Preauthorization-Capture Flows](/docs/scos/dev/technology-partners/201907.0/payment-partners/bs-payone/legacy-demoshop-integration/payone-authorization-and-preauthorization-capture-flows.html)
* [PayPal Express Checkout Payment - Payone](/docs/scos/dev/technology-partners/201907.0/payment-partners/bs-payone/legacy-demoshop-integration/payone-paypal-express-checkout-payment.html)
