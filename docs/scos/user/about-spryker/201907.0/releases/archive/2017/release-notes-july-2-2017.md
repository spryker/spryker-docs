...
originalLink: https://documentation.spryker.com/v3/docs/release-notes-july-2-2017
originalArticleId: 74359260-55d6-4f8e-b174-145f1c1400f8
redirect_from:
  - /v3/docs/release-notes-july-2-2017
  - /v3/docs/en/release-notes-july-2-2017
---
...
**Documentation**
For module documentation, see [Product Label Module Guide](/docs/scos/dev/features/201907.0/product-management/product-label.html)
For detailed migration guides, see [Product Label Migration Guide](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-product-label.html).
...
**Documentation**
For module documentation, see [HowTo - Import Data](/docs/scos/dev/developer-guides/201907.0/development-guide/back-end/data-manipulation/data-ingestion/data-importers/creating-a-data-importer.html).
...
**Documentation**
For module documentation and integration guides, see [ProductNew Module Guide](/docs/scos/dev/features/201907.0/product-management/new-products.html)
...
* [Category Migration Guide](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-category.html) 
* [CMS Block Category Connector Migration Guide](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-cms-block-category-connector.html)
* Category Template Migration Console <!-- add a link -->
* [CMS Block Category Connector Migration Console](/docs/scos/dev/migration-and-integration/201907.0/module-migration-guides/migration-guide-cms-block-category-connector.html-console)
