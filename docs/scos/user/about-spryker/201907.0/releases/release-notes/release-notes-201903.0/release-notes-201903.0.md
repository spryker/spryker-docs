...
originalLink: https://documentation.spryker.com/v3/docs/release-notes-201903-0
originalArticleId: d2f58ca6-7a21-4b58-b3bf-2cd7079d940b
redirect_from:
...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/v3/docs/availability-notification).
...
**Documentation**: [Discount](/docs/scos/dev/features/201907.0/promotions-and-discounts/discount/discount.html). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v3/docs/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/dev/features/201907.0/catalog-management/category-management/category-management.html).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v3/docs/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v3/docs/cms-pages-in-search-results-overview).
...
**Documentation**: [Assigning a Template for a Category Page](/docs/scos/user/user-guides/201907.0/back-office-user-guide/category/category.html)
...
**Documentation**: [CMS Block widget](https://documentation.spryker.com/v3/docs/content-widgets)
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/201907.0/development-guide/back-end/data-manipulation/data-enrichment/session-handlers.html).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/201907.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/201907.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](/docs/scos/dev/features/201907.0/sdk/development-tools/phpstan.html).
...
**Documentation**: [Spryk](/docs/scos/dev/features/201907.0/sdk/spryk-code-generator.html).
...
**Documentation**: [Retrieving Related Products](/docs/scos/dev/glue-api/201907.0/glue-api-storefront-guides/managing-products/retrieving-related-products.html).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](https://documentation.spryker.com/v3/docs/retrieving-navigation-trees-201903).
...
**Documentation**: [Retrieving Alternative Products](/docs/scos/dev/glue-api/201907.0/glue-api-storefront-guides/managing-products/retrieving-alternative-products.html).
...
**Documentation**: [Configuring Visibility of the Included Section](/docs/scos/dev/tutorials/201907.0/howtos/glue-api-howtos/configuring-visibility-of-the-included-section.html).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/v3/docs/quick-add-to-cart).
...
**Documentation**: [Approval Process](https://documentation.spryker.com/v3/docs/approval-process-201903).
...
**Documentation**: [Checkout](https://documentation.spryker.com/v3/docs/delivery-address-step-shop-guide), [Business on Behalf](/docs/scos/dev/features/201907.0/company-account-management/business-on-behalf/business-on-behalf.html), [Reclamations](/docs/scos/dev/features/201907.0/order-management/reclamations/reclamations.html).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/201907.0/payment-partners/heidelpay/heidelpay-split-payment-marketplace.html).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/201907.0/payment-partners/adyen/adyen.html).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/201907.0/payment-partners/afterpay/afterpay.html).

Check out [Documentation Updates](/docs/scos/user/about-spryker/201907.0/whats-new/documentation-updates.html) for all the updates to documentation made with this release. 
