...
originalArticleId: 9ba478a0-5ca2-4d0e-9460-e73864598f93
redirect_from:
...
If you would like to see our Shop App in action, check out our [live demo](https://now.spryker.com/en/demoshop), watch one of our feature [videos](/docs/scos/user/about-spryker/201907.0/videos-and-webinars/spryker-videos.html){target="_blank"} of check out our feature list:
...
* If you would like to check out past release visit our [release notes](/docs/scos/user/about-spryker/201907.0/releases/release-notes/release-notes.html){target="_blank"} section and archive.
