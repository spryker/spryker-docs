...
originalArticleId: 64c2ec4d-4a11-4838-a005-fce424bc7054
redirect_from:
...
{% info_block infoBox %}
This month we released some important [security updates](/docs/scos/user/about-spryker/202001.0/whats-new/security-updates.html
{% endinfo_block %}.)
...
For detailed migration guides, see [Shipment Module Migration Guide from Version 5. to 6](/docs/scos/dev/migration-and-integration/202001.0/module-migration-guides/migration-guide-shipment.html#upgrading-from-version-5---to-version-6--).
...
**Documentation**
For detailed migration guides, see [RabbitMQ Module Migration Guide from Version 0. to 1](/docs/scos/dev/migration-and-integration/202001.0/module-migration-guides/migration-guide-rabbitmq.html#upgrading-from-version-0---to-version-1--).
