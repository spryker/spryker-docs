...
originalLink: https://documentation.spryker.com/v4/docs/release-notes-september-2-2017
originalArticleId: da17fd6d-cac8-4723-aa82-b442055cdf5e
redirect_from:
  - /v4/docs/release-notes-september-2-2017
  - /v4/docs/en/release-notes-september-2-2017
---
...
**Documentation**
For detailed migration guides, see [Currency Module Migration Guide from Version 2. to 3](/docs/scos/dev/migration-and-integration/202001.0/module-migration-guides/migration-guide-currency.html#upgrading-from-version-2---to-version-3--).
