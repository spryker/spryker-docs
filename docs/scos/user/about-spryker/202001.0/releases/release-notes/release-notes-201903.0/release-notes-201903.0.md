...
originalArticleId: 15e58657-1917-4a56-b283-c720786d4ba3
redirect_from:
...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/v4/docs/availability-notification).
...
**Documentation**: [Discount](/docs/scos/dev/features/202001.0/promotions-and-discounts/discount/discount.html). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v4/docs/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/dev/features/202001.0/catalog-management/category-management/category-management.html).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v4/docs/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v4/docs/cms-pages-in-search-results-overview).
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/202001.0/development-guide/back-end/data-manipulation/data-enrichment/session-handlers.html).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/202001.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](/docs/scos/dev/features/202001.0/sdk/development-tools/phpstan.html).
...
**Documentation**: [Spryk](/docs/scos/dev/features/202001.0/sdk/spryk-code-generator.html).
...
**Documentation**: [Retrieving Related Products](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-products/retrieving-related-products.html).
...
**Documentation**: [Retrieving Alternative Products](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-products/retrieving-alternative-products.html).
...
**Documentation**: [Configuring Visibility of the Included Section](/docs/scos/dev/tutorials/202001.0/howtos/glue-api-howtos/configuring-visibility-of-the-included-section.html).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/v4/docs/quick-add-to-cart).
...
**Documentation**: [Checkout](/docs/scos/user/user-guides/202001.0/shop-user-guide/shop-guide-checkout/shop-guide-address-step.html), [Business on Behalf](/docs/scos/dev/features/202001.0/company-account-management/business-on-behalf/business-on-behalf.html), [Reclamations](/docs/scos/dev/features/202001.0/order-management/reclamations/reclamations.html).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/202001.0/payment-partners/heidelpay/heidelpay-split-payment-marketplace.html).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/202001.0/payment-partners/adyen/adyen.html).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/202001.0/payment-partners/afterpay/afterpay.html).
