...
originalLink: https://documentation.spryker.com/v4/docs/release-notes-201907-0
originalArticleId: 7a472b02-f345-4893-95db-7ae61cddaef9
redirect_from:
...
**Documentation:**
Feature documentation: [Gift Cards](https://documentation.spryker.com/v4/docs/gift-card)
...
**Documentation**: [Scheduled Prices](/docs/scos/dev/features/202001.0/price/scheduled-prices/scheduled-prices.html)
...
**Documentation**: [Product Image Management](https://documentation.spryker.com/v4/docs/product-images-overview)
***
## CMS
### CMS Content Items
...
* [Content Item Widgets](https://documentation.spryker.com/v4/docs/content-item-widgets-201907)
***
...
**Documentation**: [B2B Logging in as Company User](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/logging-in-as-company-user.html)
...
* [Retrieving Company Information](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/retrieving-company-information.html)
* [Retrieving Business Unit Information](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/retrieving-business-unit-information.html)
* [Retrieving Company User Information](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/retrieving-company-user-information.html)
* [Retrieving Company Role Information](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/retrieving-company-role-information.html)
...
* [Security and Authentication](/docs/scos/dev/glue-api/202001.0/glue-api-developer-guides/security-and-authentication.html)
* [B2B Logging in as Company User](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/logging-in-as-company-user.html)
* [Retrieving Company Role Information](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/b2b-account-management/retrieving-company-role-information.html)
...
**Documentation**: [Managing Carts of Registered Users](https://documentation.spryker.com/v4/docs/managing-carts-of-registered-users)
...
**Documentation**: [Shared Carts API](/docs/scos/dev/glue-api/202001.0/glue-api-storefront-guides/managing-carts/sharing-company-user-carts.html)
...
* [B2B-B2C Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/v4/docs/checking-out-purchases-and-getting-checkout-data)
...
**Documentation**: [Spryker in Docker](https://documentation.spryker.com/v4/docs/spryker-in-docker-201907)
***
## B2B
### Request for Quote
...
**Documentation**: [Request for Quote](https://documentation.spryker.com/v4/docs/quotation-process) 
...
**Documentation**: [Punchout](https://documentation.spryker.com/v4/docs/punchout-201907)
...
**Documentation**: [Comments](/docs/scos/dev/features/202001.0/mailing-and-communication/comments/comments.html)
...
**Documentation**: [Unique URL per Cart for Easy Sharing](https://documentation.spryker.com/v4/docs/resource-sharing-feature-overview)
...
* Vault - We introduce the Vault place where you can store valuable information and get it from there by ID in an encrypted form and vice versa
    **Documentation**: [Vault for Tokens](https://documentation.spryker.com/v4/docs/vault-for-tokens-overview)

* Customer Login by Token - Ability to log in to the Spryker Commerce OS by token
    **Documentation**: [Customer Login by Token](https://documentation.spryker.com/v4/docs/customer-login-by-token-overview)
...
**Documentation**: [Payone - Cash on Delivery](/docs/scos/dev/technology-partners/202001.0/payment-partners/bs-payone/scos-integration/payone-cash-on-delivery.html)
...
**Documentation**: [Heidelpay - Easy Credit](/docs/scos/dev/technology-partners/202001.0/payment-partners/heidelpay/heidelpay-easy-credit.html)
...
**Documentation**: [Episerver](/docs/scos/dev/technology-partners/202001.0/marketing-and-conversion/customer-communication/episerver/episerver.html) 
...
**Documentation**: [Ratenkauf by Easycredit - Installation and Configuration](/docs/scos/dev/technology-partners/202001.0/payment-partners/ratenkauf-by-easycredit/ratenkauf-by-easycredit-installation-and-configuration.html)
...
**Documentation**: [CrefoPay](/docs/scos/dev/technology-partners/202001.0/payment-partners/crefopay/crefopay-installation-and-configuration.html) 
...
 
Check out [Documentation Updates](/docs/scos/user/about-spryker/202001.0/whats-new/documentation-updates.html) for all the updates to documentation made with this release. 
