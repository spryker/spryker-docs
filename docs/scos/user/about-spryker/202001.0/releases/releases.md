...
originalArticleId: 8aade3b4-a1f4-486d-8558-b17eefa3c052
redirect_from:
  - /v4/docs/releases
  - /v4/docs/en/releases
---

This section contains the notes for each [Product release](/docs/scos/user/about-spryker/202001.0/spryker-release-process.html#product-releases) made by Spryker. Make sure that you check this section from time-to-time to stay up to date with the improvements, bug fixes and new features that are delivered by our team.
...
* [Release notes](/docs/scos/user/about-spryker/202001.0/releases/release-notes/release-notes.html)
