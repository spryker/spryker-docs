...
originalArticleId: 637dc4e3-dad3-4778-98b6-a57c4cc00d04
redirect_from:
...
If you would like to see our Shop App in action, check out our [live demo](https://now.spryker.com/en/demoshop), watch one of our feature [videos](/docs/scos/user/about-spryker/202001.0/videos-and-webinars/spryker-videos.html){target="_blank"} of check out our feature list:
...
* If you would like to check out past release visit our [release notes](/docs/scos/user/about-spryker/202001.0/releases/release-notes/release-notes.html){target="_blank"} section and archive.
