...
originalLink: https://documentation.spryker.com/v4/docs/security-audit
originalArticleId: 96bc93b8-bf78-400e-bf87-4b4d56cd26bd
redirect_from:
...
The evaluation of the Commerce OS was done without having prior knowledge of the source code, to protect it from attackers. Where it was the case, the found vulnerabilities were verified using the B2B and B2C Demo Shops. See the [Demo shops](/docs/scos/user/about-spryker/202001.0/about-spryker.html#spryker-b2b-b2c-demo-shops) article for more details.
