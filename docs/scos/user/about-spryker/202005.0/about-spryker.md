...
originalLink: https://documentation.spryker.com/v5/docs/about-spryker
originalArticleId: 12ac590a-c4ec-4e01-b626-3aba8f6780f3
redirect_from:
...
The modules combine to create [features](/docs/scos/dev/features/202005.0/about-features.html) and have limited dependencies. The limited dependencies imply less development effort, increasing your return on investment and lowering the total cost of ownership.
...
* [What's new](/docs/scos/user/about-spryker/202005.0/whats-new/whats-new.html): general information about Spryker, news, and release notes.
