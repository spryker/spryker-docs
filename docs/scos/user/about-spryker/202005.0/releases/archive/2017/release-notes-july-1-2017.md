...
originalArticleId: fa6d7d0e-50cb-401b-a82b-add6557f0dd9
redirect_from:
...
**Documentation**
For integration guides, see [Cart Integration](/docs/scos/dev/migration-and-integration/202005.0/feature-integration-guides/cart-integration.html). 
...
**Documentation**
For relevant documentation, see [CMS Block](/docs/scos/dev/features/202005.0/cms/cms-block/cms-block.html).

For detailed migration guides, see [CMS Migration Guide](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-cms.html), [CMS Block Migration Console](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-cms.html-block-category-connector-console)
...
**Documentation**
For relevant documentation, see [Product Label Module Guide](/docs/scos/dev/features/202005.0/product-information-management/product-label.html), [Discount Module Guide](/docs/scos/dev/features/202005.0/promotions-and-discounts/discount/discount.html)
...
**Documentation**
For module documentation, see [Payment Module Guide](/docs/scos/dev/features/202005.0/payment/payment.html)
For detailed migration guides, see [Payment Migration Guide](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-payment.html)
