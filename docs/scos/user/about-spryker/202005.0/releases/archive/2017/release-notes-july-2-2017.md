...
originalArticleId: 6e1636f9-b547-44fe-8d09-44e063e2539f
redirect_from:
...
**Documentation**
For module documentation, see [Product Label Module Guide](/docs/scos/dev/features/202005.0/product-information-management/product-label.html)
For detailed migration guides, see [Product Label Migration Guide](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-productlabel.html).
...
**Documentation**
For module documentation, see [HowTo - Import Data](/docs/scos/dev/developer-guides/202005.0/development-guide/data-import/creating-a-data-importer.html).
...
**Documentation**
For module documentation and integration guides, see [ProductNew Module Guide](/docs/scos/dev/features/202005.0/product-information-management/new-products.html)
...
* [Category Migration Guide](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-category.html) 
* [CMS Block Category Connector Migration Guide](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-cms-block-category-connector.html)
* Category Template Migration Console <!-- add a link -->
* [CMS Block Category Connector Migration Console](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-cms-block-category-connector.html-console)
