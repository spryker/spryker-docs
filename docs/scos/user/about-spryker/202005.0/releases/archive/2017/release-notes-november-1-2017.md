...
originalLink: https://documentation.spryker.com/v5/docs/release-notes-november-1-2017
originalArticleId: cef88e29-898c-4aed-8800-7049136a2627
redirect_from:
  - /v5/docs/release-notes-november-1-2017
  - /v5/docs/en/release-notes-november-1-2017
---

{% info_block infoBox %}
This month we released some important [security updates](/docs/scos/user/about-spryker/202005.0/whats-new/security-updates.html
{% endinfo_block %}.)
...
For detailed migration guides, see [Shipment Module Migration Guide from Version 5. to 6](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-shipment.html#upgrading-from-version-5---to-version-6--).
For store administration guides, see Shipment Store Administration Guide<!--/administration_interface_guide/shipment.htm)-->
For other related documentation, see [HowTo - Add New Shipment Method](/docs/scos/dev/tutorials/202005.0/howtos/howto-add-a-new-shipment-method-2.0.html)
...
**Documentation**
For detailed migration guides, see [RabbitMQ Module Migration Guide from Version 0. to 1](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-rabbitmq.html#upgrading-from-version-0---to-version-1--).
...
* [Queue Integration - Loggly](/docs/scos/dev/technology-partners/202005.0/operational-tools-monitoring-legal-etc/loggly.html)
* [Payolution — Configuration](/docs/scos/dev/technology-partners/202005.0/payment-partners/payolution/payolution-installation-and-configuration.html)
* [Payolution — Workflow](/docs/scos/dev/technology-partners/202005.0/payment-partners/payolution/payolution-workflow.html)
