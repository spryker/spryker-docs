...
originalLink: https://documentation.spryker.com/v5/docs/release-notes-september-2-2017
originalArticleId: 2d927e4e-fb47-4a07-810e-e69d756dd95a
redirect_from:
  - /v5/docs/release-notes-september-2-2017
  - /v5/docs/en/release-notes-september-2-2017
---
...
**Documentation**
For module documentation, see [Discount Module Guide](/docs/scos/dev/features/202005.0/promotions-and-discounts/discount/discount.html), Extending the Discount Module, [Discount Promotions](/docs/scos/dev/features/202005.0/promotions-and-discounts/promotions-and-discounts.html).
...
For feature integration, see [Feature Integration - Product Reviews](/docs/scos/dev/migration-and-integration/202005.0/feature-integration-guides/product-reviews-feature-integration.html).
...
**Documentation**
For detailed migration guides, see [Currency Module Migration Guide from Version 2. to 3](/docs/scos/dev/migration-and-integration/202005.0/module-migration-guides/migration-guide-currency.html#upgrading-from-version-2---to-version-3--).
