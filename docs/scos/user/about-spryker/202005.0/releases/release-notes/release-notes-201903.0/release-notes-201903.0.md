...
originalArticleId: d70f2d07-02e9-4abb-b9db-f07ad5fb709f
redirect_from:
...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/v5/docs/en/availability-notification).
...
**Documentation**: [Discount](/docs/scos/dev/features/202005.0/promotions-and-discounts/discount/discount.html). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v5/docs/en/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/dev/features/202005.0/catalog-management/category-management/category-management.html).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v5/docs/en/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v5/docs/en/cms-pages-in-search-results-overview).
...
**Documentation**: [Assigning a Template for a Category Page](/docs/scos/user/user-guides/202005.0/back-office-user-guide/catalog/category/category.html)
...
**Documentation**: [CMS Block widget](https://documentation.spryker.com/v5/docs/en/content-widgets)
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/202005.0/development-guide/back-end/data-manipulation/data-enrichment/session-handlers.html).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/features/202005.0/sdk/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/features/202005.0/sdk/development-tools/architecture-sniffer.html), [PHPStan](/docs/scos/dev/features/202005.0/sdk/development-tools/phpstan.html).
...
**Documentation**: [Spryk](/docs/scos/dev/features/202005.0/sdk/spryk-code-generator.html).
...
**Documentation**: [Retrieving Related Products](https://documentation.spryker.com/v5/docs/en/retrieving-related-products-201903).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](https://documentation.spryker.com/v5/docs/en/retrieving-navigation-trees-201903).
...
**Documentation**: [Retrieving Alternative Products](/docs/scos/dev/glue-api-guides/202005.0/managing-products/retrieving-alternative-products.html).
...
**Documentation**: [Configuring Visibility of the Included Section](/docs/scos/dev/tutorials/202005.0/howtos/glue-api-howtos/configuring-visibility-of-the-included-section.html).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/v5/docs/en/quick-add-to-cart).
...
**Documentation**: [Approval Process](https://documentation.spryker.com/v5/docs/en/approval-process-201903).
...
**Documentation**: [Checkout](/docs/scos/user/user-guides/202005.0/shop-user-guide/shop-guide-checkout/shop-guide-address-step.html), [Business on Behalf](/docs/scos/dev/features/202005.0/company-account-management/business-on-behalf/business-on-behalf.html), [Reclamations](/docs/scos/dev/features/202005.0/order-management/reclamations/reclamations.html).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/202005.0/payment-partners/heidelpay/heidelpay-split-payment-marketplace.html).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/202005.0/payment-partners/adyen/adyen.html).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/202005.0/payment-partners/afterpay/afterpay.html).
