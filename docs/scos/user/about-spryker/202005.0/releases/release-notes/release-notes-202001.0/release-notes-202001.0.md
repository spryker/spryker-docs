...
originalArticleId: eac3de7f-5c83-487d-a309-01e8a9c8e85a
redirect_from:
...
* [Creating Scheduled Prices in the Back Office](https://documentation.spryker.com/v5/docs/en/creating-scheduled-prices-201907)
* [Managing Scheduled Prices in the Back Office](/docs/scos/user/user-guides/202005.0/back-office-user-guide/catalog/scheduled-prices/managing-scheduled-prices.html)
...
* [Warehouse Management](/docs/scos/dev/features/202005.0/inventory-management/warehouse-management.html)
* [Managing Payment Methods in the Back Office](/docs/scos/user/user-guides/202005.0/back-office-user-guide/administration/payment-methods/managing-payment-methods.html)
* [Managing Delivery Methods in the Back Office](/docs/scos/user/user-guides/202005.0/back-office-user-guide/administration/delivery-methods/creating-and-managing-delivery-methods.html)
...
#### Documentation
[Templates and Slots](/docs/scos/dev/features/202005.0/cms/templates-and-slots/templates-and-slots.html)
***
## B2B
...
#### Documentation
[Discounts API](/docs/scos/dev/glue-api-guides/202005.0/discounts-and-promotions/retrieving-discounts.html) 
...
* [Getting Started with Docker](/docs/scos/dev/developer-guides/202005.0/installation/spryker-in-docker/getting-started-with-docker.html#running-production)
* [Deploy File Reference](/docs/scos/dev/developer-guides/202005.0/installation/spryker-in-docker/docker-sdk/deploy-file-reference-1.0.html)
* [Spryker in Docker Services](/docs/scos/dev/developer-guides/202005.0/installation/spryker-in-docker/configuration/services.html)
...
#### Documentation: 
[Search Migration Guides](/docs/scos/dev/migration-and-integration/202005.0/migration-concepts/search-migration-concept/search-migration-concept.html)
...
#### Documentation
[HowTo - Disable Key-value Storage and use the Database Instead](/docs/scos/dev/tutorials/202005.0/howtos/howto-disable-key-value-storage-and-use-the-database-instead.html)
...
#### Documentation:
[Silex Migration Guides](/docs/scos/dev/migration-and-integration/202005.0/migration-concepts/silex-replacement/silex-replacement.html)
...
#### Documentation:
[Tutorial - Handling Data - Publish and Synchronization - Spryker Commerce OS](/docs/scos/dev/tutorials/202005.0/introduction/tutorial-handling-data-publish-and-synchronization-spryker-commerce-os.html#7--queue)
...
#### Documentation
[Search Initialization Improvement](/docs/scos/dev/migration-and-integration/202005.0/technical-enhancements/search-initialization-improvement.html)
