...
originalArticleId: f5a43905-491b-4de8-85df-706500511430
redirect_from:
...
Check out our Security Release notes in the [Release Notes](/docs/scos/user/about-spryker/202005.0/releases/release-notes/release-notes.html) article for each respective release.
