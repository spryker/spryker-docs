...
redirect_from:
  ...
  - /docs/scos/user/back-office-user-guides/201811.0/products/products/managing-products/creating-and-managing-product-bundles.html
related:
...
2. On the **Create a Product** page, do the procedure described in the [Creating an Abstract Product](/docs/scos/user/back-office-user-guides/{{page.version}}/catalog/products/manage-abstract-products/creating-abstract-products-and-product-bundles.html) article:
