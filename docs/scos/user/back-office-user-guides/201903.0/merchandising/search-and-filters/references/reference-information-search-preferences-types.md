...
originalLink: https://documentation.spryker.com/v2/docs/search-preferences-types
originalArticleId: ce1cfed7-2703-4739-85e9-f4216e504355
redirect_from:
  - /v2/docs/search-preferences-types
  - /v2/docs/en/search-preferences-types
  - /docs/scos/user/back-office-user-guides/201903.0/merchandising/search-and-filters/references/search-preferences-types.html
---
...
Suppose, you have created the _video_recording_ attribute in your shop with the values **Geotagging** and **Autofocus**.
