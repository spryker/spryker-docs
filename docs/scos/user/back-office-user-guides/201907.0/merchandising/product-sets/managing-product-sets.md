...
originalLink: https://documentation.spryker.com/v3/docs/managing-product-sets
originalArticleId: 02a02a64-ecb5-476b-8a9f-96651d47d99f
redirect_from:
  - /v3/docs/managing-product-sets
  - /v3/docs/en/managing-product-sets
related:
  ...
  - title: Creating Product Sets
    link: docs/scos/user/back-office-user-guides/201907.0/merchandising/product-sets/creating-product-sets.html
---
...
The attributes you see are described in the _Product Sets: Reference Information_.
{% endinfo_block %}
