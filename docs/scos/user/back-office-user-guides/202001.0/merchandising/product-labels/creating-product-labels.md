...
originalArticleId: 02c24f96-b479-48bd-9dc5-7b92a43acfaf
redirect_from:
...
2. On the **Overview of Product Label** page, click **Activate** in the _Actions_ column.
...
* To learn more about the attributes you select and enter while creating or managing the labels or see some examples of product labels, see [Product Labels: Reference Information](/docs/scos/user/back-office-user-guides/{{page.version}}/merchandising/product-labels/references/product-labels-reference-information.html).
