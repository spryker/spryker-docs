...
1. On the **Overview of Discounts** page, click **Add code** in the _Actions_ column.
    ...
    Follow the steps described in [Creating a Discount Voucher](/docs/pbc/all/discount-management/{{page.version}}/base-shop/manage-in-the-back-office/create-discounts.html#creating-a-voucher).
