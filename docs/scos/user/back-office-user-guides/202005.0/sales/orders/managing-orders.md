...
## Creating Returns
If a sales order item is[ returnable](docs/scos/user/features/{{page.version}}/return-management-feature-overview/return-management-feature-overview.md.html), you can create a return for it.
