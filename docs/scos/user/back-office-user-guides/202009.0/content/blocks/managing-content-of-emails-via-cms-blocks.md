...
If you updated the **name**, pass it to your development team to update the name of the respective [.twig email template](https://documentation.spryker.com/v6/docs/en/email-as-a-cms-block-overview). 
