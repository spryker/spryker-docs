...
originalLink: https://documentation.spryker.com/v6/docs/customers-reference-information
originalArticleId: 4d55b2a9-aa99-40cb-8121-763adfb3cbdc
redirect_from:
  - /v6/docs/customers-reference-information
  - /v6/docs/en/customers-reference-information
---

This topic contains the reference information for working with Customers in the **Customers** section.
***
## Customers page
...
* Customer last name
* Customer first name
* Status of the customer (can either be *Unverified* or *Verified*)
* The actions that you can perform on a customer record (**View**, **Edit**, and for B2B only: **Attach to company**)
