...
You can not just add or update a glossary key without using it in code; otherwise, the translation is not applied. Therefore, if you need to add a new translation, ask a developer to apply the glossary key and its translation values in code as well.
