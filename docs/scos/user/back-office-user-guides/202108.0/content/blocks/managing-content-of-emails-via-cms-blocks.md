...
2. On the **Edit CMS Block: _[Block ID]_** page, you can update the **Name** or choose a different **Template**.
...
2. On the **Edit Block Glossary: _[Block ID]_** page, update the content of the email CMS block. You can use plain text to create content of the emails, or apply glossary keys and variables. See **Tips and tricks** for details.
