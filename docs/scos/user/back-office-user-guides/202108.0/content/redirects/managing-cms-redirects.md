...
1. On the **CMS Redirect** page in the **Actions** column, click **Edit** next to the URL you want to update.
...
2. On the **CMS Redirect** page in the **Actions** column, click **Delete** next to the URL you want to delete.
