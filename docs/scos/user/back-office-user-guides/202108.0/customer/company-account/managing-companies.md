...
To start managing a company record, go to **Customers&nbsp;<span aria-label="and then">></span> Companies**.
...
3. Click **Save**.
    The new created company appears in the **List of the Companies** table on the **Companies** page.

{% info_block errorBox "Important" %}

Once the company is created, one business unit for it is created by default. This is considered to be a headquarter and can be managed in the same ways as the other business units. For more details, see [Managing company units](/docs/scos/user/back-office-user-guides/{{page.version}}/customer/company-account/managing-company-units.html).

{% endinfo_block %}

The companies can be managed by triggering certain actions in the **Actions** column in the **List of Companies** table on the **Companies** page.
...
To approve a company and activate a company, do the following:
1. Click **Approve** in the **Actions** column.
    As a result, the status of the company is changed to `Approved`.
2. Click **Activate** in the **Actions** column. As a result, the activity state of the company will change from **Inactive** to **Active**.
...
You can approve and activate the record in a later event. The record itself continues existing in the system.
...
To change the name of a company, do the following:
1. Click **Edit** in the **Actions** column.
2. On the **Edit Company** page, in the **Name** file, edit the name of the company.
The updated company name is displayed in the **List of the Companies** table of the **Companies** page.
