...
2. On the **Edit Configurable Bundle Template** page:
...
1. On the **Edit Configurable Bundle Template** page, in the top right corner, select **Add Slot**.
...
1. On the **Edit Configurable Bundle Template** page, switch to the *Slots* tab.
2. Select **Edit** next to the slot you want to edit.
3. On the **Edit Slot** page:
...
1. On the **Edit Slot** page, switch to the *Assign Categories* tab.
...
1. On the **Edit Slot** page, switch to the **Assign Products** tab.
