...
Make sure the selected products are listed on the *Selected products to assign ({number of products})* tab.
...
* Below the table, click **Select All** to assign the label to all the products on the *Available products* tab.
...
On the *Products* tab, you can see the following information:
...
On the *Products* tab, you can do the following:
* View a product
