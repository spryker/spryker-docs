...
* [Create a tax set](/docs/pbc/all/tax-management/manage-taxes-in-the-back-office/create-tax-sets.html) to apply to the product options.
...
| TAX SET | Tax set to apply to the product options. To create one, see [Create tax sets](/docs/pbc/all/tax-management/manage-taxes-in-the-back-office/create-tax-sets.html). |
