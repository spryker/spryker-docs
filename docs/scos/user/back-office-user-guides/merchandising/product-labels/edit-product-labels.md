...
| IS DYNAMIC | Defines if this label is [dynamic](/docs/scos/user/features/product-labels-feature-overview.html#dynamic-product-label). Only developers can create dynamic product labels. |
