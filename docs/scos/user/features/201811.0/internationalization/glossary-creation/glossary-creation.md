...
{% info_block infoBox %}
For more details on CMS, see [Defining Maximum Size of Content Fields](/docs/scos/dev/tutorials/201811.0/howtos/feature-howtos/howto-define-maximum-size-of-content-fields.html
{% endinfo_block %}.)
