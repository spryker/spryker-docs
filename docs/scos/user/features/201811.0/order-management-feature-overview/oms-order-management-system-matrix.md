...
originalLink: https://documentation.spryker.com/v1/docs/oms-matrix
originalArticleId: 0eeea4d1-d793-41b2-ba4c-995893adbdca
redirect_from:
  - /v1/docs/oms-matrix
  - /v1/docs/en/oms-matrix
---
...
Many start ups in the eCommerce world have gone through an automation approach of their order processing as described by [Fabian Wesner](https://medium.com/@fabian.wesner) in his blog post "Introduction to Automated Order Management for E-commerce Startups".
