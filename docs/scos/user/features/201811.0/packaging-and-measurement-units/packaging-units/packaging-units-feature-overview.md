...
- In the [Quick Add to Cart](/docs/scos/user/features/{{page.version}}/quick-add-to-cart-feature-overview.html) form and [search widget](https://documentation.spryker.com/v1/docs/search-widget-for-concrete-products), the products use the default packaging units that cannot be changed. Flexible packaging units are not supported on the Quick Order page. 
