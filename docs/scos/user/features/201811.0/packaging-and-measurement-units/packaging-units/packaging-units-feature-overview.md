...
- In the [Quick Order](/docs/scos/dev/features/201811.0/shopping-cart/quick-order/quick-order.html) form and [search widget](https://documentation.spryker.com/v1/docs/search-widget-for-concrete-products), the products use the default packaging units that cannot be changed. Flexible packaging units are not supported on the Quick Order page. 
