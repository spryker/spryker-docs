...
The [Sales](/docs/scos/user/features/{{page.version}}/order-management/sales.html) module provides plugins to hydrate OrderTransfer which is called when `SalesFacade::getOrderByIdSalesOrder` invoked.
