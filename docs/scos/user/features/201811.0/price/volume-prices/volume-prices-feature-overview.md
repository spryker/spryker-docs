...
originalLink: https://documentation.spryker.com/v1/docs/volume-prices-overview
originalArticleId: bd5f06f6-f8bc-4e53-ad12-a82b1f07abba
redirect_from:
  - /v1/docs/volume-prices-overview
  - /v1/docs/en/volume-prices-overview
---
...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/dev/features/201811.0/price/prices-per-merchant-relation/prices-per-merchant-relation-customer-specific-prices.html).
