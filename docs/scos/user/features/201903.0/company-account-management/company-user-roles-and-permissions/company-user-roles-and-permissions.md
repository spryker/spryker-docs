...
originalLink: https://documentation.spryker.com/v2/docs/company-user-roles-and-permissions
originalArticleId: d2d6b281-8d0b-407d-b542-4f4adfc39309
redirect_from:
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v2/docs/company-user-roles-and-permissions-overview" class="mr-link">Familiarize yourself with the company roles, permissions and permission types</a></li>
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/v2/docs/company-user-roles-and-permissions-overview" class="mr-link">Manage company users</a></li>
                <li><a href="https://documentation.spryker.com/v2/docs/managing-company-roles" class="mr-link">Manage company roles</a></li>
            </ul>
        </div>
        </div>
</div>
