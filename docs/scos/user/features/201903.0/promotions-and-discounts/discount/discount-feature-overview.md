...
Voucher codes are generated in the Back Office > *Discount* section > *Edit discount* page > [Voucher codes](/docs/scos/user/features/{{page.version}}/promotions-and-discounts/discount/discount.html#voucher-codes-tab) tab. See [Creating a Discount Voucher](/docs/scos/user/features/{{page.version}}/promotions-and-discounts/discount/discount.html#creating-a-discount-voucher) for more information.
