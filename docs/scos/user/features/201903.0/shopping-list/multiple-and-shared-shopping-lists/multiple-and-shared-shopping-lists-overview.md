...
* through a [shopping list widget](/docs/scos/user/features/{{page.version}}/shopping-lists-feature-overview/shopping-list-widget/shopping-list-widget.html) in the header of site
...
* Creation date
* Possible actions to manage shopping lists: [edit](#edit), [print](/docs/scos/user/features/{{page.version}}/shopping-lists-feature-overview/printing-a-shopping-list/printing-a-shopping-list.html), [delete](#deleted), [share](#share), [dismiss](#dismiss) (for shared shopping lists)
...
* Add comments to items (check [Shopping list notes](/docs/scos/user/features/{{page.version}}/shopping-lists-feature-overview/shopping-list-notes/shopping-list-notes.html) for more details)
...
3. **Printing shopping list**: Check [Printing Shopping list](/docs/scos/user/features/{{page.version}}/shopping-lists-feature-overview/printing-a-shopping-list/printing-a-shopping-list.html) to learn how it works
