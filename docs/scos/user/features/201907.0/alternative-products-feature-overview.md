...
originalLink: https://documentation.spryker.com/v3/docs/alternative-products-overview
originalArticleId: fbc9dfbc-e740-4e8e-89ed-9b390dd72686
redirect_from:
  - /v3/docs/alternative-products-overview
  - /v3/docs/en/alternative-products-overview
---
...
* [Discontinued Products](/docs/scos/user/features/{{page.version}}/product-management/discontinued-products/discontinued-products.html) feature is enabled
