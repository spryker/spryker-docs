...
In terms of [Merchant concept](/docs/scos/dev/features/201907.0/company-account-management/merchants-and-merchant-relations/merchants-and-merchant-relations-feature-overview.html), the **merchant** is the one who sells products on a marketplace and can set prices.
...
To create product lists, follow the [guideline for the Back Office](/docs/scos/user/user-guides/201907.0/back-office-user-guide/products/product-lists/creating-a-product-list.html).

You can check more cases of product restrictions workflow on the [Restricted Products Behavior](/docs/scos/dev/features/201907.0/company-account-management/product-restrictions-from-merchant-to-buyer/restricted-products-behavior.html) page.
