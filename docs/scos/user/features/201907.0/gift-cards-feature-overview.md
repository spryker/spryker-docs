...
originalLink: https://documentation.spryker.com/v3/docs/gift-cards
originalArticleId: 52e104dc-3036-4043-a7af-50a82a23b6a1
redirect_from:
  - /v3/docs/gift-cards
  - /v3/docs/en/gift-cards
  - /v3/docs/gift-card-purchase-management
  - /v3/docs/en/gift-card-purchase-management
  - /v3/docs/gift-cards-purchase-redeeming
  - /v3/docs/en/gift-cards-purchase-redeeming
---
...
@(Warning)()(Gift Cards are sensible data and can be used to pay orders, therefore please keep in mind that they should be protected just like real money.)
