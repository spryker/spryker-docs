...
originalLink: https://documentation.spryker.com/v3/docs/barcode-generator
originalArticleId: 19b6a008-6488-4063-bdf6-122f2e909fd8
redirect_from:
  - /v3/docs/barcode-generator
  - /v3/docs/en/barcode-generator
---
    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v4/docs/product-barcode" class="mr-link">Module Guide: ProductBarcode</a></li>
                <li><a href="https://documentation.spryker.com/v4/docs/product-barcode-gui" class="mr-link">Module Guide: ProductBarcodeGui</a></li>
                <li><a href="https://documentation.spryker.com/v4/docs/product-barcode-widget" class="mr-link">Module Guide: ProductBarcodeWidget</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
