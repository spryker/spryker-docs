...
- Developer
  ...
  - [Migrate the CMS module from version 6.* to version 7.*](/docs/pbc/all/content-management-system/install-and-upgrade/upgrade-modules/upgrade-the-cms-module.html#upgrading-from-version-6-to-version-7)
  - [Migrate the CmsStorage module from version 1.* to version 2.*](/docs/pbc/all/content-management-system/install-and-upgrade/upgrade-modules/upgrade-the-cms-modulestorage.html)
  - [Migrate the CmsGui module from version 4.* to version 5.*](/docs/pbc/all/content-management-system/install-and-upgrade/upgrade-modules/upgrade-the-cms-modulegui.html)
  - [Migrate the CmsPageSearch module from version 1.* to version 2.*](/docs/pbc/all/content-management-system/install-and-upgrade/upgrade-modules/upgrade-the-cms-modulepagesearch.html)
