...
*  Tutorial that helps to understand the procedure for sending an email - [Tutorial - Sending a Mail](/docs/scos/dev/tutorials/{{page.version}}/introduction/tutorial-sending-a-mail.html).
