...
Import a csv file with a list of prices. This option is for bulk operations. You can import the file via [Back Office](/docs/scos/user/user-guides/page.version/back-office-user-guide/price/scheduled-prices/creating-scheduled-prices.html) or [manually](/docs/scos/dev/tutorials/page.version/howtos/feature-howtos/data-imports/howto-import-scheduled-prices.html).
Add a price schedule to a single abstract or concrete product. This option is suitable for working with a small number of products. See [Editing an Abstract Product](/docs/scos/user/user-guides/page.version/back-office-user-guide/products/products/abstract-products/editing-an-abstract-product.html).
