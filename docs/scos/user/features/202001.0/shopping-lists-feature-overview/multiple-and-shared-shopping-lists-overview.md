...
* from Shopping Lists page in My Account menu. See [Creating a shopping list](/docs/scos/user/shop-user-guides/{{page.version}}/shop-guide-shopping-lists.html#create-shopping-list) for more detailed instruction.
