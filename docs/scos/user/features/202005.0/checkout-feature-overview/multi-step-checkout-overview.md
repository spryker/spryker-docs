    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="/docs/pbc/all/cart-and-checkout/install-and-upgrade/upgrade-modules/upgrade-the-checkout-module.html#upgrading-from-version-4-to-version-600" class="mr-link">Migrate the Checkout module from version 4.* to version 6.0.0</a></li>
                <li><a href="/docs/pbc/all/cart-and-checkout/install-and-upgrade/upgrade-modules/upgrade-the-checkoutpage-module.html" class="mr-link">Migrate the CheckoutPage module from version 2.* to version 3.*</a></li>
            </ul>
        </div>
        <!-- col3 -->
        <div class="mr-col">
