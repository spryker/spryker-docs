...
redirect_from:
  ...
  - /docs/scos/user/shop-user-guides/202005.0/shop-application-guide/cart/multiple-carts-per-user-feature-overview.html
---
...
To learn more about sharing the shopping cart, check out [Shared Cart documentation](/docs/scos/user/features/{{page.version}}/shared-cart-feature-overview.html).
