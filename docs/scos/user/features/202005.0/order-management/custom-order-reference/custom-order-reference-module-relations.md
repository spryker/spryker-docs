...
The module relations for the [Custom Order Reference](/docs/scos/user/features/{{page.version}}/order-management/custom-order-reference/custom-order-reference-feature-overview.html) feature can be represented like this: 
