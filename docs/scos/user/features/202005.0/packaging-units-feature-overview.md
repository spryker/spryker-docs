...
originalLink: https://documentation.spryker.com/v5/docs/packaging-units-overview
originalArticleId: b4b8b2e2-f329-4217-a7a8-0fadd14ab4e4
redirect_from:
  - /v5/docs/packaging-units-overview
  - /v5/docs/en/packaging-units-overview
