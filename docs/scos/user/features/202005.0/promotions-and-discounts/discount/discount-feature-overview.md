...
See [Creating a Voucher](/docs/scos/user/user-guides/page.version/back-office-user-guide/merchandising/discount/creating-a-discount/creating-a-voucher.html) to learn how a product catalog manager can create a voucher in the Back Office.
...
See [Creating a Cart Rule](/docs/scos/user/user-guides/page.version/back-office-user-guide/merchandising/discount/creating-a-discount/creating-a-cart-rule.html) to learn how a product catalog manager can create a cart rule in the Back Office.
