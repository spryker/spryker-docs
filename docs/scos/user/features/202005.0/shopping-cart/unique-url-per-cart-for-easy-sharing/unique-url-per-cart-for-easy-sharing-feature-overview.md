...
{% endinfo_block %}
* **Read-Only**. For details on the Read only permissions, refer to the [Permissions Management for Shared Shopping Lists](/docs/scos/dev/features/202005.0/shopping-list/multiple-and-shared-shopping-lists/multiple-and-shared-shopping-lists-overview.html#read-only) section in *Multiple and Shared Shopping Lists Overview*.
* **Full Access**. For details on the Full Access permission, check [Permissions Management for Shared Shopping Lists](/docs/scos/dev/features/202005.0/shopping-list/multiple-and-shared-shopping-lists/multiple-and-shared-shopping-lists-overview.html#full-access) section in *Multiple and Shared Shopping Lists Overview*.
