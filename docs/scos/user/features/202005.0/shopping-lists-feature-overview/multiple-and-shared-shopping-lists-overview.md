...
* from Shopping Lists page in My Account menu. See [Creating a shopping list](/docs/scos/user/user-guides/{{page.version}}/shop-user-guide/shop-guide-customer-account/shop-guide-shopping-lists.html#create-shopping-list) for more detailed instruction.
...
The detailed information on managing shopping lists is covered in the [Shop User Guide](/docs/scos/user/user-guides/{{page.version}}/shop-user-guide/shop-guide-customer-account/shop-guide-shopping-lists.html).
