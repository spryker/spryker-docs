...
redirect_from:
  - /v5/docs/punchout-feature-overview
  - /v5/docs/en/punchout-feature-overview
---
...
3. Authentication is handled with the help of the [Customer login by token](https://documentation.spryker.com/v5/docs/en/customer-login-by-token-overview) feature. So, the buyer doesn't need to enter any login details to get to the customer account. The [Vault for Tokens](https://documentation.spryker.com/v5/docs/en/vault-for-tokens-overview) feature allows securely keeping the sensitive data (username and password) and retrieving it on request.
