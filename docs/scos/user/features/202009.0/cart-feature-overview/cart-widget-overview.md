...
* Access level to a shopping cart (see [Shared Cart Feature Overview](/docs/scos/user/features/{{page.version}}/shared-carts/shared-carts-feature-overview.html) for more details)
* Price mode
* Cart Total
