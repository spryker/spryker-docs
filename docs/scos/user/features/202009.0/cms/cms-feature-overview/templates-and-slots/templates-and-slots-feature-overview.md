...
originalLink: https://documentation.spryker.com/v6/docs/templates-slots-feature-overview
originalArticleId: 87d2ef5a-eaaf-4a1e-9892-fc19f3f30da6
redirect_from:
  - /v6/docs/templates-slots-feature-overview
  - /v6/docs/en/templates-slots-feature-overview
---
...
CMS Block is a separate feature with a dedicated section in the Back Office. See [CMS Block](/docs/scos/user/features/{{page.version}}/cms/cms-feature-overview/cms-block.html-guide) to learn what a content manager can do with CMS blocks in the Back Office > **Content Management** > **Blocks** section.
