...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/dev/features/202009.0/merchant-custom-prices/merchant-custom-prices.html).
