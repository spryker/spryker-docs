...
originalLink: https://documentation.spryker.com/v6/docs/volume-prices
originalArticleId: ecbd9150-3b01-4079-b1f1-aaf1aa942b97
redirect_from:
  - /v6/docs/volume-prices
  - /v6/docs/en/volume-prices
---
...
* volume prices cannot be applied to the [prices per merchant relation](/docs/scos/user/features/{{page.version}}/merchant-custom-prices/merchant-custom-prices.html).
