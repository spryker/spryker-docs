...
{% endinfo_block %}
* **Read-Only**. For details on the Read only permissions, refer to the [Permissions Management for Shared Shopping Lists](docs\scos\user\features\202009.0\shopping-list\multiple-and-shared-shopping-lists\multiple-and-shared-shopping-lists-overview.md#read-only) section in *Multiple and Shared Shopping Lists Overview*.
* **Full Access**. For details on the Full Access permission, check [Permissions Management for Shared Shopping Lists](docs\scos\user\features\202009.0\shopping-list\multiple-and-shared-shopping-lists\multiple-and-shared-shopping-lists-overview.md#full-access) section in *Multiple and Shared Shopping Lists Overview*.
