...
The tax set is a set of tax rates. You can [define tax sets in the Back office](docs\scos\user\user-guides\202009.0\back-office-user-guide\administration\tax-sets\managing-tax-sets.md) or[ import tax sets](docs\scos\dev\data-import\202009.0\data-import-categories\commerce-setup\file-details-tax.csv.md) into your project.
