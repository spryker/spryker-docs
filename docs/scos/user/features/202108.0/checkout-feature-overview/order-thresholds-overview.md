...
See [Setting up a maximum hard threshold](/docs/scos/user/back-office-user-guides/{{page.version}}/administration/thresholds/managing-global-thresholds.html#setting-up-hard-threshold) to learn how a Back Office user configures the maximum hard threshold.
...
See [Setting up a minimum hard threshold](/docs/scos/user/back-office-user-guides/{{page.version}}/administration/thresholds/managing-global-thresholds.html#setting-up-hard-threshold) to learn how a Back Office user configures the minimum hard threshold.
...
See [Setting up a minimum soft threshold](/docs/scos/user/back-office-user-guides/{{page.version}}/administration/thresholds/managing-global-thresholds.html#setting-up-soft-threshold) to learn how a Back Office user configures the minimum soft threshold.
