...
|---|
| [Get a general idea of the Product Relations feature](/docs/scos/user/features/{{page.version}}/product-rating-and-reviews/product-rating-and-reviews-feature-overview.html)  |   |
