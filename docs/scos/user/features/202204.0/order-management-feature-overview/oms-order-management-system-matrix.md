...
Many start-ups in the ecommerce world have gone through an automation approach to their order processing as described by Fabian Wesner in his blog post ([Introduction to Automated Order Management for E-commerce Startups](https://medium.com/project-a-insights/introduction-to-automated-order-management-for-e-commerce-startups-7f756043c413)).
