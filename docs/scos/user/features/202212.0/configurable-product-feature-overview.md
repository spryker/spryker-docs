...
If the configurator does not provide a price, [a regular product price](/docs/pbc/all/price-management/{{page.version}}/prices-feature-overview/prices-feature-overview.html) is used.
