...
originalLink: https://documentation.spryker.com/v6/docs/release-notes-april-1-2017
originalArticleId: 8645d6ba-cf19-4c66-bb91-850dc342f565
redirect_from:
  - /v6/docs/release-notes-april-1-2017
  - /v6/docs/en/release-notes-april-1-2017
---
...
**Documentation**
For module documentation, see [Product Relation](/docs/scos/dev/features/202009.0/product-relations/product-relations.html). For integration guides see: [Product Relations Feature Integration](https://documentation.spryker.com/v6/docs/product-relation-integration).
...
**Documentation**
For module documentation, see [Event](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/event/event.html).
