...
**Documentation**: [Checkout](/docs/scos/dev/user-guides/201903.0/shop-user-guide/checkout/address-step-sh), [Business on Behalf](/docs/scos/dev/features/201903.0/company-account-management/business-on-behalf/business-on-beh), [Reclamations](https://documentation.spryker.com/v2/docs/reclamations-201903).
