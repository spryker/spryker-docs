...
originalLink: https://documentation.spryker.com/v6/docs/release-notes-201903-0
originalArticleId: de456857-3d48-481d-88ac-adbdfde777cc
redirect_from:
...
**Documentation**: [Product is Available Again](/docs/scos/dev/features/202009.0/availability-notification/availability-notification.html).
...
**Documentation**: [Discount](/docs/scos/dev/features/202009.0/promotions-and-discounts/promotions-and-discounts.html). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/v6/docs/back-office-translations-old).
...
**Documentation**: [Category](/docs/scos/dev/features/202009.0/category-management/category-management.html).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/v6/docs/cms-pages-overview).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/v6/docs/cms-pages-in-search-results-overview).
...
**Documentation**: [Assigning a Template for a Category Page](https://documentation.spryker.com/v6/docs/category)
...
**Documentation**: [CMS Block widget](https://documentation.spryker.com/v6/docs/content-widgets)
...
**Documentation**: [Session Management](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-enrichment/session-handlers.html).
...
**Documentation**: [Code Sniffer](/docs/scos/dev/sdk/202009.0/development-tools/code-sniffer.html), [Architecture Sniffer](/docs/scos/dev/sdk/202009.0/development-tools/architecture-sniffer.html), [PHPStan](/docs/scos/dev/sdk/202009.0/development-tools/phpstan.html).
...
**Documentation**: [Spryk](/docs/scos/dev/sdk/202009.0/development-tools/spryk-code-generator.html).
...
**Documentation**: [Retrieving Related Products](https://documentation.spryker.com/v6/docs/retrieving-related-products-201903).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](https://documentation.spryker.com/v6/docs/retrieving-navigation-trees-201903).
...
**Documentation**: [Retrieving Alternative Products](/docs/scos/dev/glue-api-guides/202009.0/managing-products/retrieving-alternative-products.html).
...
**Documentation**: [Configuring Visibility of the Included Section](/docs/scos/dev/tutorials-and-howtos/202009.0/howtos/glue-api-howtos/configuring-visibility-of-the-included-section.html).
...
**Documentation**: [Quick Order](/docs/scos/dev/quick-add-to-cart/202009.0/quick-add-to-cart.html).
...
**Documentation**: [Approval Process](https://documentation.spryker.com/v6/docs/approval-process-201903).
...
**Documentation**: [Checkout](/docs/scos/dev/features/202009.0/checkout/checkout-feature-overview/multi-step-checkout.html), [Business on Behalf](https://documentation.spryker.com/v6/docs/business-on-behalf-overview), [Reclamations](/docs/scos/dev/features/202009.0/reclamations/reclamations.html).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](/docs/scos/dev/technology-partners/202009.0/payment-partners/heidelpay/heidelpay-payment-methods/heidelpay-split-payment-marketplace.html).
...
**Documentation**: [Adyen](/docs/scos/dev/technology-partners/202009.0/payment-partners/adyen/adyen.html).
...
**Documentation**: [AfterPay](/docs/scos/dev/technology-partners/202009.0/payment-partners/afterpay/afterpay.html).
