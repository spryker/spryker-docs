...
originalArticleId: 0d0953aa-ca23-4a58-8462-b42fe65b0636
redirect_from:
...
#### Documentation
[Packaging Units](/docs/scos/dev/features/202009.0/packaging-units/packaging-units.html-202001) 
...
* [Creating Scheduled Prices in the Back Office](https://documentation.spryker.com/v6/docs/creating-scheduled-prices-201907)
* [Managing Scheduled Prices in the Back Office](/docs/scos/user/user-guides/202009.0/back-office-user-guide/catalog/scheduled-prices/managing-scheduled-prices.html)
...
* [Inventory](/docs/scos/dev/features/202009.0/inventory-management/inventory-management.html)
* [Warehouse Management](https://documentation.spryker.com/v6/docs/multiple-warehouse-stock)
* [Managing Payment Methods in the Back Office](/docs/scos/user/user-guides/202009.0/back-office-user-guide/administration/payment-methods/managing-payment-methods.html)
* [Managing Delivery Methods in the Back Office](/docs/scos/user/user-guides/202009.0/back-office-user-guide/administration/delivery-methods/creating-and-managing-delivery-methods.html)
...
#### Documentation
[Templates and Slots](https://documentation.spryker.com/v6/docs/templates-and-slots-overview)
***
## B2B
...
#### Documentation
[Configurable Bundle](/docs/scos/dev/features/202009.0/configurable-bundle/configurable-bundle.html) 
***
...
#### Documentation
[Product Labels API](/docs/scos/dev/glue-api-guides/202009.0/managing-products/retrieving-product-labels.html) 
...
#### Documentation
[Discounts API](https://documentation.spryker.com/v6/docs/retrieving-discounts) 
...
#### Documentation
[Ratings and Reviews API](https://documentation.spryker.com/v6/docs/retrieving-ratings-and-reviews)
...
#### Documentation
[Product Options API](https://documentation.spryker.com/v6/docs/retrieving-product-options)
...
#### Documentation
[Search Engine Friendly URLs](/docs/scos/dev/glue-api-guides/202009.0/resolving-search-engine-friendly-urls.html)
...
* [Assigning Guest Cart to Registered Customer](/docs/scos/dev/glue-api-guides/202009.0/managing-carts/guest-carts/managing-guest-carts.html#assigning-guest-cart-to-registered-customer)
* [Getting the list of protected resources](/docs/scos/dev/glue-api-guides/202009.0/retrieving-protected-resources.html)
* [Managing Customer Access to API Resources](/docs/scos/dev/tutorials-and-howtos/202009.0/howtos/glue-api-howtos/managing-customer-access-to-api-resources.html)
...
* [Getting Started with Docker](/docs/scos/dev/developer-guides/202009.0/installation/installing-spryker-with-docker/installing-spryker-with-docker.html#running-production)
* [Deploy File Reference](/docs/scos/dev/developer-guides/202009.0/docker-sdk/deploy-file-reference-1.0.html)
* [Spryker in Docker Services](/docs/scos/dev/developer-guides/202009.0/docker-sdk/configuring-services.html)
...
#### Documentation: 
[Search Migration Guides](/docs/scos/dev/migration-and-integration/202009.0/migration-concepts/search-migration-concept/search-migration-concept.html)
...
#### Documentation
[HowTo - Disable Key-value Storage and use the Database Instead](/docs/scos/dev/tutorials-and-howtos/202009.0/howtos/howto-replace-key-value-storage-with-database.html)
...
#### Documentation:
[Silex Migration Guides](/docs/scos/dev/migration-and-integration/202009.0/migration-concepts/silex-replacement/silex-replacement.html)
...
#### Documentation:
[Health Checks](/docs/scos/dev/migration-and-integration/202009.0/technical-enhancements/health-checks.html)
...
#### Documentation:
[Tutorial - Handling Data - Publish and Synchronization - Spryker Commerce OS](/docs/scos/dev/developer-guides/202009.0/development-guide/back-end/data-manipulation/data-publishing/handling-data-with-publish-and-synchronization.html#7--queue)
...
#### Documentation
[Search Initialization Improvement](/docs/scos/dev/migration-and-integration/202009.0/technical-enhancements/search-initialization-improvement.html)
