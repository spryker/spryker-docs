...
- [How send a request in Data Exchange API](/docs/dg/dev/glue-api/202307.0/data-exchange-api/how-to-guides/how-to-send-request-in-data-exchange-api.html): Added error codes and error code descriptions.
