...
- [Install the Checkout Glue API](/install-and-upgrade/install-glue-api//docs/pbc/all/cart-and-checkout/202307.0/base-shop/install-and-upgrade/install-glue-api/install-the-checkout-glue-api.html).
