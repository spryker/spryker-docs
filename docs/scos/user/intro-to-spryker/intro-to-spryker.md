...
The modules combine to create [features](/docs/scos/user/features/features.html) and have limited dependencies. The limited dependencies imply less development effort, increasing your return on investment and lowering the total cost of ownership.
...
* [Features](/docs/scos/user/features/features.html): the Spryker features.
* [Glue REST API](/docs/scos/dev/glue-api-guides/glue-rest-api.html): Spryker Glue REST API overview, reference, and features.
* [User Guides](/docs/scos/user/back-office-user-guides/about-back-office-user-guides.html): step-by-step Backoffice and Storefront user guides.
* [Developer Guides](/docs/scos/dev/developer-getting-started-guide.html): technical information and guides for developers.
* [Technology Partners](/docs/scos/user/technology-partners/technology-partners.html): Spryker technology partners information and integration guides.
