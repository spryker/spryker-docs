...
**Documentation**
For module documentation, see [Product Relation](/docs/scos/user/features/{{page.version}}/product-relations/product-relations.html). For integration guides see: [Product Relations Feature Integration](https://documentation.spryker.com/2021080/docs/product-relation-integration).
