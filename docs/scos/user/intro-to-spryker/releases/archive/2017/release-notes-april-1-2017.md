...
**Documentation**
<br>For module documentation, see [Product Relations](/docs/scos/user/features/{{site.version}}/product-relations-feature-overview.html).
...
**Documentation**
<br>For module documentation, see [Event](/docs/scos/dev/back-end-development/data-manipulation/event/event.html).
