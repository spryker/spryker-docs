...
<br>For detailed migration guides, see [Shipment Module Migration Guide from Version 5. to 6](/docs/scos/dev/module-migration-guides/migration-guide-shipment.html#upgrading-from-version-5-to-version-6).
...
**Documentation**
<br>For detailed migration guides, see [RabbitMQ Module Migration Guide from Version 0. to 1](/docs/scos/dev/module-migration-guides/migration-guide-rabbitmq.html#upgrading-from-version-0-to-version-1).
