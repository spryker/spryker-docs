...
**Documentation**
For module documentation, see [Navigation Module Guide](/docs/scos/user/features/{{site.version}}/navigation-feature-overview.html), [Under the Hood - Navigation](/docs/scos/dev/feature-walkthroughs/{{site.version}}/navigation-feature-walkthrough/navigation-module-reference-information.html).
...
**Documentation**
For detailed migration guides, see [Sales Module Migration Guide from Version 7. to 8](/docs/scos/dev/module-migration-guides/{{site.version}}/migration-guide-sales.html).
