...
<!--
**Documentation**
<br>For module documentation, see CMS - Preview Draft Page /capabilities/cms/page-draft-preview.htm), Under the Hood - Customer User Connector.-->
For feature integration, see Feature Integration - Customer User Connector.
<br>For detailed migration guides, see [CMS Collector Module Migration Guide from Version 1. to 2.](/docs/scos/dev/module-migration-guides/migration-guide-cmscollector.html#upgrading-from-version-1-to-version-2)
...
**Documentation**
<br>For module documentation, see [Navigation Module Guide](/docs/scos/user/features/{{site.version}}/navigation-feature-overview.html), [Under the Hood - Navigation](/docs/scos/dev/feature-walkthroughs/{{site.version}}/navigation-feature-walkthrough/navigation-module-reference-information.html).

<br>For detailed migration guides, see [Navigation Module Migration Guide from Version 1. to 2](/docs/scos/dev/module-migration-guides/migration-guide-navigation.html#upgrading-from-version-1-to-version-2), [NavigationGui Module Migration Guide from Version 1. to 2.](/docs/scos/dev/module-migration-guides/migration-guide-navigationgui.html#upgrading-from-version-1-to-version-2).
...
**Documentation**
<br><br>For detailed migration guides, see [Sales Module Migration Guide from Version 7. to 8](/docs/scos/dev/module-migration-guides/migration-guide-sales.html).
