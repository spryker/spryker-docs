...
**Documentation**
For module documentation, see [Navigation Module Guide](https://documentation.spryker.com/2021080/docs/navigation), [Under the Hood - Navigation](/docs/scos/dev/features/{{page.version}}/navigation/navigation-module-reference-information.html#under-the-hood).

For feature integration, see [Feature Integration - Navigation](/docs/scos/dev/features/{{page.version}}/navigation/navigation-module-reference-information.html#feature-integration)
