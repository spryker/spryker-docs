...
For detailed migration guides, see [Discount Module Migration Guide from Version 4. to 5](/docs/scos/dev/migration-and-integration/{{site.version}}/module-migration-guides/migration-guide-discount.html#upgrading-from-version-4---to-version-5--), Migration Guide - Discount Amounts Migration Console Command.
