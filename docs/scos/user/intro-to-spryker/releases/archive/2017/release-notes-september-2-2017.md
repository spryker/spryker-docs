...
**Documentation**
For detailed migration guides, see [Currency Module Migration Guide from Version 2. to 3](/docs/scos/dev/migration-and-integration/{{site.version}}/module-migration-guides/migration-guide-currency.html#upgrading-from-version-2---to-version-3--).
