...
**Documentation**: [Checking Out Purchases and Getting Checkout Data](/docs/pbc/all/cart-and-checkout/manage-using-glue-api/check-out/check-out-purchases.html).
