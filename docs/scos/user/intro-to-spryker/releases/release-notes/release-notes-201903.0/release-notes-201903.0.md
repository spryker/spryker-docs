...
**Documentation**: [Product is Available Again](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/availability-notification-feature-overview.html).
...
**Documentation**: [Discount](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/promotions-discounts-feature-overview.html).
...
**Documentation**: [Back Office Translations](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/spryker-core-back-office-feature-overview/back-office-translations-overview.html).
...
**Documentation**: [Category](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/category-management-feature-overview.html).
...
**Documentation**: [Multi-store CMS Pages](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/cms-feature-overview/cms-pages-overview.html).
...
**Documentation**: [CMS Pages in Search Results](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/cms-feature-overview/cms-pages-in-search-results-overview.html).
...
**Documentation**: [Assigning a Template for a Category Page](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/category-management-feature-overview.html)
...
**Documentation**: [CMS Block widget](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/cms-feature-overview/cms-blocks-overview.html)
...
**Documentation**: [Retrieving Related Products](/docs/scos/dev/glue-api-guides/managing-products/retrieving-related-products.html).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/navigation-feature-overview.html).
...
**Documentation**: [Retrieving Alternative Products](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/201903.0/managing-products/retrieving-alternative-products.html).
...
**Documentation**: [Quick Order](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/quick-add-to-cart-feature-overview.html).
...
**Documentation**: [Approval Process](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/approval-process-feature-overview.html).
...
**Documentation**: [Checkout](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/checkout-feature-overview/multi-step-checkout-overview.html), [Business on Behalf](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/company-account-feature-overview/business-on-behalf-overview.html), [Reclamations](https://archive.docs.spryker.com/docs/scos/user/features/201903.0/reclamations-feature-overview.html).
...
**Documentation**: [Integrating the Split-payment Marketplace payment method for Heidelpay](/docs/scos/dev/technology-partner-guides/payment-partners/heidelpay/integrating-payment-methods-for-heidelpay/integrating-the-split-payment-marketplace-payment-method-for-heidelpay.html).
...
**Documentation**: [Adyen](https://archive.docs.spryker.com/docs/scos/user/technology-partners/201903.0/payment-partners/adyen.html).
...
**Documentation**: [AfterPay](https://archive.docs.spryker.com/docs/scos/user/technology-partners/201903.0/payment-partners/afterpay.html).
