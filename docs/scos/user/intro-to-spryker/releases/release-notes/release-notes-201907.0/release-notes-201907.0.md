...
* [Interact with third party payment providers using Glue API](/docs/pbc/all/payment-service-provider/{{site.version}}/base-shop/interact-with-third-party-payment-providers-using-glue-api.html)
...
**Documentation**: [Integrating the Easy Credit payment method for Heidelpay](/docs/pbc/all/payment-service-provider/{{site.version}}/base-shop/third-party-integrations/heidelpay/integrate-payment-methods-for-heidelpay/integrate-the-easy-credit-payment-method-for-heidelpay.html)
...
**Documentation**: [Installing and configuring ratenkauf by easyCredit](/docs/pbc/all/payment-service-provider/{{site.version}}/base-shop/third-party-integrations/ratenkauf-by-easycredit/install-and-configure-ratenkauf-by-easycredit.html)
...
**Documentation**: [CrefoPay](/docs/pbc/all/payment-service-provider/{{site.version}}/base-shop/third-party-integrations/crefopay/install-and-configure-crefopay.html)
