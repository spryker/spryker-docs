...
* [Customer Registration overview](https://archive.docs.spryker.com/docs/scos/user/features/202108.0/customer-account-management-feature-overview/customer-registration-overview.html)
* [Customer Login overview](https://archive.docs.spryker.com/docs/scos/user/features/202108.0/customer-account-management-feature-overview/customer-login-overview.html)
...
#### Documentation
[Back Office Login overview](https://archive.docs.spryker.com/docs/scos/user/features/202108.0/spryker-core-back-office-feature-overview/spryker-core-back-office-feature-overview.html)
...
#### Documentation
[Category management](https://archive.docs.spryker.com/docs/scos/user/features/202108.0/category-management-feature-overview.html)
...
#### Documentation
[Tax](https://archive.docs.spryker.com/docs/scos/user/features/202108.0/tax-feature-overview.html)
...
* Categories per store: [Import data associating categories with stores](https://archive.docs.spryker.com/docs/scos/dev/data-import/202108.0/data-import-categories/catalog-setup/categories/file-details-category-store.csv.html).
* Warehouse address: [Import the warehouse address data](https://archive.docs.spryker.com/docs/scos/dev/data-import/202108.0/data-import-categories/commerce-setup/file-details-warehouse-address.csv.html).
...
#### Documentation
[Deploy file reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html#regions)
...
#### Documentation
[Deploy file reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html#docker-debug)
...
#### Documentation
[Deploy file reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html#groups-applications-endpoints)
...
#### Documentation
[Configuring access to private repositories](https://archive.docs.spryker.com/docs/scos/dev/the-docker-sdk/202108.0/configuring-access-to-private-repositories.html)
...
#### Documentation
[Deploy file reference - 1.0](/docs/scos/dev/the-docker-sdk/deploy-file/deploy-file-reference-1.0.html#groups-applications)
...
#### Documentation
[Docker SDK](https://archive.docs.spryker.com/docs/scos/dev/the-docker-sdk/202108.0/the-docker-sdk.html)
...
#### Documentation
[Retrieving CMS pages](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/retrieving-cms-pages.html)
...
* [Authenticating as an agent assist](/docs/scos/dev/glue-api-guides/managing-agent-assists/authenticating-as-an-agent-assist.html)
* [Searching by customers as an agent assist](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-agent-assists/searching-by-customers-as-an-agent-assist.html)
* [Impersonating customers as an agent assist](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-agent-assists/impersonating-customers-as-an-agent-assist.html)
* [Managing agent assist authentication tokens](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-agent-assists/managing-agent-assist-authentication-tokens.html)
...
* [Retrieving bundled products](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/retrieving-bundled-products.html)
* [Retrieving concrete products](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/concrete-products/retrieving-concrete-products.html)
* [Retrieving abstract products](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/abstract-products/retrieving-abstract-products.html)
* [Managing items in carts of registered users](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-carts/carts-of-registered-users/managing-items-in-carts-of-registered-users.html)
* [Managing guest cart items](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-carts/guest-carts/managing-guest-cart-items.html)
...
* [Retrieving configurable bundle templates](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/retrieving-configurable-bundle-templates.html)
...
* [Checking our purchases with configurable bundles](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/checking-out/checking-out-purchases.html)
* [Retrieving orders with configurable bundles](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/retrieving-orders.html)
...
#### Documentation
[Retrieving product attributes](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/retrieving-product-attributes.html)
...
* [Submitting checkout data](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/checking-out/submitting-checkout-data.html)
* [Checking out purchases](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/checking-out/checking-out-purchases.html)
* [Retrieving orders](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/retrieving-orders.html)
...
#### Documentation
[Confirming customer registration](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-customers/confirming-customer-registration.html)
...
* [Managing availability notifications](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/managing-availability-notifications/managing-availability-notifications.html)
* [Retrieving subscriptions to availability notifications](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-products/managing-availability-notifications/retrieving-subscriptions-to-availability-notifications.html)
...
#### Documentation
[Managing customer authentication tokens via OAuth 2.0](https://archive.docs.spryker.com/docs/scos/dev/glue-api-guides/202108.0/managing-customers/managing-customer-authentication-tokens-via-oauth-2.0.html)
