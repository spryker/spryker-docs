...
* Make sure application monitoring is in place ([Tideways](/docs/scos/user/technology-partners/operational-tools-monitoring-legal-etc/tideways.html), NewRelic etc.) so you can watch for errors or issues
