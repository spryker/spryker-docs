...
originalArticleId: 1aede9b5-e625-438a-a31f-b1ac45b942cc
redirect_from:
...
To learn more on how to select a shipment method, see [Shop Guide - Shipment Step](/docs/scos/user/shop-user-guides/{{page.version}}/checkout/shop-guide-shipment-step.html).
