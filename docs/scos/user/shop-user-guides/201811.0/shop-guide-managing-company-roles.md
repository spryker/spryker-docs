...
redirect_from:
  ...
  - /docs/scos/user/shop-user-guides/shop-guide-company-roles.html
---
...
A role includes a set of permissions that can be enabled/disabled according to your needs by switching the toggle in Enable column.
  ...
  - **Approve up to grand total** - with this permission enabled, a user can approve the the cart. See [Approval Feature ](/docs/scos/user/features/approval-process-feature-overview.html) for more details.
  - **Send cart for approval (Requires "Buy up to grand total")** - allows a user to send the cart for approval. Works together with Buy up to grand total permission. See [Approval Feature Overview](/docs/scos/user/features/company-account-feature-overview/company-user-roles-and-permissions-overview.html) for more details.
3. Click **Submit**.
...
Don't forget to check out the video tutorial on setting up the [Company Roles](/docs/scos/user/features/company-account-feature-overview/company-user-roles-and-permissions-overview.html) in Spryker [B2B Demo Shop](/docs/scos/user/intro-to-spryker/b2b-suite.html):
