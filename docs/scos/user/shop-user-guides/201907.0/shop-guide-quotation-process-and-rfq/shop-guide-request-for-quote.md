...
redirect_from:
  ...
  - /docs/scos/user/shop-user-guides/quotation-process-and-rfq/shop-guide-request-for-quote.html
  - /docs/scos/user/shop-user-guides/quotation-proces-and-rfq/shop-guide-request-for-quote.html
---
...
[Creating an RFQ](/docs/scos/user/shop-user-guides/quotation-proces-and-rfq/shop-guide-creating-a-request-for-quote.html) describes the steps you need to take to create an RFQ.

[Managing RFQs for a Buyer](/docs/scos/user/shop-user-guides/quotation-proces-and-rfq/shop-guide-managing-requests-for-quotes-for-a-buyer.html) defines the procedures for managing an RFQ that a Buyer can do.

[Managing RFQs for a Sales Representative](/docs/scos/user/shop-user-guides/quotation-proces-and-rfq/shop-guide-managing-requests-for-quotes-for-a-sales-representative.html) describes the procedures a Sales Representative can do.

[RFQ: Reference Information](/docs/scos/user/shop-user-guides/quotation-proces-and-rfq/shop-guide-request-for-quote-reference-information.html) contains details on the UI elements for the RFQ pages in the shop application.
