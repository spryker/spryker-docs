...
1. Click the cart you would like to review to open the [Shopping Cart page](/docs/scos/user/shop-user-guides/shop-guide-shopping-carts/shopping-carts-reference-information.html#shopping-cart).
