...
You must be logged in to a company account to be able to add the configured bundle to cart. The corresponding [company role permissions](/docs/scos/user/shop-user-guides/{{page.version}}/shop-guide-company-roles.html) (Add item to cart) should also be applied to your user.
