...
* Initially create an RFQ from the Cart page. See [Creating an RFQ (Buyer)](/docs/scos/user/shop-user-guides/shop-guide-quotation-process-and-rfq/shop-guide-creating-a-request-for-quote.html) for more information.
* Open a Quote Request which is in the *Draft* status in the **Customer Account → Quote Request**.

See [Reference Information](/docs/scos/user/shop-user-guides/shop-guide-quotation-process-and-rfq/shop-guide-request-for-quote-reference-information.html) for details on components the Quote Request page consists of.
...
See [Buyer Workflow](/docs/scos/user/features/quotation-process-feature-overview.html#buyer-workflow) for more information on request statuses and workflow.
...
RFQ version number changes upon each revision. Check [RFQ Versioning](/docs/scos/user/features/quotation-process-feature-overview.html) to learn about the version change process.
...
1. Open the **Quote Request** page.
2. Click **Edit**.
3. Change **Purchase order number, Do not ship later than, Notes** fields, and/or [Edit the Items](/docs/scos/user/features/quotation-process-feature-overview.html) that are in the RFQ.
4. Click **Save**.
