...
See [Permissions Management for Shared Shopping Lists](/docs/pbc/all/shopping-list-and-wishlist/{{site.version}}/shopping-lists-feature-overview/shopping-lists-feature-overview.html#permissions-management-for-shared-shopping-lists) to learn more about types of shopping list access rights.
