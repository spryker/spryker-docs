...
## Prerequisites
Prior to integrating CrefoPay into your project, make sure you [installed and configured the CrefoPay module](/docs/scos/dev/technology-partners/201903.0/payment-partners/crefopay/crefopay-installation-and-configuration.html).
