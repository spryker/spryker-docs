...
originalArticleId: c336adf3-01eb-4054-95d6-2a64b89dec8b
redirect_from:
...
related:
  ...
  - title: Econda
    link: docs/scos/user/technology-partners/201811.0/marketing-and-conversion/personalization-and-cross-selling/econda/econda.html
---

To implement Econda plugin you should be familiar with the concept of [extending Spryker](/docs/scos/dev/back-end-development/extending-spryker/extending-a-core-module-that-is-used-by-another.html) and [plugins.](/docs/scos/dev/{{site.versiono}}/back-end-development/implementing-and-using-plugins.html)
