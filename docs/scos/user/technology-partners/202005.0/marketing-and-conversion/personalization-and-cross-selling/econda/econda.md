...
Econda module uses collectors to [export data to CSV](/docs/scos/user/technology-partners/202005.0/marketing-and-conversion/personalization-and-cross-selling/econda/econda-exporting-csvs.html). Please read more about Collectors.
