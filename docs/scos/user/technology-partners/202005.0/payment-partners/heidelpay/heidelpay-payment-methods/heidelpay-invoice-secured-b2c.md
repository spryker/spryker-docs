...
originalLink: https://documentation.spryker.com/v5/docs/heidelpay-invoice-secured-b2c
originalArticleId: 0888d297-e9a1-48b9-8e88-607796ddf7e9
redirect_from:
  - /v5/docs/heidelpay-invoice-secured-b2c
  - /v5/docs/en/heidelpay-invoice-secured-b2c
related:
  - title: Heidelpay
...
## Setup
The following configuration should be made after Heidelpay has been [installed](/docs/scos/user/technology-partners/202005.0/payment-partners/heidelpay/heidelpay-installation.html) and [integrated](/docs/scos/user/technology-partners/202005.0/payment-partners/heidelpay/scos-integration/heidelpay-integration-into-scos.html).
