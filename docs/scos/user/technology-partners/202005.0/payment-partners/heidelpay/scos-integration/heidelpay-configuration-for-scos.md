...
Also, you have to add payment methods to [State Machine (OMS) configuration](/docs/scos/user/technology-partners/202005.0/payment-partners/heidelpay/heidelpay.html#building-a-state-machine-workflow-to-use-heidelpay-payment-methods):
```php
