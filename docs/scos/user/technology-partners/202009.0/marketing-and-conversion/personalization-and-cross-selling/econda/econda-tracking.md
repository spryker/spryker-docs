...
originalLink: https://documentation.spryker.com/v6/docs/econda-tracking
originalArticleId: 3eae1d63-d2a5-4e80-99e0-04adf86c24ca
redirect_from:
  - /v6/docs/econda-tracking
  - /v6/docs/en/econda-tracking
---
...
To add tracking, you should also be familiar with [Twig.](/docs/scos/dev/developer-guides/202009.0/development-guide/front-end/legacy-demoshop/twig-templates/overview-twig.html)
...
Before getting started we recomend that you read the following topics: [asset management](/docs/scos/dev/developer-guides/202009.0/development-guide/front-end/legacy-demoshop/frontend-overview.html#asset-management)
and [Twig](/docs/scos/dev/developer-guides/202009.0/development-guide/front-end/legacy-demoshop/twig-templates/overview-twig.html)
