...
originalArticleId: 623d3000-c56c-4942-b699-b0b92ec2ce76
redirect_from:
...
Also, you have to add payment methods to [State Machine (OMS) configuration](/docs/scos/user/technology-partners/202009.0/payment-partners/heidelpay/heidelpay.html#building-a-state-machine-workflow-to-use-heidelpay-payment-methods):
```php
