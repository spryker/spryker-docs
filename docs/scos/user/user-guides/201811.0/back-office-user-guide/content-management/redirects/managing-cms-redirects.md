...
{% info_block infoBox %}
See the [CMS Redirects: Reference Information](/docs/scos/user/user-guides/201811.0/back-office-user-guide/content-management/redirects/references/cms-redirects-references.html
...
***
**What's next?**
To learn more about attributes you enter on the page, see the [CMS Redirects: Reference Information](/docs/scos/user/user-guides/201811.0/back-office-user-guide/content-management/redirects/references/cms-redirects-references.html) article.
