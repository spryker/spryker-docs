...
* To know how you to add blocks to pages, see the [Assigning Blocks to Category and Product details Pages](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content/blocks/assigning-blocks-to-category-or-product-pages.html) article.
