...
***
**What's next?**
Learn how the product attributes are managed in the [Managing Product Attributes](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/attributes/managing-attrib) article. 

Review the [References](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/attributes/references/attributes-refe) section to learn more about the attributes you populate for the Attribute entity and the examples of how the attributes are used. 
