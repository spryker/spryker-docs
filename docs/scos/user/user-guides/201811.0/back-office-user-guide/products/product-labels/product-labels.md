...
* [Creating a Product Label](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-labels/creating-a-prod)
* [Managing Product Labels](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-labels/managing-produc)
* [Prioritizing Labels](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-labels/prioritizing-la)

To learn more about the attributes you select and enter while creating or managing product labels, see [Product Labels: Reference Information](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-labels/references/product-labels-).
