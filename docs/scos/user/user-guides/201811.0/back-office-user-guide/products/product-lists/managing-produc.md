...
Review [Product Lists: Reference Information](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-lists/references/product-lists-r) to learn about the attributes you see, select, and enter while managing a product list.
