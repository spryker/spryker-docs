...
originalLink: https://documentation.spryker.com/v1/docs/creating-a-product-set
redirect_from:
  - /v1/docs/creating-a-product-set
  - /v1/docs/en/creating-a-product-set
---
...
* To know more about the attributes that you select and enter while creating a product set, as well as to see some examples of product sets, see [Product Sets: Reference Information](/docs/scos/dev/user-guides/201811.0/back-office-user-guide/products/product-sets/references/product-sets-re).
