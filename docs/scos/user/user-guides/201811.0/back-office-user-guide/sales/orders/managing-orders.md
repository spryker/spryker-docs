...
***
To learn more about the order statuses, see [Orders: Reference Information](/docs/scos/user/user-guides/201811.0/back-office-user-guide/sales/orders/references/orders-reference-information.html).
***
## Claiming Orders
