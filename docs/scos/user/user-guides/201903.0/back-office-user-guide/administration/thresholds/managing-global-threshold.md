...
originalLink: https://documentation.spryker.com/v2/docs/managing-global-threshold
originalArticleId: 1d16868e-258b-45f6-96b0-a3389e353f4b
redirect_from:
...
See [Threshold: Reference Information](/docs/scos/user/user-guides/201903.0/back-office-user-guide/thresholds/references/threshold-reference-information.html) to know more about the hard threshold.
***
...
See [Threshold: Reference Information](/docs/scos/user/user-guides/201903.0/back-office-user-guide/thresholds/references/threshold-reference-information.html) to know more about the soft threshold and its types.
***
