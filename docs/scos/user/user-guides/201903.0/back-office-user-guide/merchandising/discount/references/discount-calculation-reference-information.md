...
{% info_block infoBox "Info" %}
See [Token Description Tables](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/merchandising/discount/references/token-description-tables.html) for more information.
{% endinfo_block %}
