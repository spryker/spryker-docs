...
See [Threshold: Reference Information](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/thresholds/references/threshold-refer) to know more about the hard threshold.
***
...
See [Threshold: Reference Information](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/thresholds/references/threshold-refer) to know more about the soft threshold and its types.
***
