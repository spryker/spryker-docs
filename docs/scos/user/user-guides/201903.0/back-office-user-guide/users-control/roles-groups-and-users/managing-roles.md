...
See [Adding Rules for Roles](https://documentation.spryker.com/v2/docs/managing-roles#adding-rules-for-roles) for information on how to create rules.
...
2. Repeat the steps described in the [Creating a Role](https://documentation.spryker.com/v2/docs/managing-roles#creating-a-role) procedure.
***
**What's next?**
You need to create a group to assign this role to it. See the [Creating a Group](https://documentation.spryker.com/v2/docs/managing-groups#creating-a-group) section in _Managing Groups_.
