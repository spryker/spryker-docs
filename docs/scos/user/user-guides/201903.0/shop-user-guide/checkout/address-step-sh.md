...
To learn more on how to select a shipment method, see [Shop Guide - Shipment Step](/docs/scos/dev/user-guides/201903.0/shop-user-guide/checkout/shipment-step-s).
