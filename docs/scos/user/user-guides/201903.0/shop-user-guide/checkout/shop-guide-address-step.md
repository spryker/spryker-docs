...
To learn more on how to select a shipment method, see [Shop Guide - Shipment Step](/docs/scos/user/user-guides/201903.0/shop-user-guide/checkout/shop-guide-shipment-step.html).
