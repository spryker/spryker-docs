...
See [CMS Block: Reference Information](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/references/cms-block-refer) to learn more about attributes on this page.
...
{% info_block infoBox %}
See [CMS Blocks: Reference Information](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/references/cms-block-refer
...
* To learn how to set the time period during which CMS blocks will be visible on the store website, see [Defining Validity Period for CMS Blocks](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/defining-validi).

* To know what attributes you enter and select while editing the CMS block, see [CMS Block: Reference Information](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/references/cms-block-refer).
