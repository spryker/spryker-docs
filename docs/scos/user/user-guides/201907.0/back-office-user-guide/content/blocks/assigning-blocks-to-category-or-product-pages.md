...
You can only add existing, active, and not expired block. If the block has not been created yet, see [Creating a CMS Block](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content-management/blocks/creating-a-cms-block.html
{% endinfo_block %} first.)
