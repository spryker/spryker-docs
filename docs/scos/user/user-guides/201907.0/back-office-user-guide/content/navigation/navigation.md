...
* To know how the navigation elements are managed, see [Managing Navigation](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/navigation/managing-navigation.html).
