...
{% info_block infoBox %}
See the [CMS Redirects: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content/redirects/references/cms-redirects-references.html
