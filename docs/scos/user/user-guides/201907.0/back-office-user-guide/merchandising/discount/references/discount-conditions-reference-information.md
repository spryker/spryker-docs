...
originalLink: https://documentation.spryker.com/v3/docs/discount-conditions-reference-information
originalArticleId: c0437f93-aa84-47dc-ae67-d0f12cfc5c27
redirect_from:
  - /v3/docs/discount-conditions-reference-information
  - /v3/docs/en/discount-conditions-reference-information
---
...
The conditions are created in the form of a query and may be entered as a plain query or via the query builder. (See [Discount Calculation: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/discount/references/discount-calculation-reference-information.html) for more details.)
