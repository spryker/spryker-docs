...
***
**Tips & Tricks**
To know more about the node types that you select, see [Navigation Node Types](/docs/scos/dev/user-guides/202001.0/back-office-user-guide/navigation/references/navigation-node) in the References section.
