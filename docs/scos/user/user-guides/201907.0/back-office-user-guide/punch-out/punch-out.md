...
To learn how to create and manage the Punch Out connections, see [Managing Punch Out connections](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/punch-out/managing-puncho).
To learn how to manage the Punch Out translation logs, see [Managing transaction logs](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/punch-out/managing-transa).
