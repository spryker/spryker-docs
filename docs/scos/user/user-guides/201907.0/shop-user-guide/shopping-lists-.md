...
{% endinfo_block %} feature is [integrated](/docs/scos/dev/user-guides/201907.0/shop-user-guide/shopping-lists-) into your project.)
...
* Add a note to the item. To save the note, click **Save**. See [Shopping List Notes Feature Overview](/docs/scos/dev/features/201907.0/shopping-list/shopping-list-notes/shopping-list-n) for more details.
