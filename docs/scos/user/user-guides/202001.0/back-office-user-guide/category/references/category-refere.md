...
To use such a template, the Templates & Slots feature should be [integrated](/docs/scos/dev/migration-and-integration/202001.0/feature-integration-guides/cms-feature-int) into your project.

Select such a template if you want this category page to have slots. Slots can embed content from CMS Blocks and technology partner integrations. See [Templates & Slots Feature Overview](/docs/scos/dev/features/202001.0/cms/templates-and-slots/templates-slots)  for more details.
