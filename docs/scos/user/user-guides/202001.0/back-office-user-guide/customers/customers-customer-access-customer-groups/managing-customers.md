...
To know how the customer addresses are managed, see  [Managing Customer Addresses](/docs/scos/user/user-guides/202001.0/back-office-user-guide/customers/references/customers-reference-information.html).
