...
{% info_block infoBox %}
See [Voucher Codes: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/merchandising/discount/references/voucher-codes-reference-information.html
