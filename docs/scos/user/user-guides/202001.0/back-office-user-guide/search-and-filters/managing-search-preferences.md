...
originalArticleId: 446e020f-9e8a-4ed5-94cc-b3c88076b84d
redirect_from:
...
2. On the **Add attribute to search** page, enter the attribute key and (optionally) specify "Yes" or "No" for search preference types.
    See [Search Preferences Types](/docs/scos/user/user-guides/202001.0/back-office-user-guide/search-and-filters/references/search-preferences-types.html) in the **References** section to know more about the search types.
3. Click **Save**.
