...
To learn more on how to select a shipment method, see [Shop Guide - Shipment Step](/docs/scos/user/user-guides/{{page.version}}/shop-user-guide/shop-guide-checkout/shop-guide-shipment-step.html).
