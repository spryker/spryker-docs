...
| 7 | **Status** | Displays the status of the cart. See [Approval Process feature overview](https://documentation.spryker.com/v4/docs/approval-process-overview-201903) for more information on statuses. Available only after the Approval Process feature has been integrated into your project. |
