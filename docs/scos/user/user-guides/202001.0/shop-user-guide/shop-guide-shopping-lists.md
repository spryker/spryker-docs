...
* Add a note to the item. To save the note, click **Save**. See [Shopping List Notes Feature Overview](/docs/scos/dev/features/202001.0/shopping-list/shopping-list-notes/shopping-list-notes-feature-overview.html) for more details.
...
{% info_block infoBox %}
See [Permissions Management for Shared Shopping Lists](/docs/scos/dev/features/202001.0/shopping-list/printing-a-shopping-list/printing-a-shopping-list.html
