...
{% endinfo_block %} feature is [integrated](/docs/scos/dev/migration-and-integration/202001.0/feature-integration-guides/search-widget-f) into your Project.)
...
* Add a note to the item. To save the note, click **Save**. See [Shopping List Notes Feature Overview](/docs/scos/dev/features/202001.0/shopping-list/shopping-list-notes/shopping-list-n) for more details.
...
{% info_block infoBox %}
See [Permissions Management for Shared Shopping Lists](/docs/scos/dev/features/202001.0/shopping-list/printing-a-shopping-list/printing-shoppi
...
The shopping list with the available items will be added to the shopping cart. See [Shopping Cart](/docs/scos/dev/user-guides/202001.0/shop-user-guide/shop-guide-shopping-carts/shop-guide-mana) to learn how to manage and purchase items using the cart.
