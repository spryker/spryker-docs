...
2. On the **Create Tax Set** page, enter the tax set name and select one or several tax rates to assign. See [Taxes: Reference information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/administration/taxes/tax-rates-and-tax-sets/references/taxes-reference-information.html) for more details.
3. Click **Save**.
...
2. On the **Edit Tax Set** page, change the attributes. See [Taxes: Reference information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/administration/taxes/tax-rates-and-tax-sets/references/taxes-reference-information.html) for more details.
3. Click **Save**.
