...
See [Products: Reference Information](/docs/scos/user/user-guides/202005.0/back-office-user-guide/catalog/products/references/products-reference-information.html) to know more about abstract products and concrete products.
...
So first you create an abstract product. See [Creating an Abstract Product](/docs/scos/user/user-guides/202005.0/back-office-user-guide/catalog/products/abstract-products/creating-an-abstract-product.html).
