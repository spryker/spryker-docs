...
2. On the **Create a Product** page, do the procedure described in [Creating an Abstract Product](https://documentation.spryker.com/docs/en/creating-an-abstract-product).
...
***
**What's next?**
Review [Creating an Abstract Product](https://documentation.spryker.com/docs/en/creating-an-abstract-product) and [Creating a Product Variant](https://documentation.spryker.com/docs/en/creating-a-product-variant) to learn more about how the products are created. 
