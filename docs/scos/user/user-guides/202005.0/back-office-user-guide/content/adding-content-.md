...
All the content used in this guide is shipped by default in our [Demo Shops](https://documentation.spryker.com/docs/en/demoshops).
...
[Content item](https://documentation.spryker.com/docs/en/content-items-feature-overview) is the smallest content unit in Spryker. By creating a content item, you preserve a small content piece that can be used later in multiple pages. 
...
See [Creating Content Items](https://documentation.spryker.com/docs/en/creating-content-items) for more details.

If the content item types shipped by default are not sufficient for your project needs, new ones can be created by a developer. See [HowTo - Create a Content Item](https://documentation.spryker.com/docs/en/howto-create-a-content-item) for more details.

## Create CMS Blocks

[CMS block](https://documentation.spryker.com/docs/en/cms-block) serves as the actual content that you insert into Storefront pages. 
...
See [Creating a CMS Block](https://documentation.spryker.com/docs/en/creating-cms-block) for more details.
...
See [Editing Placeholders](https://documentation.spryker.com/docs/en/managing-cms-blocks#editing-placeholders) to learn about inserting content into CMS blocks.

 
## Select a Template with Slots

[Template with slots](https://documentation.spryker.com/docs/en/templates-slots-feature-overview) defines the layout of slots on the Storefront pages you add the CMS blocks to.
...
If the templates with slots shipped by default are not sufficient for your project needs, new ones can be created by a developer. See [Template with Slots](https://documentation.spryker.com/docs/en/ht-create-cms-templates#template-with-slots) for more details.

## Select a Slot

[Slot](https://documentation.spryker.com/docs/en/templates-slots-feature-overview#slot) defines the Storefront page space you add the CMS blocks to.
...
If the slots shipped by default are not sufficient for your project needs, new ones can be created by a developer. See [Correlation](https://documentation.spryker.com/docs/en/templates-slots-feature-overview#correlation) for more details.
