...
***
**What's next?**
To know more about the charts that are presented in the Dashboard section, see [Dashboard: Reference Information](https://documentation.spryker.com/docs/en/dashboard-reference-information). 
