...
{% info_block infoBox %}
To find out more information about the attributes that you see on the **Edit Discount** page, see [Discount: Reference Information](https://documentation.spryker.com/docs/en/discount-reference-information
{% endinfo_block %}.)
...
1. On the **Overview of Discounts** page, click **Add code** in the _Actions_ column.
    ...
    Follow the steps described in [Creating a Discount Voucher](https://documentation.spryker.com/docs/en/creating-a-discount-voucher).
