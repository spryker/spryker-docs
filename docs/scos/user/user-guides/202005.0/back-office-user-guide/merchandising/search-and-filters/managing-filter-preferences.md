...
See [Managing Category Filters](/docs/scos/user/user-guides/202005.0/back-office-user-guide/merchandising/search-and-filters/managing-category-filters.html) to know how to set up the category filters.
