...
Don't forget to check out the video tutorial on setting up the [Company Users](https://documentation.spryker.com/docs/en/company-account-general-organizational-structure) in Spryker [B2B Demo Shop](https://documentation.spryker.com/docs/en/demoshops#b2b-demo-shop):
