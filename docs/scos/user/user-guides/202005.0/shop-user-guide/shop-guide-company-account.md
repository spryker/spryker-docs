...
{% endinfo_block %}
Don't forget to check out the video tutorial on setting up [Company](/docs/scos/dev/features/202005.0/company-account-management/company-account-overview/company-account-overview.html) Structure in Spryker [B2B Demo Shop](/docs/scos/user/intro-to-spryker/{{site.version}}/about-spryker.html#spryker-b2b-b2c-demo-shops):
