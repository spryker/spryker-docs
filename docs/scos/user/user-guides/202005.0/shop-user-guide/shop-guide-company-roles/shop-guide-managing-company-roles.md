...
Don't forget to check out the video tutorial on setting up the [Company Roles](https://documentation.spryker.com/v5/docs/en/company-roles-permissions-overview) in Spryker [B2B Demo Shop](/docs/scos/user/about-spryker/202005.0/b2b-suite.html):
...
To learn how to assign a role to a company user, see [Editing the existing User in Shop Guide - Company Users](/docs/scos/user/user-guides/202005.0/shop-user-guide/shop-guide-company-users.html#editing-an-existing-company-user)
