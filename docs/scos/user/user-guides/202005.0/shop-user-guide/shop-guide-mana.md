...
| 7 | **Product options** | Additional items you can purchase along with the product. The examples can be gift wrapping, warranty, and insurance. See [Product Options Overview](https://documentation.spryker.com/docs/en/product-options-overview#product-options-overview) for more information. |
...
* create a new cart by clicking **Create New Cart**. Then, enter the name of the cart in the **Cart Name** field, and click **Submit**. For more information on how to create carts, see [Shop Guide - Creating a Shopping Cart](https://documentation.spryker.com/docs/en/creating-shopping-cart).
...
4. To complete the operation, click **Add to Cart**. The items will be added to the selected (active) shopping cart. See [Shop Guide - Checkout](https://documentation.spryker.com/docs/en/checkout-shop-guide-201911) to learn more about how to proceed with the order.
...
You can order frequently bought products faster by adding the products to a [shopping list](https://documentation.spryker.com/docs/en/multiple-shared-shopping-lists-overview-201907).
...
2. Specify the quantity of the product and click **Add to Shopping list**. The item will be added to the shopping list you’ve selected. For more information on managing shopping lists, see [Shop Guide - Shopping Lists](https://documentation.spryker.com/docs/en/shopping-lists-shop-guide).
...
With the [Product Reviews](https://documentation.spryker.com/docs/en/product-reviews) feature, you can share your experience or feedback about using the product.
...
If you want to purchase later the items you are interested in, you can add them to a [wishlist](https://documentation.spryker.com/docs/en/multiple-wishlists).
...
After you added the product to the cart, you can proceed with the checkout. For more information, see [Shop Guide - Checkout](https://documentation.spryker.com/docs/en/checkout-shop-guide-201911#shop-guide---checkout).

To learn how to create and manage shopping lists, see [Shop Guide - Shopping Lists](https://documentation.spryker.com/docs/en/shopping-lists-shop-guide#shop-guide---shopping-lists).

To learn how to create and manage wishlists, see [Shop Guide - Managing Wishlists](https://documentation.spryker.com/docs/en/shop-guide-wishlists). 
