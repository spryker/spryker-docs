...
2. In the **Configuration** tab, make changes to the needed attributes. See [Warehouses: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/administration/warehouses/references/reference-information-warehouses.html) for more details on the attributes you can update.
...
To learn more about the attributes you view or edit on the **View or Edit Warehouse: [Warehouse name]** pages, see [Warehouses: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/administration/warehouses/references/reference-information-warehouses.html).
