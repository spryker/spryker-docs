...
If you want to manage a CMS block for [email](https://documentation.spryker.com/v6/docs/email-as-a-cms-block-overview), see [Managing content of emails via CMS blocks](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content/blocks/managing-content-of-emails-via-cms-blocks.html).
...
2. On the *Edit Block Glossary: Block ID* page, you can update a title or content of the CMS block, as well as insert a content item widget. See [Adding content item widgets to a block](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content/content-items/adding-content-items-to-cms-pages-and-blocks.html#adding-content-item-widgets-to-blocks) for more details.
...
See [CMS Blocks: Reference Information](/docs/scos/user/user-guides/{{page.version}}/back-office-user-guide/content/blocks/references/reference-information-cms-block.html)  for more details.
