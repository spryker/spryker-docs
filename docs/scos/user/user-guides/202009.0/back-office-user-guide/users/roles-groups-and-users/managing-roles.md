...
originalLink: https://documentation.spryker.com/v6/docs/managing-roles
originalArticleId: 2acd68f5-0c1d-4967-931d-046826b23c5a
redirect_from:
  - /v6/docs/managing-roles
  - /v6/docs/en/managing-roles
---
...
See [Adding Rules for Roles](/docs/scos/user/user-guides/202009.0/back-office-user-guide/users/roles-groups-and-users/managing-roles.html#adding-rules-for-roles) for information on how to create rules.
...
2. Repeat the steps described in the [Creating a Role](/docs/scos/user/user-guides/202009.0/back-office-user-guide/users/roles-groups-and-users/managing-roles.html#creating-a-role) procedure.
***
**What's next?**
You need to create a group to assign this role to it. See the [Creating a Group](/docs/scos/user/user-guides/202009.0/back-office-user-guide/users/roles-groups-and-users/managing-groups.html#creating-a-group) section in _Managing Groups_.
