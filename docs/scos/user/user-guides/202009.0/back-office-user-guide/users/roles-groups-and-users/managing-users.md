...
{% info_block infoBox %}
 ...
 See [User: Reference Information](/docs/scos/user/user-guides/pa{{page.version}}/back-office-user-guide/users/roles-groups-and-users/references/reference-information-user.html) for details on these attributes.
