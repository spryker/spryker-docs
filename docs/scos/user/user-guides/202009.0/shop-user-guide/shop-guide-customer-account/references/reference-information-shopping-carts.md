...
originalLink: https://documentation.spryker.com/v6/docs/shop-guide-shopping-carts-reference-information
originalArticleId: de026417-d948-4c75-a5da-fb8d5509df71
redirect_from:
...
Shopping Carts page is the page where you can access your shopping carts. Don't have a shopping cart? Start [creating](https://documentation.spryker.com/v6/docs/multiple-carts-per-user-overview#multiple-carts-per-user-on-the-storefront) it!
...
| 2 | **Shopping Cart Name** | See [Editing Shopping Cart](https://documentation.spryker.com/v6/docs/multiple-carts-per-user-overview#multiple-carts-per-user-on-the-storefront) to change the name of the shopping cart. |
