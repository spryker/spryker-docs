...
To make sure you can take updates, stick to the [recommended extension points](/docs/dg/dev/guidelines/keeping-a-project-upgradable/extension-scenarios/extenstion-scenarios.html) when customizing your project.
