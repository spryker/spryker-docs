...
To correspond to [PSR-2+ standards](http://www.php-fig.org/psr/psr-2/), we integrated the well known [PHPCodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer).
